module Spree
  module PromotionRules
    ...
    class Category < Spree::PromotionRule
      ...
      def taxons
        Spree::Deprecation.warn('Spree::PromotionRules::Category#taxons is deprecated and will be removed in Spree 6.1. Use #categories instead.')
        categories
      end
      ...
      def taxon_ids
        Spree::Deprecation.warn('Spree::PromotionRules::Category#taxon_ids is deprecated and will be removed in Spree 6.1. Use #category_ids instead.')
        category_ids
      end
      ...
      def eligible_taxon_ids
        Spree::Deprecation.warn('Spree::PromotionRules::Category#eligible_taxon_ids is deprecated and will be removed in Spree 6.1. Use #eligible_category_ids instead.')
        eligible_category_ids
      end

      # @deprecated Use #category_ids_to_add.
      def taxon_ids_to_add
        Spree::Deprecation.warn('Spree::PromotionRules::Category#taxon_ids_to_add is deprecated and will be removed in Spree 6.1. Use #category_ids_to_add instead.')
        category_ids_to_add
      end
      ...
      def taxon_ids_string
        Spree::Deprecation.warn('Spree::PromotionRules::Category#taxon_ids_string is deprecated and will be removed in Spree 6.1. Use #category_ids instead.')
