  ...
  class VariantPresenter
    ...
    def call
      @variants.map do |variant|
        price_record = variant.price_in(current_currency)
        {
          display_price: price_record.display_price_including_vat_for(current_price_options).to_html,
          price: price_record,
          display_compare_at_price: price_record.display_compare_at_price_including_vat_for(current_price_options).to_html,
