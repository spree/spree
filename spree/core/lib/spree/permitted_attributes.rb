module Spree
  module PermittedAttributes
    ...
    @@payment_method_attributes = [:name, :type, :description, :active, :display_on, :auto_capture, :capture_method, :position, { metadata: {}, preferences: {} }]
    ...
    @@variant_attributes = [
      ...
      :own_seller_id, :own_delivery_profile_id,
