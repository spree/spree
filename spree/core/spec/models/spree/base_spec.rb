...
describe Spree::Base do
  ...
  describe '.json_api_permitted_attributes' do
    it { expect(Spree::Address.json_api_permitted_attributes).to contain_exactly('first_name', 'last_name', 'address1', 'address2', 'city', 'postal_code', 'phone', 'country_code', 'state_code', 'state_name', 'alternative_phone', 'company', 'country_id', 'state_id', 'created_at', 'updated_at', 'owner_id', 'owner_type', 'deleted_at', 'label', 'metadata', 'quick_checkout', 'latitude', 'longitude') }
  end
