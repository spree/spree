      ...
      context 'with a home country' do
        ...
        context 'and the destination is elsewhere' do
          it 'takes the home VAT out and puts the destination VAT on' do
            create(:tax_rate, country_code: home_country&.iso, tax_category: tax_category, amount: 0.19,
                              included_in_price: true)
            create(:tax_rate, country_code: destination&.iso, tax_category: tax_category, amount: 0.25,
                              included_in_price: true)
