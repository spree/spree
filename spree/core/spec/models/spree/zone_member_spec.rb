...
# Spree::Zone is defunct: it addressed its members by country and state row id,
# and countries and states became reference data in 6.0
# (docs/plans/6.0-drop-country-state-models.md). Matching returns nothing until
# the tax provider replaces it (docs/plans/6.0-tax-provider.md Phase 5), so
# these are skipped rather than deleted — the tax rewrite decides their fate.
xdescribe Spree::ZoneMember, type: :model do
