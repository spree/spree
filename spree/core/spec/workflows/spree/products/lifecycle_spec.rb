...
RSpec.describe 'product workflows' do
  ...
  describe Spree::Products::Create do
    ...
    it 'lets a validate handler reject the product before it is written' do
      ...
      expect(Spree::Product.find_by(name: 'a sample chair')).to be_nil
    end
  ...
  describe Spree::Products::Update do
  ...
  describe Spree::Products::Destroy do
