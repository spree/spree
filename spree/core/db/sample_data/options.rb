...
# variants, which hands it the whole option machinery for free (presentation
...
%w[new refurbished used].each_with_index do |value, index|
  ...
  condition.option_values.create!(name: value, presentation: value.capitalize, position: index + 1)
end
