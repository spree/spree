class CreateSpreeStockReservations < ActiveRecord::Migration[7.2]
  def change
    create_table :spree_stock_reservations, if_not_exists: true do |t|
    ...
    add_index :spree_stock_reservations, [:stock_item_id, :expires_at], if_not_exists: true
    add_index :spree_stock_reservations, [:stock_item_id, :line_item_id], unique: true,
              name: 'idx_stock_reservations_item_line_item', if_not_exists: true
    add_index :spree_stock_reservations, :expires_at, if_not_exists: true
  end
end
