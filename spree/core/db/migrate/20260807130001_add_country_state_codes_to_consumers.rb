class AddCountryStateCodesToConsumers < ActiveRecord::Migration[7.2]
  def change
    add_column :spree_addresses, :country_code, :string
    add_column :spree_addresses, :state_code, :string
    add_index :spree_addresses, :country_code
    ...
    add_column :spree_delivery_zone_members, :country_code, :string
    add_column :spree_delivery_zone_members, :state_code, :string
    add_index :spree_delivery_zone_members, :country_code

    add_column :spree_market_countries, :country_code, :string
    add_index :spree_market_countries, [:market_id, :country_code],
              unique: true, name: 'index_spree_market_countries_on_market_id_and_country_code'
    ...
    add_column :spree_stores, :default_country_code, :string
  end
end
