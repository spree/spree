    ...
    module V3
      module Admin
        ...
        class CartSerializer < V3::CartSerializer
          %i[fulfillments payments payment_methods gift_card].each { |key| _attributes.delete(key) }

          typelize completed_at: [:string, nullable: true]

          attributes completed_at: :iso8601, created_at: :iso8601, updated_at: :iso8601

          many :order_promotions, key: :discounts, resource: proc { Spree.api.admin_applied_promotion_serializer }
