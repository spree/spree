module Spree
  module Api
    module V3
      module Admin
        # Admin API Store Serializer
        # Extends the store-facing serializer with back-office fields:
        # timestamps, mail settings, notification addresses, admin prefs.
        class StoreSerializer < V3::StoreSerializer
          typelize available_locales: [:string, multi: true],
