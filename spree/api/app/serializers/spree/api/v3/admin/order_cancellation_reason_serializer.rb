  ...
  module Api
    module V3
      module Admin
        ...
        #
        # The reason serializers are deliberately parallel rather than sharing
        # a base class: Typelizer emits one TS type per serializer, so a shared
        # parent would publish an abstract `Reason` type into the admin SDK
        # that no endpoint returns.
        class OrderCancellationReasonSerializer < V3::BaseSerializer
