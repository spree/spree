...
Gem::Specification.new do |s|
  ...
  s.summary     = 'Avalara AvaTax tax calculation for Spree eCommerce platform'
  s.description = 'Sales tax, VAT and GST calculation for Spree via Avalara AvaTax — the reference TaxProvider implementation'
