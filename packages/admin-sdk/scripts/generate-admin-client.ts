...
function generateClient(spec: OpenApiSpec): { client: string; params: string } {
  ...
  out.push(`    login: (credentials: LoginCredentials, options?: RequestOptions): Promise<AuthTokens> =>`);
  out.push(`      this.request<AuthTokens>('POST', '/auth/login', { ...options, body: credentials }),`);
  out.push(``);
