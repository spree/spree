...
describe Spree::LegacyWebhooks do
  describe '#disable_webhooks' do
    ...
    after { Spree::LegacyWebhooks.disabled = true }
    ...
    describe 'when webhooks are already disabled' do
      before { Spree::LegacyWebhooks.disabled = true }
    ...
    describe 'when webhooks are enabled' do
      before { Spree::LegacyWebhooks.disabled = false }
