...
function StockLocationFormFields({ form }: { form: UseFormReturn<StockLocationFormValues> }) {
  ...
  return (
    // Sections are siblings: each is its own fieldset, so nesting them inside
    // one group would make every field a member of a group it does not belong
    // to as well as its own.
    <div className="flex flex-col gap-6">
      ...
      <FormSection title={t('admin.stock_locations.section_details')}>
        <Field>
      ...
      <FormSection title={t('admin.stock_locations.section_behavior')}>
        <BooleanRow
          id="active"
      ...
      <FormSection title={t('admin.fields.address.address1.label')}>
        <Field>
        ...
        <div className="grid grid-cols-2 gap-3">
          <Field>
            ...
            <Input id="city" aria-invalid={!!errors.city || undefined} {...form.register('city')} />
      ...
      <FormSection title={t('admin.stock_locations.section_pickup')}>
        <BooleanRow
          id="pickup-enabled"
