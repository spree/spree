...
function RadioGroupItem({ className, ...props }: React.ComponentProps<typeof RadioPrimitive.Root>) {
  return (
    <RadioPrimitive.Root
      ...
      className={cn(
        'peer relative inline-block size-4 shrink-0 cursor-pointer rounded-full border border-border-control align-[-3px] shadow-xs outline-none transition-shadow',
