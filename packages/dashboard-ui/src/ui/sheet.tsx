  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        dir={dir}
        className={cn(
          // `translate` listed explicitly — the open/close motion below is
          // driven by `translate-x/y-*`, which Tailwind v4 compiles to the
          // standalone `translate` property rather than into `transform`.
          'fixed z-50 flex flex-col border border-border bg-card text-foreground text-sm shadow-lg transition-[opacity,transform,translate] duration-250 ease-out',
