...
export interface BulkVariantsTableProps {
  ...
  /**
   * The store's cartons. Omit to hide the packing columns entirely. The
   * optional `hint` carries each carton's size, so two similarly named ones
   * are told apart without leaving the sheet.
   */
  cartonOptions?: ReadonlyArray<{ value: string; label: string; hint?: string }>
  /**
