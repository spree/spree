...
const importsSearchSchema = resourceSearchSchema.extend(importWizardSearchSchema.shape)
...
function ImportsPage() {
  ...
  useRowClickBridge('data-import-id', wizard.open)
