...
/**
 * Settings content padding. The secondary sidebar lives one level up, in the
 * shared app shell, so it can extend the full height of the content sheet.
 * This layout owns only the right-side content padding.
 *
