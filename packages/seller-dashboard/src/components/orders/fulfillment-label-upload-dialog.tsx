...
/** Records postage the seller bought elsewhere. Buying and refunding are not here: both run through the marketplace's carrier account, and the endpoint refuses them. */
export function FulfillmentLabelUploadDialog({
  ...
  return (
    <LabelUploadDialog
      ...
      currency={currency}
      onSubmit={onSubmit}
      pending={uploadLabel.isPending || uploading}
    />
  )
}
