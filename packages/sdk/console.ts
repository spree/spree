...
const secretKey = process.env.SPREE_SECRET_KEY || "";
...
const client = createSpreeClient({ baseUrl, publishableKey, secretKey });
...
console.log(
  '  await client.store.products.get("my-product", {}, { locale: "fr" })'
);
console.log(
  '  await client.store.taxons.get("categories/clothing", {}, { currency: "EUR" })'
);
console.log("");
