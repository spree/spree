...
describe('customer', () => {
  ...
  describe('update', () => {
    it('updates customer profile', async () => {
      const result = await client.customer.update({ first_name: 'Updated' }, opts)
  ...
  describe('addresses', () => {
    ...
    it('deletes an address', async () => {
      await expect(client.customer.addresses.delete('addr_1', opts)).resolves.toBeUndefined()
    })
  })
  ...
  describe('creditCards', () => {
    ...
    it('deletes a credit card', async () => {
      await expect(client.customer.creditCards.delete('cc_1', opts)).resolves.toBeUndefined()
    })
  })
