...
export const handlers = [
  ...
  http.get(`${API_PREFIX}/products/:id`, () => HttpResponse.json(fixtures.product)),
  ...
  http.get(`${API_PREFIX}/countries/:iso`, () => HttpResponse.json(fixtures.country)),

  // Currencies
  http.get(`${API_PREFIX}/currencies`, () => HttpResponse.json({ data: [fixtures.currency] })),
  ...
  http.get(`${API_PREFIX}/markets/resolve`, () => HttpResponse.json(fixtures.market)),

  http.get(`${API_PREFIX}/markets/:id/countries`, () =>
    HttpResponse.json({ data: [fixtures.country] }),
  ),

  http.get(`${API_PREFIX}/markets/:id/countries/:iso`, () => HttpResponse.json(fixtures.country)),

  http.get(`${API_PREFIX}/markets/:id`, () => HttpResponse.json(fixtures.market)),
  ...
  http.get(`${API_PREFIX}/carts/:cartId`, () => HttpResponse.json(fixtures.cart)),

  http.patch(`${API_PREFIX}/carts/:cartId`, () => HttpResponse.json(fixtures.cart)),

  http.delete(`${API_PREFIX}/carts/:cartId`, () => new HttpResponse(null, { status: 204 })),

  http.patch(`${API_PREFIX}/carts/:cartId/associate`, () => HttpResponse.json(fixtures.cart)),
  ...
  http.delete(`${API_PREFIX}/carts/:cartId/items/:id`, () => HttpResponse.json(fixtures.cart)),

  // Carts > Discount Codes
  http.post(`${API_PREFIX}/carts/:cartId/discount_codes`, () => HttpResponse.json(fixtures.cart)),
  ...
  // Carts > Gift Cards
  http.post(`${API_PREFIX}/carts/:cartId/gift_cards`, () => HttpResponse.json(fixtures.cart)),

  http.delete(`${API_PREFIX}/carts/:cartId/gift_cards/:id`, () => HttpResponse.json(fixtures.cart)),
  ...
  // Carts > Store Credits
  http.post(`${API_PREFIX}/carts/:cartId/store_credits`, () => HttpResponse.json(fixtures.cart)),
  ...
  http.get(`${API_PREFIX}/customers/me/addresses/:id`, () => HttpResponse.json(fixtures.address)),

  http.post(`${API_PREFIX}/customers/me/addresses`, () => HttpResponse.json(fixtures.address)),
  ...
  http.delete(
    `${API_PREFIX}/customers/me/addresses/:id`,
  ...
  http.delete(
    `${API_PREFIX}/customers/me/credit_cards/:id`,
    () => new HttpResponse(null, { status: 204 }),
  ),
      ...
      data: [
        {
          ...
          body_html: '<p>Return within 30 days.</p>',
          created_at: '2026-01-01T00:00:00Z',
          updated_at: '2026-01-01T00:00:00Z',
        },
        {
          ...
          body_html: '<p>We respect your privacy.</p>',
          created_at: '2026-01-01T00:00:00Z',
          updated_at: '2026-01-01T00:00:00Z',
        },
      ],
  ...
  http.get(`${API_PREFIX}/wishlists/:id`, () => HttpResponse.json(fixtures.wishlist)),

  http.post(`${API_PREFIX}/wishlists`, () => HttpResponse.json(fixtures.wishlist)),
