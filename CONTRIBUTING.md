...
PR should be created that does. For instance, if a PR applied to master & 2-2-stable but not 2-1-stable, then there should be one PR for master & 2-2-stable and another, separate PR for 2-1-stable.
