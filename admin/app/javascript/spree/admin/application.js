...
import AccountTaxRegistrationsController from 'spree/admin/controllers/account_tax_registrations_controller'
import ActiveStorageUpload from 'spree/admin/controllers/active_storage_upload_controller'
import AddDomainController from 'spree/admin/controllers/add_domain_controller'
...
import SpreeController from 'spree/admin/controllers/spree_controller'
...
application.register('account-tax-registrations', AccountTaxRegistrationsController)
application.register('active-storage-upload', ActiveStorageUpload)
application.register('add-domain', AddDomainController)
