...
### [Introduction](building-the-main-menu#introduction) <a id="introduction"></a>
...
### [Add A Top Level Item](building-the-main-menu#add-a-top-level-item) <a id="add-a-top-level-item"></a>
...
#### [Add The Category & Promotions Container](building-the-main-menu#add-the-category-promotions-container) <a id="add-the-category-promotions-container"></a>
...
The promotions container used in the Spree mega menu is exactly the same as the Categories container, except it uses the **Code:** `promo`, go ahead and repeat the three steps above replacing the code `categories` with `promo`.
...
### [Adding Links To Containers](building-the-main-menu#adding-links-to-containers) <a id="adding-links-to-containers"></a>

#### [Add A Link To Categories Container](building-the-main-menu#add-a-link-to-categories-container) <a id="add-a-link-to-categories-container"></a>
...
#### [Add A Link To Promotions Container](building-the-main-menu#add-a-link-to-promotions-container) <a id="add-a-link-to-promotions-container"></a>
