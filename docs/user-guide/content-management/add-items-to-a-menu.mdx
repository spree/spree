...
## [Introduction](add-items-to-a-menu#introduction) <a id="introduction"></a>

This part of the guide assumes you have created a menu and are now ready to add some items to the menu items area pictured below; if this is not the case, [click here](creating-a-new-menu) to view the guide to creating a new menu.



![Menu Items Area](/images/image%20%284%29%20%281%29.png)
...
![New Menu Item Page](/images/image%20%285%29.png)

## [Settings Panel](add-items-to-a-menu#settings-panel) <a id="settings-panel"></a>

The Settings panel contains Menu Item specific settings, such as **Item Type**, **Code** and **Nest Under**.

### [Item Type](add-items-to-a-menu#item-type) <a id="item-type"></a>
...
### [Code](add-items-to-a-menu#code) <a id="code"></a>
...
For more information on using the Spree Main Menu visit the [Building The Main Menu](building-the-main-menu) page.

![Contianers With Code](/images/image%20%2855%29.png)

### [Nest Under](add-items-to-a-menu#nest-under) <a id="nest-under"></a>
...
## [Public Settings](add-items-to-a-menu#public-settings) <a id="public-settings"></a>

Public setting is where your public-facing information is set.

### [Name](add-items-to-a-menu#name) <a id="name"></a>

This is the name used for the link or container displayed in the view.

### [Subtitle](add-items-to-a-menu#subtitle) <a id="subtitle"></a>
...
### [Image](add-items-to-a-menu#image) <a id="image"></a>
...
## [Link Settings](add-items-to-a-menu#link-settings) <a id="link-settings"></a>

The link settings panel is where you set the link destination, by default, you are offered the URL field.

### [URL](add-items-to-a-menu#url) <a id="url"></a>
...
![Change Link To Type](/images/image.png)

### [Taxon / Product](add-items-to-a-menu#taxon-product) <a id="taxon-product"></a>
...
![Link To Sportsware Taxon Set](/images/image%20%2857%29.png)

### [Home Page](add-items-to-a-menu#home-page) <a id="home-page"></a>
