...
### [Shipping Categories](shipping-categories#shipping-categories) <a id="shipping-categories"></a>
...
#### [Creating a Shipping Category](shipping-categories#creating-a-shipping-category) <a id="creating-a-shipping-category"></a>
...
#### [Adding a Shipping Category to a Product](shipping-categories#adding-a-shipping-category-to-a-product) <a id="adding-a-shipping-category-to-a-product"></a>
...
### [Next Step](shipping-categories#next-step) <a id="next-step"></a>

Now that you understand how Shipping Categories work, let’s move on to the next element of the Spree shipping system - shipping [zones](zones).
