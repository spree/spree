...
### [Zones](zones#zones) <a id="zones"></a>

Zones serve as a way to define shipping rules for a particular geographic area. A zone is made up of a set of either countries or states. Zones are used within Spree to define the rules for a [Shipping Method](shipping-methods).
...
#### [Creating a Zone](zones#creating-a-zone) <a id="creating-a-zone"></a>
...
#### [Adding Members to a Zone](zones#adding-members-to-a-zone) <a id="adding-members-to-a-zone"></a>
...
#### [Removing Members From a Zone](zones#removing-members-from-a-zone) <a id="removing-members-from-a-zone"></a>
...
### [Next Step](zones#next-step) <a id="next-step"></a>
