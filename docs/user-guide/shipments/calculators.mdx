...
### [Calculators](calculators#calculators) <a id="calculators"></a>

A Calculator is the component of the Spree shipping system responsible for calculating the shipping price for each available [Shipping Method](shipping-methods).

Spree ships with 5 default calculators:

* [Flat rate \(per order\)](calculators#flat-rate-per-order)
* [Flat rate \(per item\)](calculators#flat-rate-per-item)
* [Flat percent](calculators#flat-percent)
* [Flexible rate](calculators#flexible-rate)
* [Price sack](calculators#price-sack)

#### [Flat Rate \(per order\)](calculators#flat-rate-per-order) <a id="flat-rate-per-order"></a>
...
#### [Flat Rate \(per item\)](calculators#flat-rate-per-item) <a id="flat-rate-per-item"></a>
...
#### [Flat Percent](calculators#flat-percent) <a id="flat-percent"></a>
...
#### [Flexible Rate](calculators#flexible-rate) <a id="flexible-rate"></a>
...
#### [Price Sack](calculators#price-sack) <a id="price-sack"></a>
...
#### [Custom Calculators](calculators#custom-calculators) <a id="custom-calculators"></a>

You can define your own calculator if you have more complex needs. In that case, check out the [Calculators Guide](https://developer/internals/calculators).

### [Next Step](calculators#next-step) <a id="next-step"></a>

If you have followed this guide series from the beginning, your store is now furnished with [shipping categories](shipping-categories), [geographical shipping zones](zones), and calculators. The final step is to pull it all together into [shipping methods](shipping-methods), from which your customers can choose at checkout.
