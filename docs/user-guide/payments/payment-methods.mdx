...
### [Introduction](payment-methods#introduction) <a href="#introduction" id="introduction"></a>
...
### [Terminology](payment-methods#terminology) <a href="#terminology" id="terminology"></a>
...
### [Evaluating Payment Gateways](payment-methods#evaluating-payment-gateways) <a href="#evaluating-payment-gateways" id="evaluating-payment-gateways"></a>
...
### [Add a Payment Method](payment-methods#add-a-payment-method) <a href="#add-a-payment-method" id="add-a-payment-method"></a>
...
#### [Add a Supported Gateway](payment-methods#add-a-supported-gateway) <a href="#add-a-supported-gateway" id="add-a-supported-gateway"></a>
...
### [Select Provider](payment-methods#select-provider)
...
### ****[**Display**](payment-methods#display)****
...
### ****[**Auto Capture**](payment-methods#auto-capture)****
...
#### [Add a Non-Supported Gateway](payment-methods#add-a-non-supported-gateway) <a href="#add-a-non-supported-gateway" id="add-a-non-supported-gateway"></a>
...
### [Edit a Payment Method](payment-methods#edit-a-payment-method) <a href="#edit-a-payment-method" id="edit-a-payment-method"></a>
...
### [Processing Payments](payment-methods#processing-payments) <a href="#processing-payments" id="processing-payments"></a>

Processing orders and the payments associated with them are covered in detail in the [Processing Orders guide](../orders/processing-orders).
