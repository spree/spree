...
### [Introduction](payment-states#introduction) <a id="introduction"></a>
...
### [Payment States](payment-states#payment-states) <a id="payment-states"></a>
...
### [Authorize vs Capture](payment-states#authorize-vs-capture) <a id="authorize-vs-capture"></a>
...
## [Capture a Payment via the Admin](payment-states#capture-a-payment-via-the-admin) <a id="capture-a-payment-via-the-admin"></a>
...
### [Void a Payment](payment-states#void-a-payment) <a id="void-a-payment"></a>
...
### [Edit the Payment Amount](payment-states#edit-the-payment-amount) <a id="edit-the-payment-amount"></a>
