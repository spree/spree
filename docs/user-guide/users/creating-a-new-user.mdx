...
### [Introduction](creating-a-new-user#introduction) <a id="introduction"></a>
...
### [Editing existing user](creating-a-new-user#editing-existing-user) <a id="editing-existing-user"></a>

Once you have created an account, you are redirected to a User editing page which you can find out more about [here](editing-users).
