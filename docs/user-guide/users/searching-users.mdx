...
### [Searching Users](searching-users#searching-users)
...
* **Edit** - Allows you to make [additional changes to the user’s settings](editing-users).
* **Delete** - Allows you to [delete the user permanently](deleting-users).
