...
### [Introduction.](editing-users#introduction) <a id="introduction"></a>
...
### [General Settings](editing-users#general-settings) <a id="general-settings"></a>
...
#### [Addresses](editing-users#addresses) <a id="addresses"></a>
...
#### [Orders](editing-users#orders) <a id="orders"></a>
...
* **State** - The current state of a particular order; you can find more [about order state here](../orders/order-states).
...
#### [Items](editing-users#items) <a id="items"></a>
...
* **State** - As previously mentioned, there is more information [here](../orders/order-states).
...
Firstly, to add store credit to the User, you have to create a **Category** which you can learn more about [here](../configuration/store-credit-categories). Once you create a category you can assign Store Credit to the Users by simply clicking **Edit** on a certain User and pressing **Store Credit** in the right panel.
