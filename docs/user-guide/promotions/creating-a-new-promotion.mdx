...
### [Creating a new promotion](creating-a-new-promotion#creating-a-new-promotion)
...
### [Rules](creating-a-new-promotion#rules) <a id="rules"></a>
...
#### [Item Total](creating-a-new-promotion#item-total) <a id="item-total"></a>
...
#### [Products](creating-a-new-promotion#products) <a id="products"></a>
...
#### [User](creating-a-new-promotion#user) <a id="user"></a>
...
#### [First Order](creating-a-new-promotion#first-order) <a id="first-order"></a>
...
#### [User Logged In](creating-a-new-promotion#user-logged-in) <a id="user-logged-in"></a>
...
### [Actions](creating-a-new-promotion#actions) <a id="actions"></a>

Whereas [Rules](creating-a-new-promotion#rules) establish whether a promotion applies or not, Actions determine what happens when a promotion does apply to an order. There are two types of actions: [create adjustments](creating-a-new-promotion#create-adjustments) and [create line items](creating-a-new-promotion#create-line-items).

#### [Create Adjustments](creating-a-new-promotion#create-adjustments) <a id="create-adjustments"></a>

When you select “Create adjustment” from the “Add Action of Type” drop-down menu and click “Add”, the system presents you with several calculator options. These are the same as the options you read about in the [calculators guide](../shipments/calculators), except that instead of a [price sack calculator](../shipments/calculators#price-sack), there are two additional calculators: percent per item and free shipping.
...
#### [Create Line Items](creating-a-new-promotion#create-line-items) <a id="create-line-items"></a>
