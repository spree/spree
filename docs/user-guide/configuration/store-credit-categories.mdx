...
### [Introduction](store-credit-categories#introduction) <a id="introduction"></a>
...
### [Creating a New Store Credit Category](store-credit-categories#creating-a-new-store-credit-category) <a id="creating-a-new-store-credit-category"></a>
...
### [Editing and Deleting Store Credit Categories](store-credit-categories#editing-and-deleting-store-credit-categories) <a id="editing-and-deleting-store-credit-categories"></a>
...
You can now assign Store Credit to the users’ accounts. You can learn more about it [here](../users/editing-users)
