...
### [Enabling Order Notifications](store-order-notifications#enabling-order-notifications) <a id="enabling-order-notifications"></a>
...
![](/images/zrzut-ekranu-2021-08-20-000659.jpg)

Scroll down to the **Emails** category and add your desired email address to the field labeled **New Order Notifications Email**.

![Admin: Store Emails Group](/images/image%20%2852%29.png)

Click the **Update** button at the bottom of the page and you’re all set!

### [Disabling Order Notifications](store-order-notifications#disabling-order-notifications) <a id="disabling-order-notifications"></a>
