...
### [Introduction](taxes#introduction) <a id="introduction"></a>
...
* [Tax Categories](taxes#tax-categories)
* [Zones](taxes#zones)
* [Tax Rates](taxes#tax-rates)
* [Tax Settings](taxes#tax-settings)

### [Tax Categories](taxes#tax-categories) <a id="tax-categories"></a>
...
### [Zones](taxes#zones) <a id="zones"></a>

In addition to a product’s tax category, the zone that an order is being shipped to will play a role in determining the tax amount. You can read more about how zones work in the [Zones guide](../shipments/zones).

### [Tax Rates](taxes#tax-rates) <a id="tax-rates"></a>

Tax rates are how it all comes together. A product with a given [Tax Category](taxes#tax-categories), being shipped to a particular [Zone](taxes#zones), will accrue tax charges based on the relevant tax rate that you create.
...
* **Tax Category** - The [tax category](taxes#tax-categories) that relates to this tax rate.
...
### [Tax Settings](taxes#tax-settings) <a id="tax-settings"></a>

Finally, European stores will benefit from the Tax Settings page.

![Tax Settings](/images/image%20%2815%29.png)

When this option is checked, your Spree site will take it as a default [tax category](taxes#tax-categories), find the corresponding [tax rate](taxes#tax-rates), and multiply it by the shipping rate for each available [shipping method](../shipments/shipping-methods) offered to a customer during checkout.
