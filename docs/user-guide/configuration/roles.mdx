...
### [Introduction](roles#introduction) <a id="introduction"></a>
...
### [Creating a New Role](roles#creating-a-new-role) <a id="creating-a-new-role"></a>
...
### [Assigning a Role to a User](roles#assigning-a-role-to-a-user) <a id="assigning-a-role-to-a-user"></a>

To assign a new Role, you need to open the editing panel for the certain User.

![Assign Role](/images/image%20%2821%29.png)

To find out more [click here](../users/editing-users#introduction).
