...
### [Introduction](manual-order-entry#introduction) <a id="introduction"></a>
...
### [Add Products](manual-order-entry#add-products) <a id="add-products"></a>
...
### [Customer Details](manual-order-entry#customer-details) <a id="customer-details"></a>
...
### [Shipments](manual-order-entry#shipments) <a id="shipments"></a>
...
### [Adjustments](manual-order-entry#adjustments) <a id="adjustments"></a>
...
#### [Editing Adjustments](manual-order-entry#editing-adjustments) <a id="editing-adjustments"></a>
...
#### [Deleting Adjustments](manual-order-entry#deleting-adjustments) <a id="deleting-adjustments"></a>
...
#### [Opening and Closing Adjustments](manual-order-entry#opening-and-closing-adjustments) <a id="opening-and-closing-adjustments"></a>
...
#### [Adding Adjustments](manual-order-entry#adding-adjustments) <a id="adding-adjustments"></a>
...
### [Payments](manual-order-entry#payments) <a id="payments"></a>

If you are manually entering this order, it is presumed that you have received payment either in person, on the phone, or through some other non-website means. You can manually enter payments using any of your site’s configured [payment methods](../payments/payment-methods).
...
Don’t forget that you will need to [capture the payment](../payments/payment-states) on the credit card \(unless your store is set up to automatically authorize and capture payments\).

For more on payments, be sure to read both the [Payment Methods](../payments/payment-methods) and [Payment States](../payments/payment-states) guides.
