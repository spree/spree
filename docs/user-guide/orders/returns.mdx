...
### [Introduction](returns#introduction) <a id="introduction"></a>
...
### [Creating RMAs for Returns](returns#creating-rm-as-for-returns) <a id="creating-rm-as-for-returns"></a>
...
![Return Authorizations Link](/images/image%20%2885%29.png)
...
![RMA Form](/images/image%20%2890%29.png)
...
Input the reason and any memo notes for the return, and select the [Stock Location](../configuration/inventory#stock-movements) that the item is being sent back to. Click the “Create” button.
...
![Return Edition](/images/image%20%28101%29.png)

![Return Delete](/images/image%20%28106%29.png)
...
![Return Edition Inside](/images/image%20%28104%29.png)

### [Processing Returns](returns#processing-returns) <a id="processing-returns"></a>
...
![Receive RMA Button](/images/image%20%2889%29.png)

Select which of the authorized return items were received or mark all of them by simply clicking the check box on the left-hand side of the product, and the [Stock Location](../products/creating-a-new-product) at which the item was received. You can also select whether the item that has been returned by the User is still **Resellable** or not. Once you are done, click the “Create” button.

![Receive RMA Button](/images/image%20%28107%29.png)

The return items are marked as accepted, and now you can create a reimbursement for the $24.14 you owe the customer.

![RMA Received](/images/image%20%2893%29.png)
...
![Issue a Reimbursement](/images/image%20%2894%29.png)
...
![Reimbursement Complete](/images/image%20%2899%29.png)
