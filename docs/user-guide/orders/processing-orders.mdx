...
### [Introduction](processing-orders#introduction) <a id="introduction"></a>

Once an order comes into your store - whether it is entered by a customer through the website frontend or you [manually enter it yourself](manual-order-entry) through the admin backend - it needs to be processed. That means these steps need to be taken:
...
### [Processing Payments](processing-orders#processing-payments) <a id="processing-payments"></a>
...
### [Processing Shipments](processing-orders#processing-shipments) <a id="processing-shipments"></a>
