...
### [Product Properties](product-properties#product-properties) <a id="product-properties"></a>
...
![New Product Variant](/images/image%20%2888%29.png)

#### [Adding a Product Property](product-properties#adding-a-product-property) <a id="adding-a-product-property"></a>
...
![Properties List](/images/image%20%2896%29.png)
