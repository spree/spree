...
### [Option Types and Option Values](product-options#option-types-and-option-values) <a id="option-types-and-option-values"></a>
...
#### [Creating Option Types and Option Values](product-options#creating-option-types-and-option-values) <a id="creating-option-types-and-option-values"></a>
...
![New Option Type](/images/image%20%2886%29.png)
...
![New Option Value](/images/image%20%2887%29.png)
...
![Completed Option Values](/images/image%20%28102%29.png)
...
#### [Associating Option Values with a Product](product-options#associating-option-values-with-a-product) <a id="associating-option-values-with-a-product"></a>
...
![Option Types Dropdown List](/images/image%20%2898%29.png)
