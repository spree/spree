...
## [Searching Products](searching-products#searching-products)
...
* **Edit** - Allows you to make [additional changes to product](editing-products).
* **Clone** - Allows you to make a [duplicate of the product](cloning-products).
* **Delete** - Allows you to [delete the product](deleting-products).

![Product Search](/images/image2%20%283%29.png)

### [Filtering products](searching-products#filtering-products) <a id="filtering-products"></a>
