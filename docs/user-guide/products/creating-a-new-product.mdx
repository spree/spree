...
### [Introduction](creating-a-new-product#introduction) <a id="introduction"></a>
...
![New Product Entry Form](/images/cre1.png)
...
[Prototypes](prototypes) are a more complex topic and are covered in their own guide.

### [Product Details](creating-a-new-product#product-details) <a id="product-details"></a>
...
![Product Edit Form](/images/cre2.png)
...
* **Shipping Categories** - You will learn about setting up Shipping Categories in the [Shipping Categories](../shipments/shipping-categories).
* **Tax Category** - You will learn about setting up Tax Categories in the [Taxes Guide](../configuration/taxes).
* **Taxons** - Taxons are basically like categories. You will learn more about them in the [Taxonomies Guide](taxonomies-and-taxons).
* **Option Types** - You can select any number of Options to associate your new product with. You’ll learn more about Options in the [Options Guide](product-options#option-types-and-option-values).
...
### [Images](creating-a-new-product#images) <a id="images"></a>
...
### [Understanding Variants](creating-a-new-product#understanding-variants) <a id="understanding-variants"></a>
...
### [Product Properties](creating-a-new-product#product-properties) <a id="product-properties"></a>
...
You can read much more in-depth information about this feature in the [Product Properties Guide](product-properties).

### [Stock Management](creating-a-new-product#stock-management) <a id="stock-management"></a>

As of Spree version 2.0, you now have much more granular control over how inventory is tracked through your store. You will learn more about stock locations in the [Stock Locations Guide](../configuration/inventory), but for now, it’s enough to understand that you enter the number of each product variant that you have at each of your individual stock locations.

Let’s assume that you have two stock locations - your main New York warehouse and your satellite Detroit warehouse. Refer to the instructions on creating stock locations in the [Stock Locations Guide](../configuration/inventory) to add your warehouses.
...
You should be sure to read the [Stock Locations](../configuration/inventory#stock-locations) and [Stock Movements](../configuration/inventory#stock-movements) guides for further information on managing your store’s inventory.
