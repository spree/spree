...
This guide presumes you have already created the [Option Types](product-options) and [Properties](product-properties) you need for your new prototype. If you haven’t, you should do that first before proceeding.

#### [Creating a Prototype](prototypes#creating-a-prototype) <a id="creating-a-prototype"></a>
...
## [Using a Prototype to Create Products](prototypes#using-a-prototype-to-create-products) <a id="using-a-prototype-to-create-products"></a>
...
When you do so, the Spree system shows you values for both of the Option Types you entered, so that it can automatically create [Product Variants](creating-a-new-product#understanding-variants) for each of them.
...
Proceed with [creating the product](creating-a-new-product) as you would normally, adding any missing fields not supplied by the prototype.

Be sure to update each of the Variants with corresponding images, SKUs, and correct pricing, if applicable.[  
](https://github.com/spree/spree/edit/master/guides/src/content/user/products/product_prototypes)
