...
canonical: "https://spreecommerce.org/docs/user/settings/tax"
---
...
<Note>Tax rates in Spree rely on the Zones feature to determine where each rate applies. Zones define geographic regions (like countries or states), allowing you to target specific tax rules based on a customer's shipping address. See [<u>Settings → Zones</u>](/v5/user/settings/zones) for more.</Note>
...
- [<u>Settings → Zones</u>](/v5/user/settings/zones)
