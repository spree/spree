---
title: "Users"
description: "Invite, edit, and manage admin users in the Spree dashboard — send invitations, assign roles, track pending invites, and control backend access for your team."
canonical: "https://spreecommerce.org/docs/user/settings/users"
---
...
However, you can currently create roles and apply permissions to them via code. Please refer to our developer docs for more info: [<u>Customization → Permissions</u>](/v5/developer/customization/permissions).
