...
description: "Define and manage custom metafields in Spree to attach extra structured data to products, orders, and other store objects without code changes."
canonical: "https://spreecommerce.org/docs/user/settings/metafields"
---
