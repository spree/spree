...
canonical: "https://spreecommerce.org/docs/user/products/creating-products"
---
...
See [<u>Product Metafields</u>](/v5/user/manage-products/product-metafields) to learn how to create metafield definitions and add values to your products.
