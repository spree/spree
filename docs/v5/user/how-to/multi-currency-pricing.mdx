...
canonical: "https://spreecommerce.org/docs/user/how-to/multi-currency-pricing"
---
...
1. Look for the market switcher in your storefront's navigation. If you're using the Spree Next.js Storefront, this appears in the navigation bar.
...
- [<u>Set Up Multi-Region Pricing</u>](https://spreecommerce.org/docs/user/how-to/multi-region-pricing) — charge different prices within the same currency for different markets
