...
canonical: "https://spreecommerce.org/docs/developer/core-concepts/markets"
---
...
Markets let you segment a single [Store](/v5/developer/core-concepts/stores) into distinct geographic regions, each with its own currency, locale, and set of countries. For example, an international store might define:
...
See [Taxes](/v5/developer/core-concepts/taxes) for details on tax zones and rates.

## Pricing Integration

Markets integrate with the [Pricing](/v5/developer/core-concepts/pricing) system, enabling market-specific pricing through **Price Lists** with a **Market Rule**. This lets you set different prices for the same product in different markets — beyond just currency conversion.
...
See [Pricing — Price Rules](/v5/developer/core-concepts/pricing#price-rules) for details on configuring market-specific price lists.
...
- [Markets (Store SDK)](/v5/developer/sdk/store/markets) — Listing, resolving, and reading markets from the Store SDK
- [Pricing](/v5/developer/core-concepts/pricing) — Price Lists, Price Rules, and the Pricing Context
- [Addresses](/v5/developer/core-concepts/addresses) — Countries, States, and Zones
- [Localization](/api-reference/store-api/localization) — Locale, currency, and country headers in API requests
- [Translations](/v5/developer/core-concepts/translations) — Resource and UI translations
