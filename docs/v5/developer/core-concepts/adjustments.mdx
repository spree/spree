...
canonical: "https://spreecommerce.org/docs/v5/developer/core-concepts/adjustments"
---

## Overview

An Adjustment modifies the price of an [Order](/v5/developer/core-concepts/orders), a [Line Item](/v5/developer/core-concepts/orders#line-items), or a [Shipment](/v5/developer/core-concepts/shipments). Adjustments can be positive (charges) or negative (credits).
...
- **Source** is where the adjustment comes from ([Tax Rate](/v5/developer/core-concepts/taxes) or [Promotion Action](/v5/developer/core-concepts/promotions))
...
|--------|---------|----------------|
| [Tax Rate](/v5/developer/core-concepts/taxes) | Sales tax, VAT | Positive (charge) |
| [Promotion Action](/v5/developer/core-concepts/promotions) | Coupon discount, free shipping | Negative (credit) |
...
Adjustments appear in order responses when you [`?expand=items,fulfillments`](/api-reference/store-api/relations) on the order. The response exposes the [`amount`, `adjustment_total`, and the tax totals](/api-reference/store-api/monetary-amounts) as money fields:
...
- [Promotions](/v5/developer/core-concepts/promotions) — Promotion-based adjustments
- [Taxes](/v5/developer/core-concepts/taxes) — Tax adjustments
- [Shipments](/v5/developer/core-concepts/shipments) — Shipping adjustments
- [Orders](/v5/developer/core-concepts/orders) — How adjustments affect order totals
- [Calculators](/v5/developer/core-concepts/calculators) — How tax rate and promotion action amounts are computed
