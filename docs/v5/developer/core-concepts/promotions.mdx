...
canonical: "https://spreecommerce.org/docs/developer/core-concepts/promotions"
---
...
- **[Adjustments](/v5/developer/core-concepts/adjustments)** are created on orders/line items to apply discounts
...
Create and manage promotions via the [Admin API](/api-reference/admin-api/introduction). Rules and actions can be supplied inline on create — each is a `{ type, preferences }` draft using the rule/action types described above:
...
Customers [apply coupon codes during checkout](/v5/developer/sdk/store/cart-checkout) via the Store API:
...
- [Build Custom Promotion Rules & Actions](/v5/developer/how-to/custom-promotion) - Step-by-step guide to creating custom rules and actions
- [Calculators](/v5/developer/core-concepts/calculators) - Learn about promotion calculators
- [Orders](/v5/developer/core-concepts/orders) - Understanding order processing
- [Customization Quickstart](/v5/developer/customization/quickstart) - Overview of customization options
- [Admin SDK Resources](/v5/developer/sdk/admin/resources) - The `client.promotions.*` resource-client pattern used in the examples above
- [Spree CLI Admin API](/v5/developer/cli/admin-api) - The `spree api` command reference for the CLI examples above
