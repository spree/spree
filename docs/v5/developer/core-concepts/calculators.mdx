---
title: Calculators
canonical: "https://spreecommerce.org/docs/developer/core-concepts/calculators"
---
...
- Used by **[Tax Rates](/v5/developer/core-concepts/taxes)** to calculate tax amounts
- Used by **[Shipping Methods](/v5/developer/core-concepts/shipments)** to calculate shipping costs
- Used by **[Promotion Actions](/v5/developer/core-concepts/promotions)** to calculate discounts
- Calculators store [preferences (rates, percentages, etc.)](/v5/developer/customization/model-preferences) for their calculations
...
For information about this calculator, please read the [Taxes](/v5/developer/core-concepts/taxes) guide.
...
- [Adjustments](/v5/developer/core-concepts/adjustments) — the records calculators compute amounts for.
- [Dependencies](/v5/developer/customization/dependencies) — swap out calculators via the Dependencies system.
