...
canonical: "https://spreecommerce.org/docs/v5/developer/core-concepts/users"
---
...
<Info>
You can use your own user classes. See the [Customize Authentication guide](/v5/developer/customization/authentication) for details.
</Info>
...
The response includes a [JWT token](/api-reference/store-api/authentication) and a `user` object. Pass the token in subsequent requests via the `Authorization: Bearer <token>` header. See the [account SDK guide](/v5/developer/sdk/store/account) for the full `auth.login`, refresh, and profile flows.
...
<Info>
You can create custom roles with specific permissions. See the [Customize Permissions guide](/v5/developer/customization/permissions) for details.
</Info>
...
The invitation system publishes [events](/v5/developer/core-concepts/events) you can subscribe to:
...
See the [Customize Permissions guide](/v5/developer/customization/permissions) for details on creating custom roles and permission sets.
...
- [Permissions](/v5/developer/customization/permissions) — Roles and authorization
- [Events](/v5/developer/core-concepts/events) — Subscribe to user and invitation events
- [Store API Authentication](/api-reference/store-api/authentication) — Customer JWT auth flow
- [Admin API Authentication](/api-reference/admin-api/authentication) — Staff JWT + scopes auth flow
