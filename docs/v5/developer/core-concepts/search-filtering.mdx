...
canonical: "https://spreecommerce.org/docs/developer/core-concepts/search-filtering"
---
...
See [Build a Custom Search Provider](/v5/developer/how-to/custom-search-provider) for architecture details and how to build custom providers.

## Related Documentation

- [Products](/v5/developer/core-concepts/products) — Product catalog and listing
- [Store SDK Products](/v5/developer/sdk/store/products) — `client.products.list()` options and methods
...
- [Build a Custom Search Provider](/v5/developer/how-to/custom-search-provider) — Step-by-step guide
