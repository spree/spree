...
canonical: "https://spreecommerce.org/docs/developer/core-concepts/staff-roles"
---
...
Using the [Admin SDK](/v5/developer/sdk/admin/quickstart), call `client.invitations.create`:
...
- [Admin SDK](/v5/developer/sdk/admin/quickstart) — the TypeScript client for back-office automation
- [Custom API Authentication](/v5/developer/how-to/custom-api-authentication) — implement a custom identity-provider strategy (the full guide)
- [Admin API Authentication](/api-reference/admin-api/authentication) — keys, JWTs, scopes, and the refresh-cookie flow
- [Customers](/v5/developer/core-concepts/customers) — Customer accounts and authentication
- [Permissions](/v5/developer/customization/permissions) — Roles and authorization
- [Events](/v5/developer/core-concepts/events) — Subscribe to invitation events
