...
canonical: "https://spreecommerce.org/docs/developer/core-concepts/pricing"
---
...
Base prices are set per variant per currency. Use the [Admin API](/api-reference/admin-api/introduction) — via the [Admin SDK](/v5/developer/sdk/admin/quickstart) — to set them individually or in bulk (`bulk_upsert` matches on variant + currency):
...
- **Market-based pricing** — different prices for different [Markets](/v5/developer/core-concepts/markets) (e.g., North America vs Europe)
...
|------|-------------|----------|
| **Market Rule** | Matches based on the current [Market](/v5/developer/core-concepts/markets) | Regional pricing across markets |
...
<Info>
Custom Price Rules can be created for specialized pricing logic. See the [Customization Quickstart](/v5/developer/customization/quickstart) for details.
</Info>
...
| Market | Customer's country | The [Market](/v5/developer/core-concepts/markets) for market-based rules |
...
- [Products](/v5/developer/core-concepts/products) — Products, Variants, and base prices
- [Store SDK: Products](/v5/developer/sdk/store/products) — Fetching product and variant prices with the Store SDK
- [Markets](/v5/developer/core-concepts/markets) — Geographic regions with currency and locale
- [Taxes](/v5/developer/core-concepts/taxes) — Tax categories, tax rates, and zones
- [Promotions](/v5/developer/core-concepts/promotions) — Discount-based pricing via promotion rules
