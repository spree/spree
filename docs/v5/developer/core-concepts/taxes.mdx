...
canonical: "https://spreecommerce.org/docs/developer/core-concepts/taxes"
---

## Overview

Spree uses Tax Categories and Tax Rates to calculate taxes for orders. Products are assigned to tax categories, and tax rates define the percentage charged within specific geographic [Zones](/v5/developer/core-concepts/addresses#zones).
...
- **Tax Rate** defines the percentage and rules for a Tax Category within a [Zone](/v5/developer/core-concepts/addresses#zones)
- **Zone** defines geographic regions (countries or states) where taxes apply
- **[Adjustments](/v5/developer/core-concepts/adjustments)** are created on orders/line items to apply taxes
...
Manage tax categories via the [Admin API](/api-reference/admin-api/introduction), using the [Admin SDK resource clients](/v5/developer/sdk/admin/resources):
...
<Info>
The `tax_inclusive` setting on [Markets](/v5/developer/core-concepts/markets) controls whether prices are displayed with or without tax for each geographic region.
</Info>
...
1. The customer's shipping address determines their [Zone](/v5/developer/core-concepts/addresses#zones)
2. Spree finds matching tax rates for that zone and the product's tax category
3. Tax [Adjustments](/v5/developer/core-concepts/adjustments) are created on line items
...
- [Markets](/v5/developer/core-concepts/markets) — Tax-inclusive pricing per market
- [Addresses](/v5/developer/core-concepts/addresses) — Zones and address-based taxation
- [Adjustments](/v5/developer/core-concepts/adjustments) — Tax adjustments
- [Orders](/v5/developer/core-concepts/orders) — How taxes affect order totals
- [Avalara integration](/integrations/tax/avalara) — Automated tax calculation for complex jurisdictions
