...
canonical: "https://spreecommerce.org/docs/developer/core-concepts/store-credits-gift-cards"
---
...
Store credits can also be created via the [Admin API](/api-reference/admin-api/introduction), as a nested resource under the customer:
...
Gift cards can also be created via the [Admin API](/api-reference/admin-api/introduction). The code is generated automatically if you don't supply one:
...
- [Payments](/v5/developer/core-concepts/payments) — Payment processing and methods
- [Orders](/v5/developer/core-concepts/orders) — Order management
- [Customers](/v5/developer/core-concepts/customers) — Customer management
- [Events](/v5/developer/core-concepts/events) — Event system and subscribers
- [Admin SDK Quickstart](/v5/developer/sdk/admin/quickstart) — Set up and authenticate the Admin SDK
- [Monetary Amounts](/api-reference/store-api/monetary-amounts) — How the API represents `amount`, `amount_used`, and other money fields
