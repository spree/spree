...
canonical: "https://spreecommerce.org/docs/developer/core-concepts/translations"
---
...
For configuring which locales and currencies are available in your store, see [Markets](/v5/developer/core-concepts/markets). Markets control locale and currency assignment per geographic region.
...
Slugs are also localized — a product can have different slugs per locale. See [Slugs](/v5/developer/core-concepts/slugs#internationalization) for details.
...
Translations can also be [managed via the Admin API](/v5/developer/sdk/admin/quickstart).
...
- [Markets](/v5/developer/core-concepts/markets) — Locale and currency configuration per geographic region
- [Localization](/api-reference/store-api/localization) — Locale, currency, and country headers in API requests
- [Slugs](/v5/developer/core-concepts/slugs) — Localized slugs and URL identifiers
- [Products](/v5/developer/core-concepts/products) — Product translations
