---
title: Reports
canonical: "https://spreecommerce.org/docs/v5/developer/core-concepts/reports"
---
...
- [Build a Custom Report](/v5/developer/how-to/custom-report) - Step-by-step guide to creating custom reports
- [Events](/v5/developer/core-concepts/events) - How report generation uses the events system
- [Imports & Exports](/v5/developer/core-concepts/imports-exports) - The broader async-export, ActiveStorage-attachment pattern reports share
- [Admin API Endpoints](/api-reference/admin-api/endpoints) - Endpoints for creating and downloading reports from an integration
