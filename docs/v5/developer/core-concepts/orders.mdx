...
canonical: "https://spreecommerce.org/docs/developer/core-concepts/orders"
---
...
**Key relationships:**
- **Line Items** link orders to [Variants](/v5/developer/core-concepts/products#variants) (what was purchased)
- **[Shipments](/v5/developer/core-concepts/shipments)** handle fulfillment from stock locations
- **[Payments](/v5/developer/core-concepts/payments)** track payment attempts and their states
- **[Adjustments](/v5/developer/core-concepts/adjustments)** apply taxes, promotions, and shipping costs
- **[Addresses](/v5/developer/core-concepts/addresses)** store billing and shipping information
...
Line items represent individual products in an order. Each line item links to a [Variant](/v5/developer/core-concepts/products#variants) and tracks the quantity and price at the time of purchase.
...
[Adjustments](/v5/developer/core-concepts/adjustments) modify an order's total — promotions decrease it, taxes and shipping increase it. Adjustments can be applied at the order level, the line item level, or the shipment level.
...
For more details, see [Shipments](/v5/developer/core-concepts/shipments) and [Payments](/v5/developer/core-concepts/payments).

## Related Documentation

- [Cart, Checkout & Orders](/v5/developer/sdk/store/cart-checkout) — Store SDK guide for carts, checkout, coupon codes, and order history
- [Payments](/v5/developer/core-concepts/payments) — Payment processing and payment sessions
- [Shipments](/v5/developer/core-concepts/shipments) — Fulfillment and shipping rates
- [Addresses](/v5/developer/core-concepts/addresses) — Billing and shipping addresses
- [Promotions](/v5/developer/core-concepts/promotions) — Discounts and coupon codes
- [Checkout Customization](/v5/developer/customization/checkout) — Customizing the checkout flow
- [Events](/v5/developer/core-concepts/events) — Subscribe to order events (e.g., `order.completed`)
