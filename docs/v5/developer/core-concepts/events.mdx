...
canonical: "https://spreecommerce.org/docs/developer/core-concepts/events"
---
...
To customize the payload for existing events, create a custom V3 serializer and configure it via [dependencies](/v5/developer/customization/dependencies):
...
- [Events Tutorial](/v5/developer/tutorial/events) - Hands-on, step-by-step walkthrough of building an event subscriber
...
- [Decorators](/v5/developer/customization/decorators) - When to use decorators vs events
- [Checkout Flow](/v5/developer/customization/checkout) - Using events in checkout customization
