...
canonical: "https://spreecommerce.org/docs/developer/core-concepts/slugs"
---
...
- [Translations](/v5/developer/core-concepts/translations) — Multi-language content
- [Querying](/api-reference/store-api/querying) — API resource lookup
- [Store SDK Products](/v5/developer/sdk/store/products) — `client.products.get()` slug/ID lookup
