...
canonical: "https://spreecommerce.org/docs/developer/sdk/extending"
---
...
For a complete walkthrough — creating the API endpoints on the backend, defining TypeScript types, filtering, and expanding associations — see the [API](/v5/developer/tutorial/api) and [SDK](/v5/developer/tutorial/sdk) tutorials.
