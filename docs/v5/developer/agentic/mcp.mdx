...
canonical: "https://spreecommerce.org/docs/developer/agentic/mcp"
---
...
| **[`@spree/docs` npm package](/v5/developer/agentic/llm-docs)** | Fast local reads inside a project — no network round-trip, works offline, pinned to what you installed |
| **[Agent skills](/v5/developer/agentic/agent-skills)** | Conventions and how-to knowledge the agent should apply without searching at all |
