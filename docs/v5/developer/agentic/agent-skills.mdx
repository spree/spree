...
canonical: "https://spreecommerce.org/docs/developer/agentic/agent-skills"
---
...
- **create-spree-app projects** (Docker, Rails app in `backend/`) — commands route through the [Spree CLI](/v5/developer/cli/quickstart) (`spree migrate`, `spree console`, …).
