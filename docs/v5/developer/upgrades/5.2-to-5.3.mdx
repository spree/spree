...
canonical: "https://spreecommerce.org/docs/v5/developer/upgrades/5.2-to-5.3"
---

<Info>
  Before proceeding to upgrade, please ensure you're at [Spree 5.2](/v5/developer/upgrades/5.1-to-5.2)
</Info>
...
See the [Admin Tables documentation](/v5/developer/admin/tables) for more details.
