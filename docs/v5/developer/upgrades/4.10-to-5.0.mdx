...
canonical: "https://spreecommerce.org/docs/v5/developer/upgrades/4.10-to-5.0"
---

<Info>
  Before proceeding to upgrade, please ensure you're at [Spree 4.10](/v5/developer/upgrades/4.9-to-4.10)
</Info>
...
- [Spree 5.1](https://github.com/spree/spree/releases/tag/v5.1.0) includes native [Gift Cards](/v5/developer/core-concepts/store-credits-gift-cards), Admin Staff Management & Invitations
- [Spree 5.2](https://github.com/spree/spree/releases/tag/v5.2.0) includes [Metafields](/v5/developer/core-concepts/metafields), CSV Importer, Store Policies & Newsletter Subscribers
- [Spree 5.3](https://github.com/spree/spree/releases/tag/v5.3.0) includes new highly flexible [Pricing Engine](/v5/user/manage-products/price-lists) for B2B, Wholesale and Volume discounts, [Events & Subscribers Engine](/v5/developer/core-concepts/events), [Webhooks](/v5/developer/core-concepts/webhooks), [Customer Groups](/v5/user/customers/customer-groups)
