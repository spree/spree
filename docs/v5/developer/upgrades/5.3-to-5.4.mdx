...
canonical: "https://spreecommerce.org/docs/v5/developer/upgrades/5.3-to-5.4"
---

<Info>
  Before proceeding to upgrade, please ensure you're at [Spree 5.3](/v5/developer/upgrades/5.2-to-5.3)
</Info>
...
Spree 5.4 introduces [Markets](/v5/developer/core-concepts/markets) as the primary way to manage which countries are available for checkout, along with their currencies and locales. The legacy `checkout_zone` field on the Store model is now deprecated and will be removed in Spree 6.0.
...
|---|---|
| `store.checkout_zone` | Use [Markets](/v5/developer/core-concepts/markets) to manage countries |
| `store.checkout_zone=` | Use [Markets](/v5/developer/core-concepts/markets) to manage countries |
...
Product Properties have been extracted from Spree core to a separate gem `spree_legacy_product_properties`. Product Properties were already deprecated in favor of [Metafields](/v5/developer/core-concepts/metafields) and disabled by default since Spree 5.1.
