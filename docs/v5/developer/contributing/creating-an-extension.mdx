...
canonical: "https://spreecommerce.org/docs/developer/contributing/creating-an-extension"
---
...
<Info>
  This tutorial uses decorators for extending Spree models. For extensions that need to react to events (sync with external services, send notifications, etc.), consider using [Events subscribers](/v5/developer/core-concepts/events) instead - they're easier to test and maintain. See [Customization Quickstart](/v5/developer/customization/quickstart) for guidance on choosing the right approach.
</Info>
...
The first thing we need to do is create a migration that adds a sale_price column to [variants](/v5/developer/core-concepts/products#variants).
...
| React to model changes | [Events subscribers](/v5/developer/core-concepts/events) |
| External service integration | [Webhooks](/v5/developer/core-concepts/webhooks) |
| Replace core services | [Dependencies injection](/v5/developer/customization/dependencies) |
| Add admin UI elements | [Admin Partials](/v5/developer/admin/extending-ui) |
| Add admin menu items | [Admin Navigation](/v5/developer/admin/navigation) |
...
- [Events](/v5/developer/core-concepts/events) - Subscribe to Spree events
- [Webhooks](/v5/developer/core-concepts/webhooks) - HTTP callbacks for external integrations
- [Dependencies](/v5/developer/customization/dependencies) - Replace core services
- [Customization Quickstart](/v5/developer/customization/quickstart) - Choose the right approach
