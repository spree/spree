...
canonical: "https://spreecommerce.org/docs/developer/contributing/developing-spree"
---
...
We also ship [agent skills](/v5/developer/agentic/agent-skills) (`npx skills add spree/agent-skills`), a [docs MCP server](/v5/developer/agentic/mcp), and [LLM-ready documentation](/v5/developer/agentic/llm-docs) — see the [Agentic Development docs](/v5/developer/agentic/overview) for setup across Claude Code, Cursor, Copilot, and other tools.
