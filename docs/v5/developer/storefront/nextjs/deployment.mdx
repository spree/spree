...
canonical: "https://spreecommerce.org/docs/developer/storefront/nextjs/deployment"
---

## Environment Variables

At minimum, set `SPREE_API_URL` and `SPREE_PUBLISHABLE_KEY` in your hosting platform's dashboard or `.env` file. See [Environment Variables](/v5/developer/storefront/nextjs/environment-variables) for the full reference — analytics, error tracking, wholesale, emails, and SEO.
...
3. Add environment variables:
   ...
   - `SPREE_WEBHOOK_SECRET`, `RESEND_API_KEY`, `EMAIL_FROM` — for [transactional emails](/v5/developer/storefront/nextjs/emails)
   ...
   See the [Environment Variables reference](/v5/developer/storefront/nextjs/environment-variables) for the full list.
4. Click **Deploy**
