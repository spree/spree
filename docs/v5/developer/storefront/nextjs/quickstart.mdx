...
canonical: "https://spreecommerce.org/docs/developer/storefront/nextjs/quickstart"
---
...
The fastest way to get a full project — Spree backend, this Next.js storefront, and the `spree` CLI, wired together — is [`create-spree-app`](/v5/developer/create-spree-app/quickstart):
...
Then follow [Configuration](#configuration) to point it at your Spree API. If you plan to customize and track upstream changes, [fork first](/v5/developer/storefront/nextjs/customization#tracking-upstream-updates).
...
See [Deployment](/v5/developer/storefront/nextjs/deployment) for all optional environment variables (Sentry, GTM, etc.).
...
<Note>
  Testing Apple Pay / Google Pay locally needs a public HTTPS URL. See [Wallet Payments in Development](/v5/developer/storefront/nextjs/wallet-payments).
</Note>
...
See the [Deployment](/v5/developer/storefront/nextjs/deployment) guide for Vercel, Docker, and other hosting options.
