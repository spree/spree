...
canonical: "https://spreecommerce.org/docs/developer/storefront/nextjs/customization"
---

The storefront is yours to modify — the code ships in your project so you can restyle it, swap components, and change the data layer directly. Scaffold a project with [`create-spree-app`](/v5/developer/storefront/nextjs/quickstart#installation), then edit the storefront under `apps/storefront/`.
...
The storefront can render and send its own order, shipment, and account emails with react-email and Resend, driven by Spree webhooks. See the dedicated [Transactional Emails](/v5/developer/storefront/nextjs/emails) guide.
