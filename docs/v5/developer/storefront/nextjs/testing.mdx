...
canonical: "https://spreecommerce.org/docs/developer/storefront/nextjs/testing"
---
...
To click through the storefront against a running backend (no E2E harness), point it there directly: set `SPREE_API_URL` and `SPREE_PUBLISHABLE_KEY` in `.env.local` (see [Environment Variables](/v5/developer/storefront/nextjs/environment-variables)) and run `npm run dev`.
