...
canonical: "https://spreecommerce.org/docs/developer/storefront/nextjs/environment-variables"
---
...
<Note>
  In a Docker build these two are also required at **build time** — the storefront prerenders pages against the Spree API. See [Deployment](/v5/developer/storefront/nextjs/deployment).
</Note>
...
The [wholesale portal](/v5/developer/storefront/nextjs/wholesale) is an opt-in addon, off by default.
...
See the [Transactional Emails](/v5/developer/storefront/nextjs/emails) guide for the full setup.
