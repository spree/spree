---
title: "Sections"
description: "Build Spree Rails Storefront pages with layout and content sections, including ActiveRecord models, theme views, and Page Builder admin forms."
canonical: "https://spreecommerce.org/docs/v5/developer/storefront/rails/sections"
---
...
Each section has set of default [preferences](/v5/developer/customization/model-preferences)
