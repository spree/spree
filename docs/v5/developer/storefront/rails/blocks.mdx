...
canonical: "https://spreecommerce.org/docs/v5/developer/storefront/rails/blocks"
---

Blocks are the lowest level of components in Spree Storefront. They are nested inside [sections](/v5/developer/storefront/rails/sections) and represent individual content elements like headings, text, buttons, and images.
...
- [Sections](/v5/developer/storefront/rails/sections) - Parent containers for blocks
- [Links](/v5/developer/storefront/rails/links) - Adding links to blocks
- [Media](/v5/developer/core-concepts/media) - Working with images
