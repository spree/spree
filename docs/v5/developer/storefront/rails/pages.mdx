...
sidebarTitle: "Pages"
description: "Learn how to create and use pages in your Spree Rails storefront"
canonical: "https://spreecommerce.org/docs/v5/developer/storefront/rails/pages"
---
...
Each page is made of [sections](/v5/developer/storefront/rails/sections). Sections are the building blocks of a page. They are used to create the page content.
