...
sidebarTitle: "Themes"
description: "Create and customize themes for the Spree Rails Storefront, including theme generators, template structure, and registering themes with the Page Builder."
canonical: "https://spreecommerce.org/docs/v5/developer/storefront/rails/themes"
---
...
These are standard [Spree preferences](/v5/developer/customization/model-preferences) that are configurable via Page Builder.
