...
canonical: "https://spreecommerce.org/docs/v5/developer/storefront/rails/links"
---

Links are used to create navigation throughout the storefront. They can be assigned to [sections](/v5/developer/storefront/rails/sections) and [blocks](/v5/developer/storefront/rails/blocks), enabling users to navigate to different pages, products, categories, or external URLs.
...
- [Sections](/v5/developer/storefront/rails/sections) - Adding links to sections
- [Blocks](/v5/developer/storefront/rails/blocks) - Adding links to blocks
- [Pages](/v5/developer/storefront/rails/pages) - Understanding internal page linking
