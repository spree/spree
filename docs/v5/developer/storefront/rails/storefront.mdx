...
description: "Install and configure the Spree Rails Storefront, a mobile-first, themeable storefront built with Tailwind CSS, Turbo, Stimulus, and Importmaps."
canonical: "https://spreecommerce.org/docs/v5/developer/storefront/rails/storefront"
---
...
<CardGroup>
  <Card title="Themes" href="/developer/storefront/rails/themes">
    Themes are a collection of styles, scripts and templates that are used to style and layout the storefront.
  </Card>
  <Card title="Pages" href="/developer/storefront/rails/pages">
  ...
  <Card title="Sections" href="/developer/storefront/rails/sections">
  ...
  <Card title="Blocks" href="/developer/storefront/rails/blocks">
    Blocks are the smallest building blocks of the storefront. They are used to create the content of the pages.
  </Card>
  <Card title="Links" href="/developer/storefront/rails/links">
