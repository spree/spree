---
title: Assets
canonical: "https://spreecommerce.org/docs/developer/deployment/assets"
---

By default, files are stored on the local filesystem. For production, use a cloud storage service.

Spree auto-detects the storage provider based on which environment variables are set — no code changes needed. See [Environment Variables](/v5/developer/deployment/environment_variables#file-storage-s3--cloudflare-r2) for the full list.
