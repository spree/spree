...
canonical: "https://spreecommerce.org/docs/developer/deployment/quickstart"
---
...
Spree ships as a standard [Docker image](/v5/developer/deployment/docker), which means it runs wherever containers run:
...
See [Database Configuration](/v5/developer/deployment/database) for details.
...
See [Storefront Deployment](/v5/developer/storefront/nextjs/deployment) for the full guide.
...
For any other platform, the [Docker guide](/v5/developer/deployment/docker) covers building and running your project's image — which is all any container host needs.
