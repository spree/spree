...
canonical: "https://spreecommerce.org/docs/developer/deployment/cdn"
---
...
Static asset URLs and image/attachment URLs (including those in API responses) will then use this host instead of [`RAILS_HOST`](/v5/developer/deployment/environment_variables#urls-and-hosts). Host only, no protocol — URLs keep the scheme of your primary host.