...
canonical: "https://spreecommerce.org/docs/v5/developer/tutorial/extending-models"
---
...
<Info>
  This guide assumes you've completed the [Model](/v5/developer/tutorial/model) and [Admin](/v5/developer/tutorial/admin) tutorials.
</Info>
...
| React to model changes (after save, etc.) | [Events subscriber](/v5/developer/core-concepts/events) |
| Sync with external service on changes | [Events](/v5/developer/core-concepts/events) or [Webhooks](/v5/developer/core-concepts/webhooks) |
| Add searchable/filterable field | [Ransack configuration](/v5/developer/core-concepts/search-filtering#extending-ransackable-configuration) |
| Add admin UI elements | [Admin Partials](/v5/developer/admin/extending-ui) |

<Info>
  This tutorial uses **decorators** because we're adding a structural association between models. For behavioral changes like callbacks, prefer [Events](/v5/developer/core-concepts/events) instead - they're easier to test and maintain.
</Info>
...
<Warning>
  For callbacks that trigger side effects (syncing to external services, sending notifications, etc.), use [Events subscribers](/v5/developer/core-concepts/events) instead of decorator callbacks. Events are easier to test and won't break during Spree upgrades.
</Warning>
...
**Events approach** (recommended for side effects): subscribe to `product.updated` and react in a `Spree::Subscriber` — no decorator, no callback coupling. The [Events & Webhooks tutorial](/v5/developer/tutorial/events) builds this out fully, including external-system sync (OMS, warehouse) and outbound webhooks.
...
<Info>
  SEO features like slugs, meta titles, and FriendlyId are covered in the [Slugs](/v5/developer/core-concepts/slugs) documentation.
</Info>
...
- [Model Tutorial](/v5/developer/tutorial/model) - Creating the Brand model
- [Admin Tutorial](/v5/developer/tutorial/admin) - Building the admin interface
- [API Tutorial](/v5/developer/tutorial/api) - Exposing brands through the API
- [Events & Webhooks tutorial](/v5/developer/tutorial/events) - Subscribers, custom events, and webhooks in the Brand storyline
- [Events](/v5/developer/core-concepts/events) - Subscribe to model changes without decorators
- [Webhooks](/v5/developer/core-concepts/webhooks) - HTTP callbacks for external integrations
- [Decorators](/v5/developer/customization/decorators) - Full decorator reference
- [Customization Overview](/v5/developer/customization/quickstart) - More customization patterns
- [Products](/v5/developer/core-concepts/products) - Product model documentation
