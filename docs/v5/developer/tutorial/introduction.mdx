...
canonical: "https://spreecommerce.org/docs/v5/developer/tutorial/introduction"
---

This tutorial walks you through creating a complete Spree feature from scratch: a "Brands" feature that lets admins manage [Product](/v5/developer/core-concepts/products) brands, exposes them through the Store API, and consumes them from TypeScript.
...
You need a running Spree app. The fastest path is [create-spree-app](/v5/developer/create-spree-app/quickstart) — a Docker-based project with the [Spree CLI](/v5/developer/cli/quickstart), no local Ruby required:
...
<Tip>
  Using an AI coding agent? Install the [Spree agent skills](/v5/developer/agentic/agent-skills) (`npx skills add spree/agent-skills`) and connect the [docs MCP server](/v5/developer/agentic/mcp) before starting — your agent will know the conventions this tutorial teaches and can follow along with you. See [Agentic Development](/v5/developer/agentic/overview).
</Tip>
