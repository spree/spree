...
canonical: "https://spreecommerce.org/docs/v5/developer/tutorial/api"
---
...
<Info>
  This guide assumes you've completed the [Model](/v5/developer/tutorial/model), [Admin](/v5/developer/tutorial/admin), and [Extending Core Models](/v5/developer/tutorial/extending-models) tutorials.
</Info>
...
<Tip>
  Using an AI agent? The [Spree agent skills](/v5/developer/agentic/agent-skills) include a dedicated resource-generator skill — your agent knows the field syntax, the flags, and the generated-file contract.
</Tip>
...
1. **Prefixed IDs** — Stripe-style IDs like `brand_k5nR8xLq` instead of raw database IDs. The `spree:model` generator already added `has_prefix_id :brand` in the [Model step](/v5/developer/tutorial/model), so this is done.
...
<Info>
  Secret keys carry scopes (`read_brands`, `write_brands` style) and JWT admin users go through CanCanCan abilities — see [API authentication](/v5/developer/customization/api) for the full model. From TypeScript, the [Admin SDK](/v5/developer/sdk/admin/quickstart) wraps the Admin API with typed clients for all built-in resources.
</Info>
...
- [Extending Core Models](/v5/developer/tutorial/extending-models) - Adding the Brand association to Product
- [Events & Webhooks](/v5/developer/tutorial/events) - Lifecycle events for Brand and external-system integration (next step)
- [Using Brands with the SDK](/v5/developer/tutorial/sdk) - Consuming brand endpoints from TypeScript
- [Decorators](/v5/developer/customization/decorators) - Full decorator reference
- [Dependencies](/v5/developer/customization/dependencies) - Swapping services and serializers
