...
canonical: "https://spreecommerce.org/docs/developer/customization/workflows"
---
...
[Dependencies](/v5/developer/customization/dependencies) for how to swap either one
for your own class.
...
[event subscriber](/v5/developer/core-concepts/events), not a hook.
</Warning>
...
belong there: use an [event subscriber](/v5/developer/core-concepts/events) for
...
| Send an email, call a webhook, update a search index | An [event subscriber](/v5/developer/core-concepts/events) |
| Replace an operation entirely | [Dependencies](/v5/developer/customization/dependencies) |
