...
version: v5
canonical: "https://spreecommerce.org/docs/v5/developer/customization/authentication"
---
...
Please refer to the [Admin Panel Authentication](/v5/developer/admin/authentication) page for more details.
