---
title: Permissions
canonical: "https://spreecommerce.org/docs/developer/customization/permissions"
---
...
You can replace the entire ability class via [Dependencies](/v5/developer/customization/dependencies):
