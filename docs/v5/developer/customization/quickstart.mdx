...
canonical: "https://spreecommerce.org/docs/developer/customization/quickstart"
---
...
<AccordionGroup>
  ...
  <Accordion title="Configuration">
    **Best for:** Tweaking Spree's behavior globally without modifying source code.
    ...
    Please see [Configuration](/v5/developer/customization/configuration) section for more information.
  </Accordion>
  ...
  <Accordion title="Events and Subscribers">
    ...
    **Key benefits:**
    ...
    Please see [Events](/v5/developer/core-concepts/events) section for more information.
  </Accordion>
  ...
  <Accordion title="Webhooks">
    **Best for:** Notifying external services (ERPs, CRMs, fulfillment systems) when events occur.
    ...
    Please see [Webhooks](/v5/developer/core-concepts/webhooks) section for more information.
  </Accordion>
  ...
  <Accordion title="Admin Extensions">
    ...
    **Partials API** - Add sections to forms:
    ...
    Please see:
    - [Admin Navigation](/v5/developer/admin/navigation) - For adding menu items
    - [Admin Partials](/v5/developer/admin/extending-ui) - For extending UI
    - [Admin Tables](/v5/developer/admin/tables) - For customizing list views
  </Accordion>
  ...
  <Accordion title="Search and Filtering">
    **Best for:** Making custom fields searchable/sortable in the admin and API.
    ...
    Please see [Search & Filtering](/v5/developer/core-concepts/search-filtering#extending-ransackable-configuration) section for more information.
  </Accordion>
    ...
    **Best for:** Adding associations, validations, scopes, and methods to Spree models. Use as a last resort.
    ...
    <Warning>
      ...
      **Do NOT use decorators for:**
      - After-save callbacks → Use [Events](/v5/developer/core-concepts/events) instead
      - External service sync → Use [Webhooks](/v5/developer/core-concepts/webhooks) instead
