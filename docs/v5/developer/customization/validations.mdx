...
canonical: "https://spreecommerce.org/docs/developer/customization/validations"
---
...
|---|---|
| Whether an **operation** may happen — a purchase limit, B2B eligibility, a region policy | A workflow [`validate` hook](/v5/developer/customization/workflows) |
| The **shape of a record** — a field you added must be present, a format must match | A [decorator](/v5/developer/customization/decorators) adding a validation |
| A **new attribute** you need on an existing model | [Custom fields](/v5/developer/core-concepts/metafields) |
...
different flows. See [Services & Workflows](/v5/developer/customization/workflows)
...
[Decorators](/v5/developer/customization/decorators).
...
See the [Spree 6 quickstart](/developer/customization/quickstart) for the full registry API.
