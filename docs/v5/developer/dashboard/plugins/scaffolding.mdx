...
canonical: "https://spreecommerce.org/docs/developer/dashboard/plugins/scaffolding"
---
...
You now have a buildable plugin. The next page covers what to put in `package.json` for publishing — but if you're using it internally and importing by path, you can stop here and skip [Publishing](/v5/developer/dashboard/plugins/publishing).
