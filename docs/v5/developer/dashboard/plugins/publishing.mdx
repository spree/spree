...
canonical: "https://spreecommerce.org/docs/developer/dashboard/plugins/publishing"
---
...
`routes` (optional) points at your TanStack file-routes directory; the host build compiles it into its typed route tree — see the [routes guide](/v5/developer/dashboard/customization/routes).
