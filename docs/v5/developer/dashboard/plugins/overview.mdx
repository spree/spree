...
canonical: "https://spreecommerce.org/docs/developer/dashboard/plugins/overview"
---

If you're customizing the dashboard for your own project, you don't need a plugin. Drop the same code into `src/plugins.ts` in your dashboard app and skip this section entirely — start with the [Customization](/v5/developer/dashboard/customization/quickstart) docs.
...
- [Scaffolding](/v5/developer/dashboard/plugins/scaffolding) — `spree plugin new <name>` generates the monorepo
- [Publishing](/v5/developer/dashboard/plugins/publishing) — package metadata, semver, the npm bits
- [Distributing](/v5/developer/dashboard/plugins/distributing) — what consumers do to install it

If you haven't yet, read the [Customization](/v5/developer/dashboard/customization/quickstart) section first. It's where the registry API is documented; the plugin pages mostly cover *packaging* concerns.
