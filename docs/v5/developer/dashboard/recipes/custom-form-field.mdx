...
canonical: "https://spreecommerce.org/docs/developer/dashboard/recipes/custom-form-field"
---
...
Expose it on the Admin API — the serializer returns `tech_specs`, and the products controller permits it on write (see [Backend integration](/v5/developer/dashboard/customization/backend)). Read and write names must match.
...
To also surface the attribute as a **table column with filtering and sorting**, continue with [A product attribute, end to end](/v5/developer/dashboard/recipes/attribute-end-to-end).

## Reference

- [Custom fields](/v5/developer/customization/metadata) — definitions, types, the API
- [Slots](/v5/developer/dashboard/customization/slots) — the injection mechanism
