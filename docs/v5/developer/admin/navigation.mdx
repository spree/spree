...
canonical: "https://spreecommerce.org/docs/v5/developer/admin/navigation"
---
...
- [Extending Admin UI](/v5/developer/admin/extending-ui) - Learn about other UI injection points
- [Admin Tables](/v5/developer/admin/tables) - Customize admin list views
- [Helper Methods](/v5/developer/admin/helper-methods) - Explore other admin helper methods
- [Permissions](/v5/developer/customization/permissions) - Understand the authorization system
