...
canonical: "https://spreecommerce.org/docs/v5/developer/admin/extending-ui"
---
...
<AccordionGroup>
  ...
  <Accordion title="Orders Filters">
    ...
    <ParamField path="f" type="Spree::Admin::FormBuilder">
      The [Spree::Admin::FormBuilder](/v5/developer/admin/form-builder) object.
    </ParamField>
    ...
    <Tip>
    * `q_number_cont` - The name of the filter field. For filtering we're using [ransack](/v5/developer/core-concepts/search-filtering) gem, so the name of the filter field is the name of the attribute we're filtering by.
...
<AccordionGroup>
  ...
  <Accordion title="Customers Filters">
    ...
    <Tip>
    * Use [ransack](/v5/developer/core-concepts/search-filtering) search syntax for filter field names
...
<AccordionGroup>
  ...
  <Accordion title="Stock Items Filters">
    ...
    <Tip>
    Use [ransack](/v5/developer/core-concepts/search-filtering) search syntax for filter field names (e.g., `_lt` for "less than").
    </Tip>
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Customer Returns Filters">
    ...
    <Tip>
    Use [ransack](/v5/developer/core-concepts/search-filtering) search syntax for filter field names (e.g., `_eq` for "equals").
    </Tip>
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Gift Cards Filters">
    ...
    <Tip>
    Use [ransack](/v5/developer/core-concepts/search-filtering) search syntax for filter field names (e.g., `_gt` for "greater than").
    </Tip>
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  ...
  <Accordion title="Products Filters">
    ...
    <Tip>
    * `q_name_cont` is the name of the filter field. For filtering we're using [ransack](/v5/developer/core-concepts/search-filtering) gem, so the name of the filter field is the name of the attribute we're filtering by.
...
- [Admin Navigation](/v5/developer/admin/navigation) - Add custom menu items to the admin
- [Admin Tables](/v5/developer/admin/tables) - Customize admin list views
- [Form Builder](/v5/developer/admin/form-builder) - Build admin forms with Spree's form helpers
- [Customization Quickstart](/v5/developer/customization/quickstart) - Overview of all customization options
