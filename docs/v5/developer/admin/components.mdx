...
canonical: "https://spreecommerce.org/docs/v5/developer/admin/components"
---
...
<Info>
  For comprehensive documentation on image handling, storage configuration, and best practices, see the [Media](/v5/developer/core-concepts/media) guide.
</Info>
