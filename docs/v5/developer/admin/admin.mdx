...
canonical: "https://spreecommerce.org/docs/v5/developer/admin/admin"
---
...
<Info>
  Learn more about creating admin sections in the [Admin Dashboard Tutorial](/v5/developer/tutorial/admin).
</Info>

### Views & Templates

Views use standard Rails ERB templates with Spree's [Form Builder](/v5/developer/admin/form-builder) and [Components](/v5/developer/admin/components):
...
<Info>
  Add custom JavaScript using [Stimulus controllers](/v5/developer/admin/custom-javascript).
</Info>
...
<Info>
  Learn how to customize styles in [Custom CSS](/v5/developer/admin/custom-css).
</Info>
...
|------|---------|---------------|
| Form Builder | Create consistent forms with validation | [Form Builder](/v5/developer/admin/form-builder) |
| Components | Dropdowns, dialogs, icons, badges, etc. | [Components](/v5/developer/admin/components) |
| Helper Methods | Navigation, links, utilities | [Helper Methods](/v5/developer/admin/helper-methods) |
| UI Extensions | Inject content into existing pages | [Extending UI](/v5/developer/admin/extending-ui) |
...
<Info>
  See [Authentication](/v5/developer/admin/authentication) for setup details.
</Info>
...
<Info>
  See [Permissions](/v5/developer/customization/permissions) for defining custom abilities.
</Info>
