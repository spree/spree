...
canonical: "https://spreecommerce.org/docs/v5/developer/admin/tables"
---
...
- [Extending Admin UI](/v5/developer/admin/extending-ui) - Inject partials into admin pages
- [Search & Filtering](/v5/developer/core-concepts/search-filtering) - Add searchable/filterable fields
