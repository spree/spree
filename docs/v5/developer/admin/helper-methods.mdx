...
canonical: "https://spreecommerce.org/docs/v5/developer/admin/helper-methods"
---
...
<Info>
  For UI components that render HTML elements (Dropdowns, Dialogs, Icons, etc.), see the [Components](/v5/developer/admin/components) documentation.
</Info>
...
See [Extending UI](/v5/developer/admin/extending-ui) for more information about injection points.
