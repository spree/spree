...
Before starting, make sure you understand [how splitting works in Spree](/v5/developer/core-concepts/shipments#stock-splitters) and the [order routing](/v5/developer/core-concepts/shipments#order-routing) layer that runs before splitters.

| If the answer is "yes" | Pick |
|---|---|
| Should this affect _which_ locations fulfill the order? | A [routing rule](/v5/developer/how-to/custom-order-routing#custom-routing-rules), not a splitter |
...
- [Shipments — Stock Splitters](/v5/developer/core-concepts/shipments#stock-splitters) — Concept overview and built-in splitter list
- [Build Custom Order Routing](/v5/developer/how-to/custom-order-routing) — The other layer of split-shipment customization
