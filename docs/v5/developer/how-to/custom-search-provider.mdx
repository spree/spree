...
canonical: "https://spreecommerce.org/docs/developer/how-to/custom-search-provider"
---
...
Before starting, make sure you understand [how search and filtering works in Spree](/v5/developer/core-concepts/search-filtering).
...
- [Search & Filtering](/v5/developer/core-concepts/search-filtering) — Store API search reference
