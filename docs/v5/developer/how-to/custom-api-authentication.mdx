...
canonical: "https://spreecommerce.org/docs/developer/how-to/custom-api-authentication"
---
...
- See also: [Staff & Roles](/v5/developer/core-concepts/staff-roles) for the admin login flow, [Customers](/v5/developer/core-concepts/customers) for storefront auth, and [Authentication](/v5/developer/customization/authentication) for `Spree.user_class` integration.
