...
canonical: "https://spreecommerce.org/docs/developer/how-to/custom-promotion"
---

## Overview

Spree's promotion system is built around two extension points: **Rules** (eligibility conditions) and **Actions** (what happens when a promotion applies). While Spree ships with a comprehensive set of [built-in rules and actions](/v5/developer/core-concepts/promotions#rules), you can create custom ones for business-specific logic.
...
Before starting, make sure you understand [how promotions work in Spree](/v5/developer/core-concepts/promotions).
...
Actions define what happens when a promotion is applied. Most actions create [adjustments](/v5/developer/core-concepts/adjustments) on orders or line items.
...
- [Promotions](/v5/developer/core-concepts/promotions) - Promotion architecture and built-in rules/actions
- [Calculators](/v5/developer/core-concepts/calculators) - Available calculator types for promotion actions
- [Adjustments](/v5/developer/core-concepts/adjustments) - How adjustments work on orders and line items
- [Events](/v5/developer/core-concepts/events) - Subscribe to promotion events
