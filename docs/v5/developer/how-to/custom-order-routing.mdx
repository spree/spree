...
canonical: "https://spreecommerce.org/docs/developer/how-to/custom-order-routing"
---
...
Order routing decides which [Stock Location](/v5/developer/core-concepts/inventory#stock-locations) fulfills an order at checkout. Spree gives you two extension points:
...
Before starting, make sure you understand [how order routing works in Spree](/v5/developer/core-concepts/shipments#order-routing).
...
Rules use Spree's preference system for configuration, the same way [Promotion Rules](/v5/developer/how-to/custom-promotion#using-preferences) do. Each preference creates getter/setter methods automatically:
...
- [How orders work](/v5/developer/core-concepts/orders) — Order lifecycle and the routing context
- [Inventory & Stock Locations](/v5/developer/core-concepts/inventory) — Where the locations live
- [Build Custom Promotion Rules & Actions](/v5/developer/how-to/custom-promotion) — A similar STI-based extension pattern
