...
- **Extension audit**: `spree_stripe`, `spree_adyen`, `spree_paypal_checkout` and popular community extensions — confirm ActiveJob-only (expected, but unverified). Enterprise modules too.
