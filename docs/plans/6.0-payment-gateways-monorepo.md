...
1. **Port Stripe** into `spree/providers/stripe` (smaller keep-set; sequenced first
...
- **Stripe Tax calculator**: port into `spree/providers/stripe`, or drop and revisit as
