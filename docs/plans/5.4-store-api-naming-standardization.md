...
**Status:** In Progress — the 5.4 portion is largely in (API + model aliases: `customer_note`, `billing/shipping_address`, `label`, `last4`, `brand`, etc.); 6.0 column/table renames pending
