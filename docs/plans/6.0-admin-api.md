...
- [ ] `GET /api/v3/admin/seller_transfers` — read-only earnings ledger (filter by seller/payout/status)
- [ ] `GET /api/v3/admin/seller_payouts` / `GET /:id`
- [ ] `POST /api/v3/admin/seller_payouts/:id/complete` — manual settlement (system provider)
