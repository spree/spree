...
**Status:** Phases 1–5 shipped (see "Implementation status"; Phase 5 as an initial scaffold — no FulfillmentProvider/CI wiring yet). Reference aggregator: **EasyPost** (decisions.md 2026-08-06 — Shippo pick reversed same day: BYOCA fit for larger merchants + the only actively maintained official Ruby SDK)
**Target:** Spree 6.0
