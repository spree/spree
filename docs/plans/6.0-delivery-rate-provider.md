...
**Status:** Phases 1–4 shipped (see "Implementation status"); Phase 5 (the EasyPost gem) pending. Reference aggregator: **EasyPost** (decisions.md 2026-08-06 — Shippo pick reversed same day: BYOCA fit for larger merchants + the only actively maintained official Ruby SDK)
**Target:** Spree 6.0
...
- Ship an EasyPost provider gem (decisions.md 2026-08-06, reversal entry) and a how-to guide, mirroring the custom-search-provider doc — built on the official `easypost` gem. The EasyPost snippets elsewhere in this document are now the pick, not just illustration.
