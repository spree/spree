...
13. Store after_create: `seed_default_channel` creates one `'online'` channel.
14. Channel after_create: `seed_default_order_routing_rules` creates the 3 default rules tied to the channel.
