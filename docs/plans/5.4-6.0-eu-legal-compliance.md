...
**Status:** In Progress — Omnibus half shipped (`Spree::PriceHistory` + recording callback + `?expand=prior_price`); GDPR subject requests, consent records and the withdrawal window in implementation 2026-09-02
