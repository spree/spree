...
- **The withdrawal deadline is read, never stored.** It derives from the order's market and its fulfillments' `delivered_at`; a persisted copy would go stale the moment a parcel is delivered.
