...
**Status:** Phase 1 partially shipped (`Spree::PriceHistory` model + migration + `prior_price` on Price); GDPR data export/anonymization endpoints + Consumer Rights withdrawal still pending; Phase 2 pending
