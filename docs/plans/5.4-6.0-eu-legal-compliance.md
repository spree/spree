...
**Status:** In Progress — Phase 1 partly in (`Spree::PriceHistory` model + migration + `prior_price` on Price); GDPR data export/anonymization endpoints + Consumer Rights withdrawal still pending; Phase 2 pending
**Target:** Spree 5.4 (Phase 1 — partial), Spree 6.0 (Phase 2)
