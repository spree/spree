...
<Warning>
  This guide is aimed at advanced users who want to add Spree to an existing Rails application. If you are new to Spree, please follow the [Quickstart guide](/developer/getting-started/quickstart).
</Warning>
