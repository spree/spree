---
title: Adding Spree to an Existing Rails App
description: Step-by-step guide for adding Spree commerce to an existing Ruby on Rails application, including gems, installer, database setup, and admin configuration.
---
