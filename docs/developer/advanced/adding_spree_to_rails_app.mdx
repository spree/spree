---
title: "Add Spree to an existing Ruby on Rails app"
description: "Step-by-step guide to installing the Spree commerce engine into an existing Ruby on Rails application — gems, migrations, configuration, and routes."
---
<Warning>
