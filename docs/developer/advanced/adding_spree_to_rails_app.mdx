...
description: "Add Spree commerce to an existing Ruby on Rails application by installing the gems, running generators, and configuring the admin panel and storefront."
---
