---
title: Add Spree Commerce to an existing Rails app
description: "Install and mount Spree Commerce inside an existing Ruby on Rails application, including database setup, gem dependencies, and initial configuration."
---
