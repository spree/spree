...
description: "Enable multiple stores on a single Spree instance by adding the spree_multi_store gem — licensing, install steps, and what gets shared per store."
