...
description: "Configure a multi-store Spree instance with a wildcard root domain, per-store subdomains, custom domains, currencies, taxes, and shared product catalogs."
sidebarTitle: Setup
---
