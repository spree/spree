...
sidebarTitle: Setup
description: "Set up Spree multi-store with a wildcard root domain so each store gets a subdomain like store1.example.com generated from its admin-configured code."
---
