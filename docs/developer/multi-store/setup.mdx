...
sidebarTitle: Setup
description: Configure a Spree multi-store setup with a wildcard root domain — generate per-store URLs, manage store codes, and connect custom domains in admin.
---
