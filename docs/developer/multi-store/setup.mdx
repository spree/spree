---
title: "Set up multi-store routing and root domain"
description: "Configure root domain, store URLs, and per-store routing for a Spree multi-store deployment — wildcard subdomains and custom domain handling."
sidebarTitle: Setup
---
## Root domain
