---
title: "Order adjustments — taxes, promotions, fees"
description: "How Spree applies adjustments to orders, line items, and shipments for taxes, promotions, store credits, and other price modifications during checkout."
---
## Overview
