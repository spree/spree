...
Adjustments appear in order responses when you include line items or shipments:
...
```bash cURL
curl 'https://api.mystore.com/api/v3/store/orders/or_abc123?includes=line_items,shipments' \
