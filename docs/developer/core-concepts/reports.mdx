---
title: Reports
description: Generate sales, product performance, and custom business metric reports in Spree with the flexible reporting system, background jobs, and CSV exports.
---
