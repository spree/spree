---
title: Reports
description: "Generate Spree reports for sales analytics, product performance, and custom business metrics — async CSV exports delivered through the admin dashboard."
---
