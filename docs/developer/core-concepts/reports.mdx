---
title: "Reports and async data exports in Spree"
description: "How Spree's reporting system generates async sales, product, and business reports — with built-in report types and how to add custom reports."
---
## Overview
