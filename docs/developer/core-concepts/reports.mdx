---
title: Reports
description: "Spree's reporting system for generating sales analytics and CSV exports asynchronously via background jobs, with report models and line item formatters."
---
