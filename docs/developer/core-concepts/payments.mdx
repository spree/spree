---
title: "Spree payments model, gateways, and processing"
description: "How Spree models payments and payment methods — multi-gateway support, payment sessions, 3D Secure, refunds, and decoupled order processing."
---
## Overview
