---
title: Payments
description: How Spree models payments, payment methods, and gateway integrations to authorize, capture, refund, and void transactions during and after checkout.
---
