---
title: Payments
description: "Understand Spree flexible payment model — payment methods, gateways, payment sessions, and order processing for cards, wallets, and offline payments."
---
