---
title: Payments
description: "Understand the Spree Payment model — payment methods, gateways, sources, and how processing logic is decoupled from orders for flexible checkout integrations."
---
