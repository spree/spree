---
title: "Shipments, shipping methods, and fulfillment"
description: "How Spree models shipments, shipping methods, and rates — including split shipments across stock locations and the order routing pipeline."
---
