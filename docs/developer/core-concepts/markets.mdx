...
A market also chooses **which tax provider works out its numbers** — Spree's own rate tables in a simple market, an external tax service in a complicated one. See [Taxes](/developer/core-concepts/taxes).
...
- [Addresses](/developer/core-concepts/addresses) — Countries, states, and address forms
