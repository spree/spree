---
title: "Markets for multi-region commerce in Spree"
description: "Use Markets to bundle geography, currency, and locale into distinct selling regions within a single Spree store for international commerce."
---
