---
title: "Product media, named variants, and focal points"
sidebarTitle: "Media"
description: "How Spree handles product images and videos — uploads, WebP conversion, named variants, focal points, and how media is delivered via the Store API."
---
