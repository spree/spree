---
title: Taxes
description: How Spree calculates taxes at checkout using tax categories, tax rates, zones, and address-based jurisdictions for accurate VAT and sales tax handling.
---
