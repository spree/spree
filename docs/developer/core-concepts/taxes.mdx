---
title: "Tax categories, rates, and zone-based calculation"
description: "How Spree calculates taxes at checkout — tax categories on products, tax rates per zone, included vs additional pricing, and external tax services."
---
## Overview
