...
- **[Adjustments](/developer/core-concepts/taxes-discounts-fees)** are created on orders/line items to apply taxes
...
Manage tax categories via the [Admin API](/api-reference/admin-api/introduction), using the [Admin SDK resource clients](/developer/sdk/admin/resources):
...
3. Tax [Adjustments](/developer/core-concepts/taxes-discounts-fees) are created on line items
...
- [Adjustments](/developer/core-concepts/taxes-discounts-fees) — Tax adjustments
