---
title: "Customer accounts, authentication, and profiles"
description: "How Spree models customers — registration, authentication, addresses, profile management, order history, and guest checkout via the Store API."
---
