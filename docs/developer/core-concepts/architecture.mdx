---
title: Architecture
description: "Overview of Spree's architecture covering core models, packages, APIs, and how the commerce engine adapts to headless, embedded, or multi-vendor setups."
---
