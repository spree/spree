---
title: "Spree commerce engine architecture overview"
description: "How Spree's core models, APIs, gems, and packages fit together — from the Rails engine and Store API to the admin dashboard and storefront layers."
---
## Overview
