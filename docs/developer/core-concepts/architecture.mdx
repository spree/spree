---
title: Architecture
description: How Spree's core models, gems, APIs, admin dashboard, and storefront packages fit together to form an extensible Rails-based commerce platform.
---
