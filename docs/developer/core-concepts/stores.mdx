---
title: "Stores — the central model in Spree Commerce"
description: "How the Store model anchors every Spree resource — products, orders, payment methods, taxonomies — and how single- vs multi-store setups differ."
---
## Overview
