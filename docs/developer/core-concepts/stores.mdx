...
![](/images/mulit\_store\_978x2.png)
</Frame>
...
All Spree controllers or any other controllers that include [Spree::Core::ControllerHelpers::Store](https://github.com/spree/spree/blob/master/core/lib/spree/core/controller\_helpers/store.rb) have access to the `current_store` method which returns the `Store` matching the current URL.
...
Read more about how resource translations work in [Internationalization](../customization/i18n#resource-translations).
