...
description: "Use Spree store credits and gift cards as stored value for refunds, loyalty rewards, and gifting — with code redemption, expiration, and checkout flow."
---
