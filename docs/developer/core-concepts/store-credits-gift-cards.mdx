---
title: "Store credits and gift cards in Spree"
description: "How Spree handles stored-value mechanisms — store credits for refunds and loyalty, and gift cards for redemption at checkout across stores."
---
