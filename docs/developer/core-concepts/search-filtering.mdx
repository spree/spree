---
title: "Product search and filtering via the Store API"
description: "Use the Store API to search, filter, and sort products and other resources — full-text search, faceted filtering, and Meilisearch integration."
---
