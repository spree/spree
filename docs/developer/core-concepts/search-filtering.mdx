...
curl 'https://api.mystore.com/api/v3/store/products?q[taxons_id_eq]=txn_xxx' \
  -H 'Authorization: Bearer spree_pk_xxx'
```
...
//   categories: [{ id: "txn_xxx", name: "Clothing", count: 45 }],
// }
...
curl 'https://api.mystore.com/api/v3/store/products/filters?category_id=txn_xxx' \
  -H 'Authorization: Bearer spree_pk_xxx'
```
