...
| `return.received` / `return.refunded` | A return arrived / was refunded (published for every refund, including partial ones) |
| `import.completed` | An import finished |

For the full list of events and their payloads, see [Webhook Events & Payloads](/api-reference/webhooks-events).
