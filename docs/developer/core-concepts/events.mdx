---
title: "Spree event system and event subscriptions"
description: "Subscribe to Spree's built-in event bus to react to order, cart, payment, and customer events — and emit custom events from your own code."
---
