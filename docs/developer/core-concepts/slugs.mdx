---
title: "SEO-friendly slugs for products and resources"
description: "How Spree generates SEO-friendly URL slugs for products, taxons, and other resources — with FriendlyId, slug history, and uniqueness handling."
---
## Overview
