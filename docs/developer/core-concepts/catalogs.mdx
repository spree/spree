...
| Assign to | Meaning |
|---|---|
| **[Channel](/developer/core-concepts/channels)** | Everyone buying through this channel — an app, a retail till |
| **[Customer group](/developer/core-concepts/customers)** | A segment — wholesale accounts, staff, a loyalty tier |
| **[Market](/developer/core-concepts/markets)** | Everyone in a region |
...
<Warning>
A price list attached to a catalog applies **because the catalog applies** — its own rules are not consulted, and it's excluded from ordinary rule matching.
