...
**Configuration:**
- `preferred_country_id` or `preferred_country_code` (ISO 2-letter code)
...
Customers [apply coupon codes during checkout](/developer/sdk/store/cart-checkout) via the Store API:
...
- [Admin SDK Resources](/developer/sdk/admin/resources) - The `client.promotions.*` resource-client pattern used in the examples above
- [Spree CLI Admin API](/developer/cli/admin-api) - The `spree api` command reference for the CLI examples above
