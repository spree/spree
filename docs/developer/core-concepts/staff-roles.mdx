---
title: Staff & Roles
description: "How Spree manages admin staff users, roles, invitations, and store-scoped permissions for granting access to the admin panel and vendor dashboards."
---
