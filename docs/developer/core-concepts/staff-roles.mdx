---
title: "Admin users, roles, invitations, and permissions"
description: "How Spree manages staff accounts — admin users, role assignments, invitations, store-scoped permissions, and the underlying CanCanCan abilities."
---
## Overview
