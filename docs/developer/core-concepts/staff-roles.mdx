---
title: Staff & Roles
description: Manage Spree admin staff with role-based permissions, invitations, and CanCan abilities to control who can access products, orders, and store settings.
---
