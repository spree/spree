---
title: Calculators
description: "Learn how Spree calculators work — the polymorphic model behind shipping rates, tax calculations, promotion discounts, and other configurable pricing logic."
---
