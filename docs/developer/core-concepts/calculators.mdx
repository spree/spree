---
title: Calculators
description: How Spree calculators compute shipping rates, tax amounts, and promotion discounts using pluggable preference-driven classes attached to rates and rules.
---
