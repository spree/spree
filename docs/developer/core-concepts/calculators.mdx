---
title: Spree calculators for tax, shipping & promos
description: "How Spree calculators compute amounts for tax rates, shipping methods, and promotion actions — model structure, preferences, and creating your own."
---
