---
title: "Calculators for shipping, tax, and promotion pricing"
description: "How Spree calculators compute shipping rates, tax amounts, and promotion discounts — with built-in calculator types and how to add custom ones."
---
## Overview
