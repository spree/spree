---
title: Calculators
description: "How Spree calculators compute shipping rates, tax amounts, and promotion discounts, with preferences, calculable types, and writing your own calculator."
---
