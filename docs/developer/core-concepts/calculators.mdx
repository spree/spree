...
- Used by **[Shipping Methods](/developer/core-concepts/fulfillments)** to calculate shipping costs
...
- [Adjustments](/developer/core-concepts/taxes-discounts-fees) — the records calculators compute amounts for.
