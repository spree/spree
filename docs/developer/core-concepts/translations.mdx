---
title: "Resource translations and storefront localization"
description: "How Spree translates product, taxon, and store content into multiple locales — model translations, fallback rules, and storefront language switching."
---
## Overview
