---
title: "Bulk imports and exports in Spree Commerce"
description: "How Spree's bulk import and export system processes CSV files asynchronously — with configurable field mapping, validation, and error reporting."
---
## Overview
