---
title: "Spree webhooks for outbound event notifications"
description: "Send real-time HTTP POST notifications to external services when orders, carts, customers, and other Spree events occur — with retries and signing."
---
