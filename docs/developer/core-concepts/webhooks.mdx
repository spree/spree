---
title: Webhooks
description: Send real-time HTTP notifications to external services when Spree events occur — order placed, product updated, customer created — with signed payloads.
---
