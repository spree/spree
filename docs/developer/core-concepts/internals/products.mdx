...
Spree automatically handles the creation and storage of several size versions of each image (via Active Storage). See [Images Customization](../customization/images) section.
