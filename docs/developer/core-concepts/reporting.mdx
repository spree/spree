...
exchanges, open claims, low stock variants and out of stock variants. The
three post-sale ones badge their sidebar entries. The low stock counter reads the
