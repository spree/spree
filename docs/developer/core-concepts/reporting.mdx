...
**counters** beside metrics and dimensions, and `GET /dashboard/operations`
evaluates them:
...
Core ships five: orders to fulfill, payments to collect, open returns, low
stock variants and out of stock variants. The low stock counter reads the
