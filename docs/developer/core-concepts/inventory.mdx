---
title: Inventory
description: How Spree tracks inventory with stock locations, stock items, stock movements, and backorderable flags to manage availability across warehouses.
---
