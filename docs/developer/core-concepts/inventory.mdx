...
TTL deliberately lives on Store, not StockLocation — it's a checkout-experience policy, not a warehouse property. This matches how Shopify, Saleor, Medusa, and Vendure scope the equivalent setting.
