---
title: Spree inventory, stock items, and stock locations
description: "How Spree tracks inventory across stock locations, manages stock items and movements, and follows inventory units through fulfillment and returns."
---
...
- [Admin SDK resources](/developer/sdk/admin/resources) - `stockLocations`, `stockItems`, and `stockTransfers` methods used in the examples above
