---
title: Inventory
description: "How Spree tracks inventory through stock locations, stock items, stock movements, inventory units, and time-limited stock reservations during checkout."
---
