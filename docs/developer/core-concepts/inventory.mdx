---
title: Inventory
description: "Track inventory with stock locations, stock items, stock movements, backorders, and time-limited stock reservations across multi-warehouse setups."
---
