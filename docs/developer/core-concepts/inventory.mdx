---
title: "Inventory, stock locations, items, and movements"
description: "How Spree tracks inventory through stock locations, stock items, and stock movements — including multi-warehouse setups and backorderable variants."
---
