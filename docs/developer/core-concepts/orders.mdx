...
# Get existing cart
curl 'https://api.mystore.com/api/v3/store/carts/or_xxx' \
  -H 'Authorization: Bearer spree_pk_xxx' \
  -H 'X-Spree-Order-Token: abc123'

# Add an item
curl -X POST 'https://api.mystore.com/api/v3/store/carts/or_xxx/items' \
  -H 'Authorization: Bearer spree_pk_xxx' \
  -H 'X-Spree-Order-Token: abc123' \
...
# Update quantity
curl -X PATCH 'https://api.mystore.com/api/v3/store/carts/or_xxx/items/li_xxx' \
  -H 'Authorization: Bearer spree_pk_xxx' \
  -H 'X-Spree-Order-Token: abc123' \
  -H 'Content-Type: application/json' \
  -d '{ "quantity": 3 }'
...
# Remove an item
curl -X DELETE 'https://api.mystore.com/api/v3/store/carts/or_xxx/items/li_xxx' \
  -H 'Authorization: Bearer spree_pk_xxx' \
  -H 'X-Spree-Order-Token: abc123'
```
...
```bash cURL
# Set addresses
curl -X PATCH 'https://api.mystore.com/api/v3/store/carts/or_xxx' \
  -H 'Authorization: Bearer spree_pk_xxx' \
  -H 'X-Spree-Order-Token: abc123' \
  -H 'Content-Type: application/json' \
  -d '{
...
curl -X PATCH 'https://api.mystore.com/api/v3/store/carts/or_xxx/shipments/shp_xxx' \
  -H 'Authorization: Bearer spree_pk_xxx' \
  -H 'X-Spree-Order-Token: abc123' \
  -H 'Content-Type: application/json' \
...
# Complete the order
curl -X POST 'https://api.mystore.com/api/v3/store/carts/or_xxx/complete' \
  -H 'Authorization: Bearer spree_pk_xxx' \
  -H 'X-Spree-Order-Token: abc123'
```
...
// Remove a coupon
await client.carts.couponCodes.remove(cartId, 'promo_xxx')
```

```bash cURL
# Apply a coupon
curl -X POST 'https://api.mystore.com/api/v3/store/carts/or_xxx/coupon_codes' \
  -H 'Authorization: Bearer spree_pk_xxx' \
  -H 'X-Spree-Order-Token: abc123' \
  -H 'Content-Type: application/json' \
  -d '{ "code": "SAVE20" }'
...
# Remove a coupon
curl -X DELETE 'https://api.mystore.com/api/v3/store/carts/or_xxx/coupon_codes/promo_xxx' \
  -H 'Authorization: Bearer spree_pk_xxx' \
  -H 'X-Spree-Order-Token: abc123'
```
