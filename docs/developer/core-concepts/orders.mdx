---
title: "Orders, checkout flow, line items, and payments"
description: "How a Spree order moves through its lifecycle — cart, address, delivery, payment, completion — and how line items, shipments, and payments connect."
---
## Overview
