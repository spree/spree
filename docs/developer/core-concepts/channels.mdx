...
| `preferred_order_routing_strategy` | Optional per-channel override of the store's [Order Routing](/developer/how-to/custom-order-routing) strategy | `Spree::OrderRouting::Strategy::Rules` |
...
This attribution drives reporting (best-selling by channel, revenue per channel) and per-channel order routing — see [Order Routing](/developer/how-to/custom-order-routing).
...
- [Order Routing](/developer/how-to/custom-order-routing) — Channels can override the store's routing strategy
