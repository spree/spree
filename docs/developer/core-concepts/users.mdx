---
title: "User models — customers and admin users"
description: "How Spree separates customer and admin user models — authentication, account management, store-scoping, and permissions for each user type."
---
## Overview
