---
title: "Products, variants, options, prices, and categories"
description: "How Spree models products and their variants — option types, SKUs, prices, images, taxons, and the relationships that power the storefront catalog."
---
## Overview
