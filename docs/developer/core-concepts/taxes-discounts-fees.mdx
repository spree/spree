...
- **Tax lines** → a line item, a [fulfillment](/developer/core-concepts/fulfillments), or a fee, so item tax and delivery tax stay separately visible
...
- [Fulfillments](/developer/core-concepts/fulfillments) — delivery charges
- [Orders](/developer/core-concepts/orders) — order totals and statuses
