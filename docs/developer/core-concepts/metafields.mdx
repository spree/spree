---
title: Spree metafields for typed custom data
description: "Add type-safe custom structured data to Spree products, orders, and resources with metafield definitions, validation, and visibility controls."
---
