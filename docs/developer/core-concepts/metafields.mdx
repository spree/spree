---
title: "Metafields for typed custom data on Spree resources"
description: "Add custom structured data to products, orders, and other resources with type-safe metafields — definitions, validation, and storefront access."
---
## Overview
