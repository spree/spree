---
title: Metafields
description: "Add custom structured data to Spree products, orders, and resources using type-safe metafields with schema validation and visibility controls."
---
