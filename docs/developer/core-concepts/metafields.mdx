---
title: Metafields
description: "Add custom, type-safe structured data to Spree products, orders, and variants using metafields with schema definitions, validation, and visibility controls."
---
