---
title: "Use a CDN to accelerate your Spree storefront"
description: "Improve Spree storefront performance by serving images and static assets through a CDN such as Cloudflare, with caching headers and origin configuration."
---
