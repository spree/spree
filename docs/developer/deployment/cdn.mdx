---
title: CDN
description: Speed up your Spree storefront with a CDN by configuring Cloudflare cache rules for Active Storage images, static assets, JavaScript, and CSS.
---
