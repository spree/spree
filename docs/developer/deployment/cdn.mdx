---
title: Speed up Spree with a Cloudflare CDN
description: "Improve Spree storefront performance by serving images and static assets through a Cloudflare CDN with recommended cache rules and configuration."
---
