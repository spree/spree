---
title: "Configure Redis caching for Spree applications"
description: "Set up Redis as the cache store for a Spree application to speed up page renders, fragment caching, and expensive database queries in production."
---
