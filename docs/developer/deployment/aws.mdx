---
title: Deploy Spree Commerce on AWS ECS Fargate
description: "Deploy your Spree Commerce application on AWS using ECS Fargate, RDS PostgreSQL, ElastiCache Redis, and S3 for assets with a production-ready setup."
---
