---
title: "Deploy Spree on Amazon Web Services (AWS)"
description: "Deploy Spree to AWS using ECS Fargate, RDS for PostgreSQL, ElastiCache for Redis, and S3 for storage — a production-ready cloud architecture."
---
