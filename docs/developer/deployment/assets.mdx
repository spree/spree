---
title: "Asset Storage: S3, Cloudflare R2, and Local Files"
description: Configure Spree asset storage with AWS S3, Cloudflare R2, or local files. Auto-detected via environment variables, with CORS setup guidance.
---
