---
title: Assets
description: "Configure Spree file storage for production with AWS S3, Cloudflare R2, or other providers using Active Storage environment variables — no code changes."
---
