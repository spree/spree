---
title: Spree asset storage with S3 and R2
description: "Configure Spree Active Storage for production using AWS S3, Cloudflare R2, or other S3-compatible object stores via environment variables."
---
