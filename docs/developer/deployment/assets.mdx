---
title: Assets
description: "Configure Spree file storage for production — auto-detect AWS S3, Cloudflare R2, or local disk using environment variables, no code changes required."
---
