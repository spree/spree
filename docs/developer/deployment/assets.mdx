---
title: "Configure asset storage for Spree in production"
description: "Configure file storage for Spree uploads in production — Amazon S3, Google Cloud Storage, Azure Blob, or local filesystem with auto-detection."
---
