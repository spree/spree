---
title: Docker
description: Run Spree with the official ghcr.io/spree/spree Docker image or build your own, including docker-compose setup with Postgres, Redis, web, and worker.
---
