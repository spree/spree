---
title: Docker
description: Run Spree with the official multi-arch Docker image from GHCR, or build your own. Includes docker-compose setup for web, worker, Postgres, and Redis.
---
