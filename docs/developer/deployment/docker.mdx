---
title: Docker
description: "Run Spree with the official multi-arch Docker image from GitHub Container Registry or build your own image with available tags for releases and versions."
---
