---
title: "Run Spree with the official Docker image"
description: "Run the official multi-arch Spree Docker image from GHCR or build your own — environment variables, volumes, and production-ready Compose examples."
---
