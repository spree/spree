---
title: "Spree environment variables reference"
description: "Reference for every Spree environment variable — required production settings, database, Redis, email, storage, and optional feature flags."
---
