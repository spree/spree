---
title: "Deploy Spree to Render with one click"
description: "Deploy Spree to Render with the one-click deploy button or render.yaml blueprint — managed PostgreSQL, Redis, worker, and web service in minutes."
---
## One-Click Deploy
