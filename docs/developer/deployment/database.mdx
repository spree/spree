...
description: Set up Spree with PostgreSQL, MySQL, or SQLite using DATABASE_URL or database.yml, including recommended adapters, pool sizing, and production tips.
---
