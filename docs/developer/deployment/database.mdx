---
title: "Configure PostgreSQL, MySQL, or SQLite for Spree"
description: "Configure Spree to run on PostgreSQL, MySQL, or SQLite — supported versions, development vs production recommendations, and connection settings."
---
## Supported Databases
