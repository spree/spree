---
title: Spree database setup with Postgres or MySQL
description: "Configure your Spree Commerce database for development and production using PostgreSQL, MySQL, or SQLite, with recommendations for scaling and performance."
---
