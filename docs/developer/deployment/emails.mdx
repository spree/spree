---
title: "Send transactional emails from a Spree app"
sidebarTitle: Emails
description: "Configure transactional email delivery from a Spree application — Postmark, SendGrid, or any SMTP provider — for order confirmations and shipments."
---
