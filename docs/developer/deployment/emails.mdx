---
title: Sending transactional emails from Spree
sidebarTitle: Emails
description: "Send Spree transactional emails — order confirmations, shipping updates, password resets, and admin alerts — using SMTP, SendGrid, Postmark, or Resend."
---
