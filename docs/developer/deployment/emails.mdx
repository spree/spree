...
sidebarTitle: Emails
description: Send transactional and system emails from Spree using storefront webhooks, Resend, and react-email templates for order, shipping, and password events.
---
