...
sidebarTitle: Emails
description: Send transactional emails from Spree — order confirmations, shipping updates, and admin notifications — via Resend, SendGrid, or any SMTP provider.
---
