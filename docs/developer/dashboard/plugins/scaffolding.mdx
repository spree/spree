...
// Routes are NOT registered here — they ship as file routes in src/routes/
// (declared via the package.json marker) and compile into the host's typed
// route tree. See the routes guide.
