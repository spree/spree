...
description: How the React Dashboard is structured, how to customize existing screens and how to build new features
---

<Info>
The React Dashboard is a Developer Preview — APIs may still change between releases. In Spree 6 it becomes the default admin interface.
</Info>

The React Dashboard is a single-page application (SPA) that talks to the Spree Admin API and is built on three packages:
