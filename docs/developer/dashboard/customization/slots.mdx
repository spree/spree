...
```tsx
import { DropdownMenuItem, defineDashboardPlugin } from '@spree/dashboard'
...
```tsx
import { registerSlot } from '@spree/dashboard'
...
```ts
import { removeSlot, updateSlot } from '@spree/dashboard'
