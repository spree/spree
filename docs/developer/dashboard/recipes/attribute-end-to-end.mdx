...
| Filtering / sorting the products list | ❌ | ✅ via Ransack |
| A database index, Rails validations, queries in Ruby | ❌ | ✅ |
...
```ruby
# app/serializers/my_plugin/product_serializer.rb
module MyPlugin
  class ProductSerializer < Spree::Api::V3::Admin::ProductSerializer
    typelize lead_time_days: 'number | null'
    attributes :lead_time_days
  end
end

# config/initializers/spree.rb
Spree.api.admin_product_serializer = 'MyPlugin::ProductSerializer'
```
...
```ruby
# app/controllers/my_plugin/products_controller_decorator.rb
module MyPlugin
...
Spree::Api::V3::Admin::ProductsController.prepend(MyPlugin::ProductsControllerDecorator)
```
