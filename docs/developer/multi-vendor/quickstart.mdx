...
description: "Build a multi-vendor marketplace with Spree — vendor dashboards, Stripe Connect payouts, Shopify and WooCommerce sales channels, and split checkout."
---
