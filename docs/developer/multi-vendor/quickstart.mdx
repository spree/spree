---
title: "Build a multi-vendor marketplace with Spree"
description: "Build a true multi-vendor marketplace on Spree Enterprise Edition with the spree_multi_vendor gem — vendor onboarding, payouts, and commissions."
