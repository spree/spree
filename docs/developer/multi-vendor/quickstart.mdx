...
description: Build a multi-vendor marketplace on Spree with the Enterprise spree_multi_vendor gem — vendor dashboards, Stripe Connect, and multi-party checkout.
---
