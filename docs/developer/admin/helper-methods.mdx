---
title: Spree admin dashboard helper methods
sidebarTitle: Helper Methods
description: "Reference for Spree admin view helpers covering navigation items, links with icons, current store and vendor accessors, and utility helpers."
---
