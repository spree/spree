...
description: "Reference for Spree Admin Dashboard helper methods covering navigation, links, current store and vendor context, and other utilities for admin views."
---
