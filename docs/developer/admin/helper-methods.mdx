...
description: "Reference for Spree admin dashboard helper methods covering navigation items, link helpers, icon helpers, and utility view methods for custom admin pages."
