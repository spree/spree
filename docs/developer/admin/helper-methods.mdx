---
title: Admin Dashboard Helper Methods Reference
sidebarTitle: Helper Methods
description: Reference for Spree Admin Dashboard helper methods including nav_item, navigation links, URL helpers, and utility functions used across admin views.
---
