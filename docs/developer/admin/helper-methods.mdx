...
description: "Reference for Spree admin dashboard view helpers including nav_item, links, icons, and utility methods used to build custom admin pages and navigation."
---
