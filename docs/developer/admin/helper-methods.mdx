---
title: "Spree Admin Dashboard view helper methods"
description: "Reference for Spree Admin view helpers — current store and vendor accessors, navigation links, breadcrumbs, badges, and utility methods for custom admin views."
