...
description: "Extend the Spree admin sidebar navigation with custom menu items, sub-menus, icons, and permissions using the declarative Spree.admin.navigation API."
