---
title: "Extend the Spree Admin sidebar navigation"
description: "Add custom menu items, sections, and badges to the Spree Admin sidebar without modifying core code — safe for upgrades and packaged in extensions."
