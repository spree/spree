---
title: Extending Admin Navigation & Sidebar Menu
sidebarTitle: Navigation
description: Add, modify, and remove items in the Spree Admin sidebar using the declarative Spree.admin.navigation API to extend the dashboard menu from initializers.
---
