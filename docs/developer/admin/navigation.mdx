...
description: "Add, modify, or remove Spree admin sidebar menu items using the declarative Spree.admin.navigation API in initializers without patching core files."
---
