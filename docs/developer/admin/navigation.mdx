---
title: Extending the Spree admin sidebar nav
sidebarTitle: Navigation
description: "Add, modify, and remove items in the Spree admin sidebar using the declarative Spree.admin.navigation API from your Rails initializers."
---
