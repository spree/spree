...
description: "Extend the Spree Admin Dashboard sidebar with the Spree.admin.navigation API — add, modify, or remove menu items from your initializers without patching core."
---
