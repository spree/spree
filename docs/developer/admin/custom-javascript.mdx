---
title: "Custom JavaScript for the Spree Admin Dashboard"
sidebarTitle: Custom JavaScript
description: "Add custom JavaScript and Stimulus controllers to the Spree Admin Dashboard to enrich forms, tables, and bespoke back-office workflows."
---
