---
title: Custom JavaScript in the Spree admin
sidebarTitle: Custom JavaScript
description: "Extend the Spree admin dashboard with custom JavaScript using Stimulus controllers, importmap entries, and Turbo-compatible behaviors."
---
