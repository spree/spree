---
title: "Customizing the Spree Admin Dashboard"
sidebarTitle: Overview
description: "Customize and extend the Spree Admin Dashboard — branding, navigation, custom views, tables, forms, and embedded UI for back-office workflows."
---
