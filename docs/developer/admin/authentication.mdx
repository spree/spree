---
title: Spree admin panel authentication setup
sidebarTitle: Authentication
description: "Configure Devise authentication for the Spree admin panel, use a separate AdminUser model, and customize sign-in and access for staff users."
---
