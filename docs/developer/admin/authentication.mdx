---
title: "Customize Spree admin panel authentication"
sidebarTitle: Authentication
description: "Customize how admin users sign in to the Spree admin panel — replace the default Devise model with SSO, OAuth, or your own authentication backend."
---
