...
description: "Customize Spree admin panel authentication using a separate AdminUser model with Devise, including initializer setup and route configuration."
---
