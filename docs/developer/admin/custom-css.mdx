---
title: "Custom CSS for the Spree Admin Dashboard"
description: "Add custom Tailwind CSS v4 styles to the Spree Admin Dashboard while keeping consistency with the built-in design system and color tokens."
