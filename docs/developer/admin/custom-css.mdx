...
description: "Customize the Spree Admin Dashboard styles with Tailwind CSS v4 — override theme variables and add custom rules in app/assets/tailwind/spree_admin.css."
---
