...
title: Admin Tables
sidebarTitle: Tables
description: "Define Spree admin resource tables with the Spree.admin.tables DSL — configure columns, sorting, filtering, and bulk actions for listings from initializers."
---
