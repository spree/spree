---
title: "Build custom admin tables with the Tables DSL"
description: "Define resource listings with the Spree Admin Tables DSL — configurable columns, sorting, filtering, bulk actions, and search out of the box."
sidebarTitle: Tables
---
