...
description: "Extend Spree Admin Dashboard pages through named injection points so you can add UI elements without forking core templates or losing upgrade safety."
---
