---
title: "Inject custom UI into Spree Admin pages"
description: "Inject custom UI elements into existing Spree Admin pages with view hooks — extend layouts, forms, and sidebars without modifying core code."
