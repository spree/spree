---
title: "Admin UI Components: Dropdowns, Dialogs & Icons"
sidebarTitle: Components
description: Reusable Spree Admin view helpers and Stimulus-powered UI components for dropdowns, dialogs, icons, and other interactive admin dashboard elements.
---
