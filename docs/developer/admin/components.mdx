---
title: "Reusable UI components for Spree Admin views"
description: "Use Spree Admin's built-in view helpers and Stimulus-powered components — buttons, modals, tables, forms — to build consistent custom admin pages."
