---
title: Spree admin UI components reference
sidebarTitle: Components
description: "Reusable view helpers and Stimulus-powered UI components — dropdowns, dialogs, icons, and tabs — for building custom Spree admin views."
---
