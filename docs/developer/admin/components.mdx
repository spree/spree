...
description: "Reusable Spree admin UI components like dropdowns, dialogs, and icons rendered through view helpers and Stimulus controllers for custom admin views."
---
