...
description: "Reusable Spree admin UI components — dropdowns, dialogs, icons, and Stimulus-backed view helpers you can use in custom admin pages and extensions."
---
