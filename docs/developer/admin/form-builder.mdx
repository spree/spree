...
description: "Use the Spree::Admin::FormBuilder to build admin forms with consistent styling, error handling, and helpers like spree_text_field and spree_text_area."
---
