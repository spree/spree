---
title: "Spree Admin form builder helpers"
description: "Use Spree::Admin::FormBuilder to render consistent admin form fields — inputs, selects, file uploads, switches — with built-in styling and behavior."
