---
title: Admin Form Builder API for Custom Admin Forms
sidebarTitle: Form Builder
description: Use Spree::Admin::FormBuilder helpers like spree_text_field and spree_text_area to build admin forms with consistent styling, labels, and error handling.
---
