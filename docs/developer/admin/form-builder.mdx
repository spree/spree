...
description: "Build consistent Spree admin forms with the Spree::Admin::FormBuilder helpers for text fields, labels, errors, and styled inputs used across the admin UI."
---
