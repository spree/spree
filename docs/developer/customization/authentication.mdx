...
<AccordionGroup>
  ...
  <Accordion title="4. Customize Spree Authentication Helpers (Optional)">
      ...
      module AuthenticationHelpers
        def self.included(receiver)
          receiver.helper_method(
            ...
            :spree_admin_login_url,
            :spree_admin_logout_path,
            :spree_admin_logout_url
          )
        end
        ...
        def spree_admin_login_url(opts = {})
          main_app.admin_login_url(opts)
        end
        ...
        def spree_admin_logout_url(opts = {})
          main_app.admin_logout_url(opts)
        end
      end
    end
    ```
    ...
    * `spree_admin_login_path/url` The location of the login/sign in form for the admin panel.
    * `spree_admin_logout_path/url` The location of the logout feature for the admin panel.
