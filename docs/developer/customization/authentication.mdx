...
description: Integrate Spree 5 with a custom Devise-based authentication setup — wire up your existing User model and reuse Spree sign-in, sign-up, and password flows.
version: v5
---
