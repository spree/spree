---
title: "Custom storefront authentication with Devise"
description: "Replace or extend Spree's default Devise authentication for the storefront — custom user models, OAuth providers, SSO, and passwordless login flows."
version: v5
---
