---
title: "Custom metadata on Spree resources"
description: "Attach unstructured key-value metadata to Spree orders, products, customers, and other resources — similar to Stripe metadata for integration IDs."
---
## Overview
