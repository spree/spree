---
title: "Resource Metadata: Key-Value Storage for Spree"
description: Store unstructured key-value metadata on Spree resources for integration IDs, tracking data, and machine-readable info, similar to Stripe's metadata API.
---
