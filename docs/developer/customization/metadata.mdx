---
title: Metadata
description: "Store arbitrary key-value metadata on Spree resources for integration IDs and tracking data via the Store and Admin APIs, with public and private fields."
---
