---
title: Spree metadata key-value storage
description: "Store unstructured private and public key-value metadata on Spree orders, products, and other resources for integration IDs and tracking data."
---
