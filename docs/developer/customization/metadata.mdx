---
title: Metadata
description: "Attach unstructured key-value metadata to Spree resources via the Store and Admin APIs — ideal for integration IDs, tracking data, and machine-readable tags."
---
