...
It is highly recommended to use [Dependencies](dependencies) and [Extensions](../extensions/extensions) first rather than to apply patches to Spree Core. Still if you don't find those to be efficient you can pretty much overwrite any part of Spree following this guide.
...
Adding a custom method to the [Product](https://github.com/spree/spree/blob/master/core/app/models/spree/product.rb) model: `app/models/spree/product_decorator.rb`
...
Adding a custom action to the [ProductsController](https://github.com/spree/spree/blob/master/frontend/app/controllers/spree/products_controller.rb): `app/controllers/spree/products_controller_decorator.rb`
