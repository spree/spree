---
title: "Customize Spree transactional emails"
description: "Customize Spree transactional email templates and senders via the spree_emails gem and Postmark templates — order confirmations, shipments, and more."
---
<Note>
