---
title: Permissions
description: "Configure Spree authorization with CanCanCan using permission sets, roles, and custom abilities to control admin, vendor, and customer access to resources."
---
