---
title: Permissions
description: "Configure Spree authorization with CanCanCan — define roles, permission sets, and granular abilities for admin users, customer service agents, and other actors."
---
