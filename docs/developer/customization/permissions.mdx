---
title: Permissions
description: "Configure Spree role-based access with CanCanCan permission sets to control what admins, vendors, and customer service users can do in the dashboard."
---
