---
title: "CanCanCan permissions and authorization in Spree"
description: "Use Spree's permission sets and CanCanCan abilities to define granular admin and API authorization — custom roles, scoping, and resource-level rules."
---
