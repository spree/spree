---
title: Permissions, Roles & CanCanCan Authorization
description: Define granular access control in Spree using CanCanCan permission sets, roles, and role configuration to govern admin and customer user abilities.
---
