---
title: Spree permissions, roles, and abilities
description: "Customize Spree authorization with CanCanCan abilities, roles, and reusable permission sets to control access for admin users and customer-facing actions."
---
