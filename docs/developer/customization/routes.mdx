---
title: Routes
description: "Customize where Spree mounts in your Rails app by changing the engine mount point, adding scoped routes, or overriding default storefront URL paths."
---
