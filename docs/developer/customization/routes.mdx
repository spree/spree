---
title: Customizing Spree Routes & Mount Point
description: Customize the Spree engine mount point in config/routes.rb to serve the storefront, API, and admin dashboard under a custom path like /shop or a subdomain.
---
