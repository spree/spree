---
title: Customizing Spree routes and mount path
description: "Customize the Spree engine mount point, add new routes, override default storefront and admin paths, and configure route constraints in your Rails app."
---
