---
title: "Customize Spree mount points and routes"
description: "Customize the Spree engine mount point and add custom routes — change the storefront root, namespace under /shop, and extend admin and API routes."
---
