---
title: Routes
description: "Customize where Spree mounts in your Rails app, change the admin and API paths, and add custom routes alongside the Spree engine in config/routes.rb."
---
