...
description: "Use Spree Dependencies to swap core services, CanCanCan abilities, and API serializers with your own classes for global or scoped customization."
---
