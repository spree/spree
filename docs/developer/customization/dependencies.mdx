...
description: "Replace Spree core services, CanCanCan abilities, and API serializers using the Dependencies system to customize behavior globally or per store."
---
