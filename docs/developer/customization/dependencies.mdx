---
title: Customizing Spree Dependencies & Services
section: customization
description: Replace Spree core services, CanCanCan abilities, and API serializers with your own classes using the Spree dependencies API for global or scoped overrides.
---
