...
[Services and Workflows](/developer/customization/workflows), CanCanCan
Abilities (used for [Permissions](/developer/customization/permissions)), and API Serializers (used for
...
Seams backed by a [workflow](/developer/customization/workflows) were renamed
