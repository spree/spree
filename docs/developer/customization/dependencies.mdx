---
title: Dependencies
description: "Replace Spree services, CanCanCan abilities, and API serializers with your own classes using the Spree dependencies system at the app or store level."
