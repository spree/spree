---
title: Replace Spree services and serializers
section: customization
description: "Use the Spree dependencies system to swap core services, CanCanCan abilities, and API serializers with your own classes without forking the engine."
---
