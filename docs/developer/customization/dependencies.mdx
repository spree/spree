---
title: "Replace Spree services with the dependencies API"
description: "Use Spree Dependencies to swap services, CanCanCan abilities, and other core parts of Spree with your custom implementations — without decorators."
