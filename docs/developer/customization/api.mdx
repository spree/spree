---
title: "Customize and extend the Spree Store API"
description: "Add new Store API endpoints and customize existing responses — serializers, controllers, routes, and how to extend resources without forking Spree."
---
