---
title: "Theme the Spree 4 Rails storefront with SASS"
description: "Customize the Spree 4 Rails storefront by overriding SASS variables for header, footer, meganav, backgrounds, fonts, and other Bootstrap 4 theme tokens."
---
