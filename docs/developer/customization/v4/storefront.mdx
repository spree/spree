---
title: "Customize the Spree 4 Rails storefront"
description: "Customize the legacy Spree 4 Rails storefront from spree_frontend — Bootstrap 4 SASS variables, layouts, partials, and view overrides for branding."
---
