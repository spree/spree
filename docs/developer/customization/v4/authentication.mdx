...
description: Plug a custom authentication setup into Spree 4 — connect your existing application User model so Spree can use it for storefront and admin sign-in.
version: v4
---
