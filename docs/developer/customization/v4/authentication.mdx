---
title: "Custom authentication in Spree 4"
description: "Use a custom authentication setup with Spree 4 when your existing Rails app already handles sign-in or sign-up flows — and bridge to Spree user models."
version: v4
---
