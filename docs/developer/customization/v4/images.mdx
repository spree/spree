---
title: "Product image dimensions and storage in Spree 4"
description: "Configure product image dimensions and storage options in Spree 4 with ActiveStorage — local filesystem, Amazon S3, Google Cloud, and Azure providers."
version: v4
---
## Overview
