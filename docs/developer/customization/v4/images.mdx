...
title: Images
version: v4
description: "Change Spree 4 product image dimensions and configure ActiveStorage backends like S3 or Google Cloud Storage through a Spree::Image decorator."
---
