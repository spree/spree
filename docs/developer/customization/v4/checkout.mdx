---
title: Checkout Flow
description: Customize the Spree 4 checkout flow using the Checkout DSL — modify steps, add gateways, and keep customer data secure with SSL and tokenized payments.
version: v4
---
