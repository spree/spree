---
title: "Customize the Spree 4 checkout flow"
description: "Customize the Spree 4 checkout state machine — add, remove, or reorder checkout steps, override controllers, and tailor address and payment behavior."
version: v4
---
## Overview
