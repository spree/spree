---
title: "Customize the Spree 4 admin panel UI"
description: "Customize the Spree 4 admin panel UI without Deface — extend the main menu, override views, and inject custom forms and sidebars in extensions."
---
