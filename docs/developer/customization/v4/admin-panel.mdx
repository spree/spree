---
title: "Customize the Spree 4 admin panel"
description: "Extend the Spree 4 admin panel without Deface — add main menu sections, customize tabs on Orders, Products, and Users, and register UI overrides from a gem."
---
