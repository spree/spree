...
version: v4
description: "Use Deface to customize Spree 4 ERB templates with CSS selectors — override view fragments from app/overrides without editing core view files directly."
---
