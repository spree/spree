---
title: "Deface view overrides in Spree 4"
description: "Use the Deface gem to override Spree 4 view templates from extensions — legacy approach, no longer recommended; prefer modern customization paths."
version: v4
---
<Warning>
