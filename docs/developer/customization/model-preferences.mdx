...
description: "Add typed preferences to Spree models — store options like preferred_language on User with a serialized preferences column and a generated Rails migration."
---
