---
title: "Model preferences for per-record configuration"
description: "Use Spree model preferences to attach typed configuration options to individual records — store settings, user preferences, and integration credentials."
---
