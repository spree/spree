---
title: "Decorators for modifying Spree core classes"
description: "How to use decorators to add or modify behavior on Spree classes — and modern alternatives like dependencies and event subscriptions for safer upgrades."
---
<Warning>
