...
<Warning>
  **Decorators should be a last resort.** They tightly couple your code to Spree internals and can break during upgrades. Before using decorators, consider these modern alternatives that are safer and easier to maintain:
  ...
  - **[Admin Navigation](/developer/dashboard/customization/navigation)** - For adding menu items without controller decorators
  - **[Admin Partials](/developer/dashboard/customization/quickstart)** - For extending admin UI without view decorators
  - **[Admin Tables](/developer/dashboard/customization/tables)** - For customizing admin list views
...
| Add admin menu item | Controller decorator | [Admin Navigation API](/developer/dashboard/customization/navigation) |
| Add section to admin form | View decorator/override | [Admin Partials injection](/developer/dashboard/customization/quickstart) |
...
- [Admin Navigation](/developer/dashboard/customization/navigation) - Extend admin menu without decorators
- [Admin Partials](/developer/dashboard/customization/quickstart) - Extend admin UI without view decorators
