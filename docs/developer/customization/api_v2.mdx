...
<Note>
Generally it's recommended to use [Properties](../internals/products#product-properties) and [OptionTypes/Option Values](../internals/products#option-types-and-option-values) for custom attributes and not to modify the Spree database schema
</Note>
