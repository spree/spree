...
<Note>
Generally it's recommended to use [Properties](/core-concepts/products#product-properties) and [OptionTypes/Option Values](/core-concepts/products#option-types-and-option-values) for custom attributes and not to modify the Spree database schema
</Note>
