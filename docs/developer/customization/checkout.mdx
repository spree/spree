---
title: Checkout Flow
description: Customize the Spree 5 checkout — add, remove, or reorder steps using the Checkout Flow DSL while preserving SSL security and tokenized payment handling.
version: v5
---
