...
<AccordionGroup>
  ...
  <Accordion title="Payments">
    ...
    <Card
      title="Stripe"
      href="https://github.com/spree/spree_stripe"
    >
      Official Stripe payment gateway for Spree Commerce. Supports all major credit cards, Apple Pay, Google Pay, buy-now-pay-later (Affirm, Afterpay, Klarna), regional payment methods, and more.
    </Card>
  </Accordion>
