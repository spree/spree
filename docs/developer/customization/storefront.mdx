...
<img src="/images//cms_navigation.png" alt="" data-size="line"> To make those changes live you need to update SCSS variable files located in your project at `app/assets/stylesheets/spree/frontend/variables/variables.scss`.
