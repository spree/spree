...
<AccordionGroup>
  ...
  <Accordion title="Authentication">
    **Best for:** using your own user model or identity provider.
    ...
    Spree 6 owns its authentication stack rather than depending on Devise, and separates the customer identity from the staff identity. Point Spree at your own classes with `Spree.customer_class` and `Spree.admin_user_class`.
