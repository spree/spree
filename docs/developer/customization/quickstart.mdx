...
<AccordionGroup>
  ...
  <Accordion title="Dependencies">
    **Best for:** Swapping core services, serializers, and abilities with your own implementations.
    ...
    Please see [Dependencies](/developer/customization/dependencies) section for more information.
  </Accordion>
  ...
  <Accordion title="Authentication">
    **Best for:** Using your own user model or authentication system.
    ...
    You can find more information in the [Authentication](/developer/customization/authentication) section.
  </Accordion>
  ...
  <Accordion title="Checkout flow">
    **Best for:** Customizing checkout steps and flow.
    ...
    Please see [Checkout flow customization section](/developer/customization/checkout) for more information.
  </Accordion>
    ...
    **Best for:** Adding associations, validations, scopes, and methods to Spree models. Use as a last resort.
    ...
    <Warning>
      ...
      **Do NOT use decorators for:**
      ...
      - Custom service logic → Use [Dependencies](/developer/customization/dependencies) instead
    ...
    Please see [Decorators](/developer/customization/decorators) section for more information.
  </Accordion>
</AccordionGroup>
