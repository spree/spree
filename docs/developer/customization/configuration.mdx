...
description: "Reference for every Spree configuration key — defaults, environment-specific overrides, and how to set values via initializers or the admin panel."
---
