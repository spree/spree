---
title: "Configuration"
description: "Complete reference of Spree configuration options you can set in config/initializers/spree.rb to control checkout, inventory, taxes, and store behavior."
---
