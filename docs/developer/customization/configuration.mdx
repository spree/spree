...
All business configuration can be performaed fromm the Admin Dashboard.What is left is a small set of settings describing the *installation*: limits,
expiries, and where things are hosted. **Every one of them is set with an environment
