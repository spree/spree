---
title: "Configuration"
description: "Full reference of Spree configuration options, default values, and behavior flags you can set in config/initializers/spree.rb to customize your store."
---
