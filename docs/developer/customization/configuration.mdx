...
description: "Complete reference for Spree configuration keys — checkout, currency, address, order, mailer, and gateway settings — with defaults and descriptions."
---
