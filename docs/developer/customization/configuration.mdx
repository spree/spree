---
title: "Configuration"
description: "Complete reference of Spree configuration options — checkout, address, capture, validation, and other preferences set in config/initializers/spree.rb."
---
