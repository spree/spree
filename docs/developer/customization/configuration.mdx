---
title: "Spree Configuration Options Reference"
description: Complete reference of Spree configuration keys, default values, and behaviors for checkout, addresses, payments, shipping, taxes, and storefront settings.
---
