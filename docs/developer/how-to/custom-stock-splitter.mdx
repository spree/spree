...
description: Extend Spree's stock splitter chain to break a stock location's allocation into multiple shipments along your own axis, like refrigeration or hazmat.
---
