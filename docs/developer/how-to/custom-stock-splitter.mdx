...
description: Extend Spree's stock splitter chain to break a location's allocation into multiple shipments along axes like refrigeration, gift wrap, or hazmat handling.
---
