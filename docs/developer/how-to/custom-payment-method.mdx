---
title: Build a custom Spree payment method gem
description: "Step-by-step recipe for building a custom Spree payment method gem with Payment Sessions, 3D Secure support, and PCI-compliant checkout integration."
---
