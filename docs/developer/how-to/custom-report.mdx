---
title: "Build a custom Spree report"
description: "Step-by-step guide to building a custom Spree report — define the data query, format line items, and expose CSV export from the admin dashboard."
---
## Overview
