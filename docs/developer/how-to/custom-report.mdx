...
description: "Build a custom Spree report with a data query, line item formatter, and CSV export, plus advanced patterns for SQL aggregation and multi-vendor support."
---
