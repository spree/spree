---
title: Build a custom Spree admin report
description: "Add a custom report to the Spree admin reports section with a Report class, ReportLineItem formatter, CSV export, and registration in Spree.reports."
---
