...
description: Build custom Spree admin reports — define ActiveRecord queries, format rows with ReportLineItem, register reports, and enable CSV export from the admin.
---
