...
- **Actions** — what an applied promotion does, usually writing [Discount](/developer/core-concepts/discounts) rows
...
- [Discounts](/developer/core-concepts/discounts) and [Fees](/developer/core-concepts/fees) — the rows actions and adjusters write
