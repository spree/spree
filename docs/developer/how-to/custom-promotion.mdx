...
description: Create custom Spree promotion rules and actions — implement eligible?, actionable?, and perform contracts to add business-specific discount logic.
---
