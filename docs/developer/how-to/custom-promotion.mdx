---
title: Custom Spree promotion rules and actions
description: "Extend Spree promotions with custom rules and actions in Ruby for business-specific eligibility logic, discount behaviors, and admin UI integration."
---
