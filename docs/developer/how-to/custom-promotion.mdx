...
description: "Create custom Spree promotion rules and actions for business-specific eligibility logic and discount behavior, including admin UI and calculator integration."
---
