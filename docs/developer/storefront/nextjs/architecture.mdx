---
title: Architecture
description: Understand the Spree Next.js storefront architecture — server-first rendering, project structure, httpOnly cookie auth, and Server Action API calls.
---
