---
title: "Next.js storefront server-first architecture"
description: "Server-first architecture, project structure, and auth flow of the Spree Next.js storefront — server actions, API keys, and routing conventions."
---
