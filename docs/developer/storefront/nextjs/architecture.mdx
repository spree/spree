---
title: Architecture
description: Explore the Spree Next.js Storefront server-first architecture, project structure, Server Actions, httpOnly cookie auth flow, and @spree/sdk integration.
---
