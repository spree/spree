---
title: Deployment
description: Deploy the Spree Next.js storefront to Vercel, Docker, or any Node.js host — required env variables, Sentry, GTM, and production build configuration.
---
