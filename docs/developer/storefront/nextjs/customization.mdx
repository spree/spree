---
title: Customization
description: Fork, customize, and extend the Spree Next.js Storefront with Tailwind CSS 4 theming, upstream syncing, custom components, and transactional email templates.
---
