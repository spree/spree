---
title: "Customize the Spree Next.js storefront"
description: "Fork, customize, and extend the Spree Next.js storefront — branding, components, theming with Tailwind, and pulling upstream updates safely."
---
## Forking the Starter
