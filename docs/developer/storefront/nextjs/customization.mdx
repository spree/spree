---
title: Customizing the Spree Next.js storefront
description: "Fork the Spree Next.js storefront repo, customize components, styles, and server actions, and stay in sync with upstream updates via Git remotes."
---
