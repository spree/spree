...
description: Reference for Spree Rails storefront helper methods — access current_store, current_theme, current_order, current_user, and other view helpers in templates.
---
