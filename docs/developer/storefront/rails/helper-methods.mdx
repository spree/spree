...
description: "Reference of Spree Rails storefront helper methods — current_store, current_order, current_user, and theme helpers available across storefront views."
---
