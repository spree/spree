---
title: "Spree Rails storefront view helper methods"
description: "Reference for Spree Rails storefront view helpers — current store, theme, order, and user accessors plus utility helpers used in templates and partials."
