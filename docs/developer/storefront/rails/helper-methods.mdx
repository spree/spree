...
description: Reference Spree Rails storefront helper methods like current_store, current_theme, current_page, and current_order for use in your view templates.
