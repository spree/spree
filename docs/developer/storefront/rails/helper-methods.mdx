---
title: Spree Rails storefront helper methods
sidebarTitle: Helper Methods
description: "Reference for Spree Rails storefront view helpers — current store, current order, theme, user, and other context methods available in every template."
---
