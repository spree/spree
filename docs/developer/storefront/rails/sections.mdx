---
title: "Storefront sections — building blocks of pages"
description: "Use sections — the primary building blocks of pages in the Spree Rails storefront — to compose layouts with reusable headers, footers, and content."
---
## Quick Start
