...
title: "Links"
sidebarTitle: "Links"
description: "Use Spree::PageLink in the Rails storefront to add navigation links to pages, products, taxons, posts, external URLs, mailto, and tel destinations."
---
