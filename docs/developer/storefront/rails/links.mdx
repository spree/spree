---
title: "Storefront links for navigation in Spree"
sidebarTitle: "Links"
description: "Use storefront links to build navigation across sections and blocks — link to products, taxons, pages, blog posts, and external URLs in the Rails storefront."
---
