---
title: Navigation links in the Spree Rails storefront
sidebarTitle: "Links"
description: "Use Spree::PageLink to build navigation, footer, and CTA links to products, taxons, pages, and external URLs in the Spree Rails storefront."
---
