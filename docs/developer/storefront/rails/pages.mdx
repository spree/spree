---
title: CMS pages in the Spree Rails storefront
sidebarTitle: "Pages"
description: "Create and manage CMS pages in the Spree Rails storefront — built-in homepage, taxon, and product pages plus custom pages edited via the Page Builder."
---
