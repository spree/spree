---
title: "Built-in and custom pages in the Spree storefront"
sidebarTitle: "Pages"
description: "Use built-in storefront pages — home, product, cart, checkout — and create custom pages via the page builder for the Spree Rails storefront."
---
## Built-in Pages
