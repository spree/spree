...
sidebarTitle: "Pages"
description: "Create and customize Spree Rails storefront pages — built-in homepage, product, taxon, search, account pages, and custom pages via the Page Builder."
---
