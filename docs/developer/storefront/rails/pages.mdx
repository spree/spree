...
sidebarTitle: "Pages"
description: "Create and customize Spree Rails storefront pages including Homepage, Product Details, Taxon, Search, Blog, and Shop All using the Page Builder admin."
---
