---
title: "Custom CSS for the Spree Rails storefront"
sidebarTitle: "Custom CSS"
description: "Add custom CSS stylesheets to your Spree Rails storefront on top of Tailwind CSS 4 — theming, brand styles, and component-level overrides."
---
