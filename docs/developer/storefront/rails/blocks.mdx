---
title: "Storefront blocks — the lowest-level page elements"
description: "Use blocks — the lowest-level content elements in the Spree Rails storefront — for headings, text, buttons, and media nested inside sections."
---
