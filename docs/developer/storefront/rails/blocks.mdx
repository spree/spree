---
title: Page blocks in the Spree Rails storefront
description: "Build and manage page blocks — headings, text, buttons, and images — nested inside sections in the Spree Rails storefront via the Page Builder."
---
