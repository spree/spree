---
title: "Blocks"
description: "Build storefront content with Spree Page Builder blocks — headings, text, buttons, and images nested inside sections, plus custom block types in Rails."
---
