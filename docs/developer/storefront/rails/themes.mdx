---
title: "Themes in the Spree Rails storefront"
sidebarTitle: "Themes"
description: "Develop, install, and switch themes in the Spree Rails storefront — theme structure, default theme, styles, settings, and customization workflow."
---
