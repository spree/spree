...
description: "Overview of the Spree Rails storefront — a mobile-first, themeable shopfront built with Tailwind CSS v4, Turbo, Stimulus, and Importmaps for fast navigation."
---
