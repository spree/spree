...
module Spree
  class Brand < Spree::Base
    ...
    validates :slug, presence: true, uniqueness: { scope: spree_base_uniqueness_scope } # [!code ++]
  end
end
```
...
<div class="row" data-controller="slug-form seo-form"> <!-- [!code ++] -->
  <div class="col-lg-8">
    <div class="card mb-4">
      <div class="card-body">
        ...
        <%= f.spree_rich_text_area :description,
            data: { seo_form_target: 'sourceDescriptionInput' } %> <!-- [!code ++] -->
      </div>
    </div>
  </div>

  <div class="col-lg-4"> <!-- [!code ++:11] -->
...
def load_brand
  @brand = current_store.brands.friendly.find(params[:id])
end
```
