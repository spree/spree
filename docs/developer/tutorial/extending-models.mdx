---
title: "Tutorial — extend Spree's Product model with Brands"
description: "Extend Spree's core Product model to connect with the custom Brand model — has_many associations, decorators, and serializer updates."
---
