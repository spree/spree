...
```bash
bin/rails g migration AddBrandIdToSpreeProducts brand_id:integer
```
...
module Spree
  module ProductDecorator
    def self.prepended(base)
      # [!code --]
      # Class-level configurations go here
      base.belongs_to :brand, class_name: 'Spree::Brand', optional: true # [!code ++]
    end
  end
...
module Spree
  class Brand < Spree::Base
    ...
    has_many :products, class_name: 'Spree::Product', dependent: :nullify # [!code ++]
...
Spree::PermittedAttributes.product_attributes << :brand_id # [!code ++]
```
