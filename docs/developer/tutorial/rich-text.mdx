---
title: "Tutorial — rich text content with Action Text"
description: "Add rich text content to the Brand model with Rails Action Text — editor integration, attachments, and rendering on the storefront and API."
---
<Info>
