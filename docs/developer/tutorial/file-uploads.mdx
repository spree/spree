...
<div class="card mb-4"> <!-- [!code ++] -->
  <div class="card-header"> <!-- [!code ++] -->
    <h5 class="card-title"><%= Spree.t(:logo) %></h5> <!-- [!code ++] -->
  </div> <!-- [!code ++] -->
  <div class="card-body"> <!-- [!code ++] -->
    <%= f.spree_file_field :logo, width: 300, height: 300 %> <!-- [!code ++] -->
  </div> <!-- [!code ++] -->
</div> <!-- [!code ++] -->
```
...
<tr>
  <td> <!-- [!code ++] -->
    <% if brand.logo.attached? %> <!-- [!code ++] -->
      <%= spree_image_tag brand.logo, width: 48, height: 48, class: 'rounded' %> <!-- [!code ++] -->
    <% else %> <!-- [!code ++] -->
      <div class="bg-light rounded d-flex align-items-center justify-content-center" style="width: 48px; height: 48px;"> <!-- [!code ++] -->
        <%= icon('photo-off', class: 'text-muted') %> <!-- [!code ++] -->
      </div> <!-- [!code ++] -->
    <% end %> <!-- [!code ++] -->
  </td> <!-- [!code ++] -->
  <td>
    <%= link_to brand.name, spree.edit_admin_brand_path(brand) %>
  </td>
  <td>
