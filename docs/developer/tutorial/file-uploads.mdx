---
title: "Tutorial — add file uploads to the Brand model"
description: "Add ActiveStorage file uploads to the Brand model — logos and images, image variants, admin form handling, and storefront delivery via the API."
---
<Info>
