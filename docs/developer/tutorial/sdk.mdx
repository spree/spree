---
title: "Tutorial — consume Brand endpoints from the SDK"
description: "Use the @spree/sdk TypeScript SDK to consume the custom Brand endpoints and extended Product data created earlier in the Spree tutorial series."
---
