---
title: "Tutorial — Brand admin dashboard UI"
description: "Build an admin dashboard UI for the custom Brand model — scaffold views, register routes, add a sidebar menu, and edit Brands from the admin panel."
---
