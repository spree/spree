---
title: "Tutorial — create the Brand database model"
description: "Create the Spree::Brand database model and migration — generator usage, model attributes, validations, and the foundation for the tutorial series."
---
