---
title: "Tutorial — expose Brands via the Spree Store API"
description: "Expose the Brand model through the Spree Store API — serializers, controllers, routes, and extending the Product serializer with brand data."
---
