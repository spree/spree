---
title: "Scaffold a Spree project with create-spree-app"
sidebarTitle: Overview
description: "Scaffold a new Spree Commerce project — Rails backend, optional Next.js storefront, and sample data — in one command with create-spree-app."
---
## Quick Start
