...
Before diving into the Spree codebase we recommend you spend some time reviewing the [Core Concepts section](/developer/core-concepts/architecture) which will help you understand how Spree works under the hood.

After you're done with that please follow to [Developing Spree guide](/developer/contributing/developing-spree)
