...
description: Start contributing to Spree — fix bugs, build features, create extensions, help on Discord, or report issues. A guide for new open-source contributors.
---
