---
title: "Upgrade Spree extensions for Rails 6 and Spree 4"
description: "Upgrade legacy Spree extensions to work with Rails 6 Zeitwerk autoloading, newer Spree versions, and the modern engine and configuration conventions."
version: v4
---
