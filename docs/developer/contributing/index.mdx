...
Before diving into the Spree codebase we recommend you spend some time reviewing the [Internals section](../internals/stores) which will help you understand how Spree works under the hood.
