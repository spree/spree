---
title: "Developing the Spree monorepo locally"
description: "Clone the Spree monorepo, set up your local development environment with Docker or native services, and run the test suite to contribute changes."
---
