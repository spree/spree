---
title: "Create your first Spree extension"
description: "Scaffold a new Spree extension gem from scratch — generators, engine setup, migrations, publishing to RubyGems, and best practices for upgradability."
---
## Overview
