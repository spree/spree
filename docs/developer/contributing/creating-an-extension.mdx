...
| Add admin UI elements | [Admin Partials](/developer/dashboard/customization/quickstart) |
| Add admin menu items | [Admin Navigation](/developer/dashboard/customization/navigation) |
