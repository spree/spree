---
title: "Install Spree Commerce — getting started"
sidebarTitle: Installation
description: "Install Spree Commerce using create-spree-app, the Rails generator, or Docker — the fastest paths to a running Spree backend and Next.js storefront."
---
