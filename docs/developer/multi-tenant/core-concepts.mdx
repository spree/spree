---
title: "Spree multi-tenant architecture core concepts"
description: "Understand the Spree::Tenant model, tenant scoping, isolated data, and how every multi-tenanted record carries a tenant_id for strict separation."
