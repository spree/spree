...
description: "Core concepts behind Spree multi-tenant — the Spree::Tenant class, row-level tenant_id scoping, SpreeMultiTenant::Base models, and tenant seed data."
---
