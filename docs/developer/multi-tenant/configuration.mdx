---
title: "Spree multi-tenant configuration options"
description: "Configure Spree multi-tenant initializers — root domain, tenant resolution, scoping rules, and per-tenant customization knobs in spree_multi_tenant.rb."
