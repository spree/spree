...
description: "Configure the Spree multi-tenant gem — root domain, app subdomain, custom domains per tenant, and other settings in config/initializers/spree_multi_tenant.rb."
---
