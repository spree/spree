...
description: "Configure a multi-tenant Spree SaaS application with root domains, app subdomains, tenant signup, custom domains, and per-tenant configuration options."
