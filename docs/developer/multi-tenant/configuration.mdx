...
description: Configure Spree multi-tenant applications — set the root wildcard domain, allow tenant custom domains, and tune subdomain and tenancy initializer options.
---
