...
description: "Quickstart for building a true SaaS multi-tenant Spree application with the Enterprise spree_multi_tenant gem — compare multi-store and multi-tenant trade-offs."
---
...
[Follow the installation instructions](/developer/multi-tenant/installation) to set up a multi-tenant Spree application.