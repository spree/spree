---
title: "Upgrade Spree 3.7 to 4.0"
description: "Major Spree 3.7 to 4.0 upgrade: requires Ruby 2.5+, removes Paperclip in favor of ActiveStorage, merges spree_address_book into core, and moves to Bootstrap 4."
---
