---
title: "Upgrade Spree from 3.7 to 4.0"
section: upgrades
order: 2
description: "Step-by-step guide to upgrading a Spree 3.7 application to Spree 4.0 — Rails 6, Zeitwerk autoloading, ActiveStorage, and extension compatibility."
---
