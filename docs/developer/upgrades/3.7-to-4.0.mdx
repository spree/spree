...
1. [upgrade 3.4 to 3.5](/developer/upgrades/3.4-to-3.5)
2. [upgrade 3.5 to 3.6](/developer/upgrades/3.5-to-3.6)
3. [upgrade 3.6 to 3.7](/developer/upgrades/3.6-to-3.7)
</Note>
