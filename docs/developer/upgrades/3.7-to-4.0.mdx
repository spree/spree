...
section: upgrades
order: 2
description: "Upgrade a Spree 3.7 app to 4.0: move to Ruby 2.5, drop Paperclip for ActiveStorage, remove spree_address_book, and switch class_eval to Module.prepend."
---
