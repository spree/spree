---
title: 'Upgrade Spree 3.7 to 4.0: Ruby 2.5 and ActiveStorage'
section: upgrades
order: 2
description: 'Upgrade a Spree 3.7 application to 4.0: bump Ruby to 2.5+, complete the Paperclip to ActiveStorage migration, update gems, and run migrations.'
---
