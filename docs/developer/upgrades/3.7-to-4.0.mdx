...
section: upgrades
order: 2
description: "Upgrade Spree 3.7 to 4.0: move to Ruby 2.5, finish the Paperclip to ActiveStorage migration, remove spree_address_book, and replace class_eval with prepend."
---
