...
1. [upgrade 4.1 to 4.2](four-dot-one-to-four-dot-two)
2. [upgrade 4.2 to 4.3](fout-dot-two-to-four-dot-three)
3. [upgrade 4.3 to 4.4](https://docs.spreecommerce.org/developer/upgrades/upgrades/4.3-to-4.4)
