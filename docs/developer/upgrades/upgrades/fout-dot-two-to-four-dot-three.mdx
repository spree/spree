...
1. [upgrade 3.7 to 4.0](three-dot-seven-to-four-dot-oh)
2. [upgrade 4.0 to 4.1](four-dot-oh-to-four-dot-one)
3. [upgrade 4.1 to 4.2](four-dot-one-to-four-dot-two)
...
More [on this topic](https://github.com/rails/sprockets/blob/master/UPGRADING#manifestjs).
...
For information about changes contained within this release, please read the [CHANGELOG](https://github.com/spree/spree/blob/master/CHANGELOG).
