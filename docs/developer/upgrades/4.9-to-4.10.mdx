...
description: "Upgrade Spree 4.9 to 4.10 with a routine bundle update, install pending engine migrations via spree:install:migrations, and read the 4.10.0 release notes."
---
