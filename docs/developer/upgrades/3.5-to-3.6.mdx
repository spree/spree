...
section: upgrades
order: 4
description: "Upgrade Spree 3.5 to 3.6 on Rails 5.2 and begin migrating attachments from the deprecated Paperclip gem to ActiveStorage before 4.0 removes Paperclip."
---
