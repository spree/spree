...
section: upgrades
order: 4
description: "Upgrade a Spree 3.5 app to 3.6, including the move to Rails 5.2, an optional Paperclip-to-ActiveStorage migration, and running new engine migrations."
---
