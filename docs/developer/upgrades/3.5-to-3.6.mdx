---
title: "Upgrade Spree from 3.5 to 3.6 (Rails 5.2)"
section: upgrades
order: 4
description: "Step-by-step guide to upgrading a Spree 3.5 application to Spree 3.6 — Rails 5.2 upgrade, migrations, and extension compatibility notes."
---
