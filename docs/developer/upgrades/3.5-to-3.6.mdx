---
title: "Upgrade Spree 3.5 to 3.6"
description: "Upgrade Spree from 3.5 to 3.6 with Rails 5.2 support, an optional Paperclip-to-ActiveStorage migration path, and the usual engine migration installation."
---
