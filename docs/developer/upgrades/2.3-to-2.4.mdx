...
section: upgrades
description: "Upgrade a Spree 2.3 store to 2.4 by bumping Rails to 4.1.8, updating the spree gem to the 2.4 series, and installing and running engine migrations."
---
