...
title: 2.3 to 2.4
section: upgrades
description: "Upgrade Spree 2.3 to 2.4 with Rails 4.1.8 support: update the Gemfile, run railties:install:migrations, db:migrate, and review the 2.4.0 release notes."
---
