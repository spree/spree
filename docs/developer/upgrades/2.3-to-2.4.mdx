---
title: "Upgrade Spree 2.3 to 2.4"
description: "Step-by-step Spree 2.3 to 2.4 migration guide, bumping Rails to 4.1.8 and updating the Spree gem, plus running engine migrations against your store."
---
