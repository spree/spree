---
title: 'Upgrade Spree 2.3 to 2.4: Rails 4.1.8 bump'
section: upgrades
description: 'Upgrade a Spree 2.3 store to 2.4: bump Rails to 4.1.8, move to the 2-4-stable branch, copy and run engine migrations, and check extensions.'
---
