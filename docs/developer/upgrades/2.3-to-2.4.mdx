---
title: "Upgrade Spree from 2.3 to 2.4"
section: upgrades
description: "Step-by-step guide to upgrading a Spree 2.3 store to Spree 2.4 — gem updates, migrations, breaking changes, and extension compatibility notes."
---
