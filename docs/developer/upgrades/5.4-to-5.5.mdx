---
title: "Upgrade Spree from 5.4 to 5.5"
description: "Step-by-step guide to upgrading a Spree 5.4 application to Spree 5.5 — gem updates, migrations, configuration changes, and extension compatibility."
---
<Info>
