...
- Newly-created products in **the dashboard SPA** are auto-published on the store's default channel (Shopify-style; the merchant can untick channels post-create via the Publishing card).
