---
title: "Upgrade Spree from 3.3 to 3.4"
section: upgrades
order: 6
description: "Step-by-step guide to upgrading a Spree 3.3 store to Spree 3.4 — gem updates, taxon icon migration, and extension compatibility notes."
---
### Update gems
