---
title: 'Upgrade Spree 3.3 to 3.4: migrate Taxon icons'
section: upgrades
order: 6
description: 'Upgrade a Spree 3.3 store to 3.4: bundle update, install missing migrations, and migrate Spree::Taxon icons to use the unified Spree::Asset model.'
---
