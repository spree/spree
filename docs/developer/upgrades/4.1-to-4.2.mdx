---
title: Upgrade Spree 4.1 to 4.2
section: upgrades
order: 0
description: "Upgrade a Spree 4.1 app to 4.2: remove spree_multi_currency, optionally drop spree_i18n config, add deface, and switch fast_jsonapi to jsonapi-serializer."
---
