...
1. [upgrade 3.7 to 4.0](/developer/upgrades/3.7-to-4.0)
2. [upgrade 4.0 to 4.1](/developer/upgrades/4.0-to-4.1)
</Note>
...
If you used [Deface overrides](/developer/customization/v4/deface#organizing-overrides) you will need to include `deface` in your `Gemfile` as it was removed from Spree / Spree Auth Devise / Spree Gateway dependencies.
