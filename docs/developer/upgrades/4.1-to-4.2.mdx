---
title: "Upgrade Spree from 4.1 to 4.2"
section: upgrades
order: 0
description: "Step-by-step guide to upgrading a Spree 4.1 application to Spree 4.2 — gem updates, migrations, configuration changes, and extension compatibility."
---
