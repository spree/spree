...
If you used [Deface overrides](/developer/customization/v4/deface) you will need to include `deface` in your `Gemfile` as it was removed from Spree / Spree Auth Devise / Spree Gateway dependencies.
