...
section: upgrades
order: 0
description: "Upgrade Spree 4.1 to 4.2: remove spree_multi_currency since multi-currency is now core, drop SpreeI18n config, optionally add deface, and fix the RMA migration."
---
