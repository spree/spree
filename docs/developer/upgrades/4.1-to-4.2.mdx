---
title: 'Upgrade Spree 4.1 to 4.2: multi-currency in core'
section: upgrades
order: 0
description: 'Upgrade a Spree 4.1 application to 4.2: bundle update gems, remove the spree_multi_currency gem and its preferences, and run pending migrations.'
---
