...
description: "Spree 4.1 to 4.2 migration: drop spree_multi_currency (now in core), move I18n config to the Store model, and swap fast_jsonapi for jsonapi-serializer."
---
