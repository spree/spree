...
section: upgrades
order: 3
description: "Upgrade Spree 3.6 to 3.7: rename TaxonIcon to TaxonImage, associate orders with stores, enforce order currency, and rename guest_token to token."
---
