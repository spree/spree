---
title: "Upgrade Spree 3.6 to 3.7"
description: "Migrating Spree 3.6 to 3.7: rename TaxonIcon to TaxonImage, associate orders with stores, enforce order currency presence, and rename guest_token to token."
---
