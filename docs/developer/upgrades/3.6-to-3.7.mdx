---
title: 'Upgrade Spree 3.6 to 3.7: Taxon images and Stores'
section: upgrades
order: 3
description: 'Upgrade a Spree 3.6 application to 3.7: rename TaxonIcon to TaxonImage, associate existing orders with a Store, and ensure orders have a currency.'
---
