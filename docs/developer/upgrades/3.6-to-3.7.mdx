...
section: upgrades
order: 3
description: "Upgrade a Spree 3.6 app to 3.7: migrate taxon icons to images, associate orders with stores, backfill order currency, and rename guest_token to token."
---
