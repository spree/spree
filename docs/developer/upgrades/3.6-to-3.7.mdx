---
title: "Upgrade Spree from 3.6 to 3.7"
section: upgrades
order: 3
description: "Step-by-step guide to upgrading a Spree 3.6 application to Spree 3.7 — gem updates, taxon icon migration, and extension compatibility notes."
---
## Update gems
