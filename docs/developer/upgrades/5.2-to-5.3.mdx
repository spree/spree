---
title: 'Upgrade Spree 5.2 to 5.3: Tailwind v4 admin rewrite'
description: 'Upgrade a Spree 5.2 application to 5.3: run new migrations for Price Lists and Customer Groups, then re-run the admin installer for Tailwind v4.'
---
