...
description: "Upgrade a Spree 5.2 app to 5.3: rerun the admin install for Tailwind v4, populate counter caches and product metrics, and replace auto_strip_attributes."
---
