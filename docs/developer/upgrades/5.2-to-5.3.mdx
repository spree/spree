...
description: "Upgrade Spree 5.2 to 5.3 with new Price Lists, Customer Groups, and Tailwind v4 admin. Reset counter caches and populate product metrics rake tasks."
---
