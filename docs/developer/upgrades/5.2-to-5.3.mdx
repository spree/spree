---
title: "Upgrade Spree from 5.2 to 5.3"
description: "Step-by-step guide to upgrading a Spree 5.2 application to Spree 5.3 — gem updates, migrations, configuration changes, and extension compatibility."
---
<Info>
