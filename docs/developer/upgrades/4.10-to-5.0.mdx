---
title: "Upgrade Spree from 4.10 to 5.0"
description: "Step-by-step guide to upgrading a Spree 4.10 application to Spree 5.0 — major breaking changes, new admin dashboard, and extension compatibility."
---
<Info>
