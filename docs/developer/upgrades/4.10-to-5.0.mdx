---
title: 'Upgrade Spree 4.10 to 5.0: Rails 7.2 and new admin'
description: 'Upgrade Spree 4.10 to 5.0: drop Rails < 7.2 and spree_auth_devise, adopt the new admin dashboard, native Stripe extension, and Devise generator.'
---
