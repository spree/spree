...
description: "Upgrade a Spree 4.10 app to 5.0: move to Rails 7.2, drop spree_auth_devise for Devise, install the rewritten admin dashboard, and add the native Stripe gem."
---
