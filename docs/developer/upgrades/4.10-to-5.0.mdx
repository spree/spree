...
description: "Upgrade Spree 4.10 to 5.0: drop spree_auth_devise and old backend/frontend gems, install spree_admin and spree_stripe, and require Rails 7.2 and Ruby 3.2."
---
