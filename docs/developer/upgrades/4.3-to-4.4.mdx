---
title: "Upgrade Spree 4.3 to 4.4"
description: "Spree 4.3 to 4.4 upgrade notes: spree_digital and spree_wishlist were merged into core, webhooks were introduced, and new Sidekiq queues should be configured."
---
