---
title: "Upgrade Spree from 4.3 to 4.4"
description: "Step-by-step guide to upgrading a Spree 4.3 application to Spree 4.4 — gem updates, migrations, configuration changes, and extension compatibility."
---
<Note>
