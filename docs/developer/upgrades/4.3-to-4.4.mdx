---
title: 4.3 to 4.4
description: "Upgrade Spree 4.3 to 4.4: drop spree_digital and spree_wishlist gems now merged into core, re-run backend and frontend install generators, and set up Sidekiq."
---
