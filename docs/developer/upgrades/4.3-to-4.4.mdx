...
1. [upgrade 4.0 to 4.1](/developer/upgrades/4.0-to-4.1)
2. [upgrade 4.1 to 4.2](/developer/upgrades/4.1-to-4.2)
3. [upgrade 4.2 to 4.3](/developer/upgrades/4.2-to-4.3)
</Note>
