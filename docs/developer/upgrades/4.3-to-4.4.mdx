---
title: 'Upgrade Spree 4.3 to 4.4: digital products in core'
description: 'Upgrade a Spree 4.3 application to 4.4: bundle update gems, remove spree_digital and other gems whose features are now merged into Spree Core.'
---
...
If you have any questions or suggestions feel free join our [Discord](https://discord.spreecommerce.org/)
