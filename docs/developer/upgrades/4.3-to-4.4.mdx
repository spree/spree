...
description: "Upgrade a Spree 4.3 app to 4.4: drop spree_digital and spree_wishlist, run the install generators, add Sidekiq queues, and configure built-in webhooks."
---
