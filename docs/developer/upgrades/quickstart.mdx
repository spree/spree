---
title: "Spree upgrade quickstart and version path"
description: "How to upgrade a Spree application safely — pick the right upgrade path, run migrations incrementally, and keep extensions compatible across versions."
---
