...
description: Step-by-step guide to upgrading a Spree 5.3 application to Spree 5.4, including gem updates, migrations, configuration, and breaking changes to review.
---
