---
title: 'Upgrade Spree 5.3 to 5.4: AdminUserMethods concern'
description: 'Upgrade a Spree 5.3 application to 5.4: remove spree_sample, run new migrations, and switch admin models to the Spree::AdminUserMethods concern.'
---
...
[Multi-store](/developer/multi-store/quickstart) features like multiple store management & custom domains were moved to a separate gem [spree_multi_store](/developer/multi-store/quickstart).
