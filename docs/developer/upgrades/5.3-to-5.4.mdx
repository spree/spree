...
description: "Upgrade Spree 5.3 to 5.4: drop the spree_sample gem, switch admin users to AdminUserMethods, backfill primary_media thumbnails, and adopt prefixed resource IDs."
---
