...
description: "Upgrade a Spree 5.3 app to 5.4: backfill primary_media thumbnails, adopt prefixed IDs, migrate checkout zones to Markets, and drop ActiveMerchant."
---
