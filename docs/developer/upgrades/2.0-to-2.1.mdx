---
title: 2.0 to 2.1
description: "Upgrade a Spree 2.0 store to 2.1, the first release requiring Rails 4. Covers Gemfile bumps, running railties migrations, and the 2-1-stable branch."
---
