---
title: "Upgrade Spree 2.0 to 2.1"
description: "Upgrade guide for moving a Spree store from 2.0 to 2.1, the first release to require Rails 4. Covers gem updates and running engine migrations."
---
