---
title: 'Upgrade Spree 2.0 to 2.1: Rails 4 support'
description: 'Upgrade a Spree 2.0 store to 2.1: switch to Rails 4 exclusively, update gems on the 2-1-stable branch, copy migrations, and verify extensions.'
---
