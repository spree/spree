---
title: "Upgrade Spree from 2.0 to 2.1"
description: "Step-by-step guide to upgrading a Spree 2.0 store to Spree 2.1 — gem updates, migrations, breaking changes, and extension compatibility notes."
---
## Overview
