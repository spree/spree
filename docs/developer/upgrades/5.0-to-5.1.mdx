---
title: "Upgrade Spree 5.0 to 5.1"
description: "Spree 5.0 to 5.1 upgrade guide covering gem updates, engine migrations, and the new admin role-based user accounts via db:migrate_admin_users_to_role_users."
---
