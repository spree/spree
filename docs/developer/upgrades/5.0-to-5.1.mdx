...
description: "Upgrade Spree 5.0 to 5.1 and adopt native Gift Cards and Admin Staff Management. Run db:migrate_admin_users_to_role_users to convert existing admin accounts."
---
