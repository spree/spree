---
title: 'Upgrade Spree 5.0 to 5.1: migrate admin user roles'
description: 'Upgrade a Spree 5.0 application to 5.1: bundle update gems, run new migrations, and migrate existing admin user accounts to the new role system.'
---
