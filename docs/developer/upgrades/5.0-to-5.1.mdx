...
description: "Upgrade a Spree 5.0 app to 5.1 with bundle update, new migrations, and a rake task to migrate existing admin user accounts into the new role-based system."
---
