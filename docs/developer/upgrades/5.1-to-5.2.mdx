...
description: "Upgrade Spree 5.1 to 5.2: replace Sprockets with Propshaft, migrate product properties to flexible Metafields, and move store policies to the new Policy model."
---
