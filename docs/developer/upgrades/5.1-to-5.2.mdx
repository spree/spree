...
description: "Upgrade a Spree 5.1 app to 5.2: switch from Sprockets to Propshaft, migrate product properties to Metafields, move store policies, and adopt Tailwind v4."
---
