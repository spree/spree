---
title: "Upgrade Spree 5.1 to 5.2"
description: "Spree 5.1 to 5.2 release notes: move from Sprockets to Propshaft, migrate Product Properties to Metafields, adopt the new Policy model, and try Tailwind v4."
---
