---
title: "Upgrade Spree from 5.1 to 5.2"
description: "Step-by-step guide to upgrading a Spree 5.1 application to Spree 5.2 — Propshaft asset pipeline, gem updates, and extension compatibility notes."
---
<Info>
