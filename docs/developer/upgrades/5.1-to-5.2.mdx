---
title: 'Upgrade Spree 5.1 to 5.2: Propshaft and Metafields'
description: 'Upgrade a Spree 5.1 application to 5.2: replace sprockets with propshaft, run migrations, and optionally adopt Metafields instead of Product Properties.'
---
