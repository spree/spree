...
section: upgrades
order: 8
description: "Upgrade Spree 3.1 to 3.2, the first release requiring Rails 5.0. Covers bundle update, the Rails 4.2 to 5.0 jump, and installing engine migrations."
---
