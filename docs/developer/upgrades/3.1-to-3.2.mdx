...
description: "Migration notes for moving Spree from 3.1 to 3.2, including the required Rails 5.0 upgrade, bundle updates, and installing/running new engine migrations."
---
