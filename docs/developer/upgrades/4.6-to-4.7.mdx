---
title: 4.6 to 4.7
description: "Upgrade Spree 4.6 to 4.7 with a quick bundle update, install missing migrations, and optionally re-run the spree_rails_frontend install generator."
---
