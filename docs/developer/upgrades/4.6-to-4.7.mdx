---
title: "Upgrade Spree from 4.6 to 4.7"
description: "Step-by-step guide to upgrading a Spree 4.6 application to Spree 4.7 — gem updates, migrations, configuration changes, and recommended path to 4.8."
---
<Warning>
