---
title: 'Upgrade Spree 4.6 to 4.7: refreshed install steps'
description: 'Upgrade a Spree 4.6 application to 4.7: bundle update gems, run spree:install:migrations and db:migrate, and re-run the Spree Frontend installer.'
---
