---
title: "Upgrade Spree 4.6 to 4.7"
description: "Release notes for the Spree 4.6 to 4.7 upgrade — run bundle update, install pending engine migrations, and re-run the Spree Frontend install generator."
---
