---
title: 'Upgrade Spree 4.5 to 4.6: built-in translations'
description: 'Upgrade a Spree 4.5 application to 4.6: bundle update gems and remove spree_globalize, since translations now ship via the Mobility gem in core.'
---
