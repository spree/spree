---
title: "Upgrade Spree from 4.5 to 4.6"
description: "Step-by-step guide to upgrading a Spree 4.5 application to Spree 4.6 — gem updates, migrations, configuration changes, and recommended path to 4.8."
---
<Warning>
