...
description: "Upgrade a Spree 4.5 app to 4.6: replace spree_globalize with built-in Mobility translations, migrate to translation tables, and update pg_search scopes."
---
