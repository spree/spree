...
<Warning>
We recommend [upgrading straight to 4.8](4.7-to-4.8), as we improved how we handle translations in 4.8.
...
If you want to translate more fields in [translated resources](/developer/customization/i18n#resource-translations), you have to alter copied migrations or add new ones.
...
[Read more](/developer/customization/i18n#resource-translations-implementation) how Spree handles resource translations.
...
If you use the [pg_search](https://github.com/Casecommons/pg_search) for the full text search in [translated resources](/developer/customization/i18n#resource-translations), you need to move your scopes to the translated model, eg. from the `Spree::Product` to the `Spree::Product::Translation`. 
