---
title: 4.5 to 4.6
description: "Upgrade Spree 4.5 to 4.6 and replace spree_globalize with built-in Mobility-powered translations, moving copy to dedicated spree_products_translations tables."
---
