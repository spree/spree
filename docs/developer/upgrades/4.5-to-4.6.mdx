...
1. [upgrade 4.2 to 4.3](/developer/upgrades/4.2-to-4.3)
2. [upgrade 4.3 to 4.4](/developer/upgrades/4.3-to-4.4)
3. [upgrade 4.4 to 4.5](/developer/upgrades/4.4-to-4.5)
</Note>
