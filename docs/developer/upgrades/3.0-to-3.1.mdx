...
section: upgrades
order: 9
description: "Upgrade Spree 3.0 to 3.1: namespace custom Rabl templates under v1, drop the check_for_spree_alerts preference, and run installed engine migrations."
---
