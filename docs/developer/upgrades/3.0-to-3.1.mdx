---
title: 'Upgrade Spree 3.0 to 3.1: namespace Rabl templates'
section: upgrades
order: 9
description: 'Upgrade a Spree 3.0 store to 3.1: bundle update gems, run migrations, namespace custom Rabl templates under v1, and drop check_for_spree_alerts.'
---
