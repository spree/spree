...
section: upgrades
order: 9
description: "Upgrade a Spree 3.0 store to 3.1: bundle gem updates, new migrations, adding the v1 API namespace to rabl templates, and removing the alerts preference."
---
