---
title: "Upgrade Spree 3.0 to 3.1"
description: "Spree 3.0 to 3.1 upgrade guide covering bundle updates, engine migrations, namespacing custom RABL templates under v1, and removing legacy Spree alert checks."
---
