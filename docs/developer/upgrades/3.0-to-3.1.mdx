---
title: "Upgrade Spree from 3.0 to 3.1"
section: upgrades
order: 9
description: "Step-by-step guide to upgrading a Spree 3.0 store to Spree 3.1 — gem updates, migrations, breaking changes, and extension compatibility notes."
---
## Update gems
