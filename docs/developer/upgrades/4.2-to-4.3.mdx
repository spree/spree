...
order: 0
hidden: true
description: "Upgrade Spree 4.2 to 4.3: split spree_emails, spree_backend and spree_frontend into separate gems, then remove spree_multi_domain and spree_editor."
---
