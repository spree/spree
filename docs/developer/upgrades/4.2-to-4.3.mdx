---
title: Upgrade Spree 4.2 to 4.3
section: upgrades
order: 0
hidden: true
description: "Upgrade a Spree 4.2 app to 4.3: add the new spree_backend, spree_frontend, and spree_emails gems, remove merged extensions, and upgrade to Sprockets 4."
---
