---
title: "Upgrade Spree from 4.2 to 4.3"
section: upgrades
order: 0
hidden: true
description: "Step-by-step guide to upgrading a Spree 4.2 application to Spree 4.3 — gem updates, migrations, configuration changes, and extension compatibility."
---
<Note>
