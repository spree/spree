---
title: 'Upgrade Spree 4.2 to 4.3: split backend and frontend'
section: upgrades
order: 0
hidden: true
description: 'Upgrade a Spree 4.2 application to 4.3: add spree_backend, spree_frontend, and spree_emails gems, and remove spree_multi_domain merged into core.'
---
