---
title: "Upgrade Spree from 4.0 to 4.1"
section: upgrades
order: 1
description: "Step-by-step guide to upgrading a Spree 4.0 application to Spree 4.1 — gem updates, migrations, configuration changes, and extension compatibility."
---
<Note>
