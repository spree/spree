...
section: upgrades
order: 1
description: "Upgrade a Spree 4.0 app to 4.1 with bundle updates, new migrations, and the option to adopt the new Turbolinks-powered mobile-first Storefront UI."
---
