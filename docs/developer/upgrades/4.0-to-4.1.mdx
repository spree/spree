---
title: 'Upgrade Spree 4.0 to 4.1: new Turbolinks storefront'
section: upgrades
order: 1
description: 'Upgrade a Spree 4.0 application to 4.1: bundle update gems, run migrations, and optionally migrate to the new mobile-first Turbolinks storefront UI.'
---
