---
title: "Upgrade Spree 4.0 to 4.1"
description: "Spree 4.0 to 4.1 upgrade guide — adopt the new mobile-first Turbolinks-powered Storefront UI via spree:frontend:copy_storefront, or keep the 4.0 frontend."
---
