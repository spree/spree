...
1. [upgrade 3.5 to 3.6](/developer/upgrades/3.5-to-3.6)
2. [upgrade 3.6 to 3.7](/developer/upgrades/3.6-to-3.7)
3. [upgrade 3.7 to 4.0](/developer/upgrades/3.7-to-4.0)
</Note>
