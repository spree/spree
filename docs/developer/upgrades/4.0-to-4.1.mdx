...
section: upgrades
order: 1
description: "Upgrade Spree 4.0 to 4.1 and adopt the new mobile-first Turbolinks Storefront UI, or keep the legacy 4.0 frontend by copying its views, assets, and helpers."
---
