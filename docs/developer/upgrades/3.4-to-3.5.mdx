...
section: upgrades
order: 5
description: "Upgrade a Spree 3.4 store to 3.5, including bundle updates, new migrations, and installing the extracted spree_analytics_trackers extension for tracking."
---
