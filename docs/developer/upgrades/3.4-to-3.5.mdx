...
section: upgrades
order: 5
description: "Upgrade Spree 3.4 to 3.5: install Analytics Trackers as an external extension after it was extracted from core, then run the install generator and migrations."
---
