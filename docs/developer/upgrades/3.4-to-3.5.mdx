---
title: 'Upgrade Spree 3.4 to 3.5: extract Analytics Trackers'
section: upgrades
order: 5
description: 'Upgrade a Spree 3.4 store to 3.5: bundle update gems, run migrations, and install the spree_analytics_trackers extension extracted from core.'
---
