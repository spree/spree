---
title: Upgrade Spree 3.2 to 3.3
section: upgrades
order: 7
description: "Upgrade a Spree 3.2 store to 3.3: move to Rails 5.1, include UserMethods in your User class, and bump aws-sdk to 2.0 for Paperclip 5.1 support."
---
