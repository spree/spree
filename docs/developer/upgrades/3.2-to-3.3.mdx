---
title: "Upgrade Spree from 3.2 to 3.3 (Rails 5.1)"
section: upgrades
order: 7
description: "Step-by-step guide to upgrading a Spree 3.2 store to Spree 3.3 — Rails 5.1 upgrade, migrations, breaking changes, and extension compatibility notes."
---
