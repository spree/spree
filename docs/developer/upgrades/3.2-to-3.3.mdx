...
section: upgrades
order: 7
description: "Upgrade Spree 3.2 to 3.3 on Rails 5.1 with Paperclip 5.1: include UserMethods, bump aws-sdk to 2.0, and add jquery.validate if you used it directly."
---
