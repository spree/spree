---
title: 'Upgrade Spree 3.2 to 3.3: Rails 5.1 and UserMethods'
section: upgrades
order: 7
description: 'Upgrade a Spree 3.2 store to 3.3: move to Rails 5.1, run migrations, include Spree::UserMethods in your User class, and update aws-sdk gem.'
---
