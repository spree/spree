...
description: "Spree 3.2 to 3.3 upgrade steps: bump to Rails 5.1, include Spree::UserMethods manually, and update aws-sdk to 2.0 for Paperclip 5.1 / S3 support."
---
