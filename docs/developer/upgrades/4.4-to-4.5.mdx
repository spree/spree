---
title: 4.4 to 4.5
description: "Upgrade Spree 4.4 to 4.5 on Rails 6.1 or 7.x: drop Rails 6.0, wrap Spree.config in after_initialize for Rails 7, and install libvips for ActiveStorage variants."
---
