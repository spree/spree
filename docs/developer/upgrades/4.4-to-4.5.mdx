---
title: 'Upgrade Spree 4.4 to 4.5: drop Rails 6.0'
description: 'Upgrade a Spree 4.4 application to 4.5: move off Rails 6.0 to Rails 6.1 or 7.x for ActiveStorage and CDN improvements, then bundle update gems.'
---
