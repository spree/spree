...
<Warning>
We recommend [upgrading straight to 4.8](/developer/upgrades/4.x-to-4.8), as we improved how we handle translations in 4.8.
...
1. [upgrade 4.1 to 4.2](/developer/upgrades/4.1-to-4.2)
2. [upgrade 4.2 to 4.3](/developer/upgrades/4.2-to-4.3)
3. [upgrade 4.3 to 4.4](/developer/upgrades/4.3-to-4.4)
</Note>
