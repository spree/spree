...
description: "Upgrade a Spree 4.4 app to 4.5: move to Rails 6.1 or 7.x, install libvips for variants, wrap initializers in after_initialize, and add spree_api_v1."
---
