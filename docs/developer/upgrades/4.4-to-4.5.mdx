---
title: "Upgrade Spree 4.4 to 4.5"
description: "Spree 4.4 to 4.5 migration drops Rails 6.0 support, requires Rails 6.1 or 7.x, and extracts the legacy REST API v1 into the standalone spree_api_v1 gem."
---
