---
title: "Upgrade Spree from 4.4 to 4.5"
description: "Step-by-step guide to upgrading a Spree 4.4 application to Spree 4.5 — gem updates, migrations, configuration changes, and recommended path to 4.8."
---
<Warning>
