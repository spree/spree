---
title: "Upgrade Spree from 4.x directly to 4.8"
description: "Recommended path to upgrade Spree 4.4+ applications directly to Spree 4.8 — improved translations, simpler migrations, and consolidated changes."
---
<Info>
