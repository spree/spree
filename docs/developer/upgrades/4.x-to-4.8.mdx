---
title: "Upgrade Spree 4.x to 4.8"
description: "Upgrade Spree 4.4+ stores directly to 4.8: switches asset management to importmap-rails and improves translations handling for large product catalogs."
---
