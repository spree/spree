...
description: "Upgrade a Spree 4.x app to 4.8: install importmap-rails for asset management, run new migrations, and enable always_use_translations when coming from 4.5-4.7."
---
