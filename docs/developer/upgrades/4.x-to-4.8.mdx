---
title: 'Upgrade Spree 4.x to 4.8: importmap-rails switch'
description: 'Upgrade a Spree 4.4+ application to 4.8: bundle update, run migrations, install importmap-rails, and drop jsbundling-rails for asset management.'
---
