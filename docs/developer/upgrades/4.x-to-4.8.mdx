...
description: "Upgrade any Spree 4.4+ application to 4.8: swap jsbundling-rails for importmap-rails with Turbo and Stimulus, and enable always_use_translations."
---
