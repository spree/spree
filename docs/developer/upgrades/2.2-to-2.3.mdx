---
title: "Upgrade Spree from 2.2 to 2.3"
description: "Step-by-step guide to upgrading a Spree 2.2 store to Spree 2.3 — gem updates, migrations, breaking changes, and extension compatibility notes."
---
## Overview
