---
title: 'Upgrade Spree 2.2 to 2.3: Rails 4.1 support'
description: 'Upgrade a Spree 2.2 store to 2.3: move to Rails 4.1.2, switch to the 2-3-stable branch, copy migrations, and verify extension compatibility.'
---
