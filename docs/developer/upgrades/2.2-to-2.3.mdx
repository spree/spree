...
description: "Upgrade a Spree 2.2 store to 2.3, including upgrading Rails to 4.1.2, switching to the 2-3-stable spree branch, and installing engine migrations."
---
