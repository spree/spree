---
title: 2.2 to 2.3
description: "Upgrade a Spree 2.2 store to 2.3, the first release supporting Rails 4.1. Bump the rails gem to 4.1.2, switch to 2-3-stable, and run new migrations."
---
