---
title: "Upgrade Spree from 2.1 to 2.2"
section: upgrades
description: "Step-by-step guide to upgrading a Spree 2.1 store to Spree 2.2 — gem updates, migrations, breaking changes, and extension compatibility notes."
---
