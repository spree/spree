...
section: upgrades
description: "Upgrade a Spree 2.1 store to 2.2: bump Rails to 4.0.6, rename backend and frontend asset paths, and handle Paperclip settings removed from master."
---
