---
title: "Upgrade Spree 2.1 to 2.2"
description: "Migration steps for the Spree 2.1 to 2.2 upgrade, including renamed asset paths (spree/backend, spree/frontend) and Paperclip configuration changes."
---
