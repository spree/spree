...
title: 2.1 to 2.2
section: upgrades
description: "Upgrade Spree 2.1 to 2.2 on Rails 4.0.6: rename spree/backend and spree/frontend asset paths, remove Paperclip master settings, and install migrations."
---
