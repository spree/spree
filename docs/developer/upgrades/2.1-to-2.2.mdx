---
title: 'Upgrade Spree 2.1 to 2.2: bump Rails to 4.0.6'
section: upgrades
description: 'Upgrade a Spree 2.1 store to 2.2: bump Rails to 4.0.6, switch gems to the 2-2-stable branch, copy migrations, and verify extension compatibility.'
---
