---
title: Spree Commerce security policy and reporting
description: "How to report security vulnerabilities responsibly, which Spree Commerce versions receive security updates, and the project's security practices."
---
