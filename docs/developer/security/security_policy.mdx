---
title: "Spree security policy and vulnerability reporting"
description: "How to report security vulnerabilities in Spree, supported version policy, and the Spree team's secure-development and disclosure practices."
---
## Overview
