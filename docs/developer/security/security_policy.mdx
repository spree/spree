...
description: "Spree's security policy covering supported versions, how to report vulnerabilities responsibly, security patches, and recommended Rails security practices."
---
