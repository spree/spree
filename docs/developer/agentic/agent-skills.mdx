...
<Note>
The skills target Spree 6. For a Spree 5 project, use the [`v0.3.0` release](https://github.com/spree/agent-skills/tree/v0.3.0) of the skills.
</Note>
...
- **create-spree-app projects** (Docker, Rails app in `server/`) — commands route through the [Spree CLI](/developer/cli/quickstart) (`spree migrate`, `spree console`, …).
