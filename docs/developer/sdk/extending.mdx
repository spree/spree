...
For a complete walkthrough — creating the API endpoints on the backend, defining TypeScript types, filtering, and expanding associations — see the [API](/developer/tutorial/admin-api) and [SDK](/developer/tutorial/storefront) tutorials.
