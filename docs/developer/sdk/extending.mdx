---
title: "Call custom Store API endpoints from the Spree SDK"
sidebarTitle: Custom Endpoints
description: "Use the Spree SDK's request method to call custom Store API endpoints you've added — the same primitive that powers every built-in resource client."
---
