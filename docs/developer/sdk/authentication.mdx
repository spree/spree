---
title: Spree SDK authentication and tokens
description: "Authenticate against the Spree Store API with the @spree/sdk client using JWT customer tokens, guest order tokens, and publishable key headers."
---
