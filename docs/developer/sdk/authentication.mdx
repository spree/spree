...
description: Configure Spree SDK authentication with publishable API keys, JWT tokens, and guest cart tokens for public, customer, and headless storefront access.
---
