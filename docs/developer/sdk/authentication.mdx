...
description: "Authenticate with the Spree SDK using publishable keys, JWT customer tokens, and order tokens — including guest checkout flows and authenticated requests."
---
