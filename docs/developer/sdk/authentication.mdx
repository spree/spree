---
title: "Spree SDK authentication and guest checkout"
description: "Authenticate the Spree TypeScript SDK with API keys and JWT customer tokens — including guest cart promotion and order-token-based session handling."
---
