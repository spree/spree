---
title: "Wishlists and wished items with the Spree SDK"
description: "Create, list, and manage customer wishlists and wished items with the Spree TypeScript SDK against the Store API wishlist endpoints."
---
## Wishlists
