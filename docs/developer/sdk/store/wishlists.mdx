---
title: Spree SDK wishlists and wished items
description: "Create, list, update, and delete customer wishlists and wished items on the Spree storefront with the @spree/sdk wishlists API and JWT auth."
---
