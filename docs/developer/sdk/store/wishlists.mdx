---
title: Wishlists
description: "Manage customer wishlists and wished items using the Spree SDK, including creating private wishlists, adding variants, updating, and deleting entries."
---
