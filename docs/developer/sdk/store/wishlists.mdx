---
title: Wishlists
description: Create and manage customer wishlists and wished items with the Spree SDK — list, share private wishlists, add variants, and remove items via JWT auth.
---
