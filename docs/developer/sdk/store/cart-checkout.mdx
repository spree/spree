...
description: Use the Spree SDK to create carts, add line items, apply coupon codes, run the checkout flow with addresses, delivery, payments, and fetch orders.
---
