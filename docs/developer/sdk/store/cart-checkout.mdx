---
title: Spree SDK cart, checkout, and orders
description: "Use the Spree SDK to manage shopping carts, line items, coupon codes, the checkout flow, address steps, delivery selection, and completed orders."
---
