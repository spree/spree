...
description: Use the Spree SDK to retrieve payment methods, create Payment Sessions for Stripe and Adyen, select delivery rates, and complete checkout payments.
---
