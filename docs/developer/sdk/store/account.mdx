...
description: "Manage customer profiles, addresses, credit cards, and store credit balances with the Spree SDK Storefront API in TypeScript for headless apps."
---
