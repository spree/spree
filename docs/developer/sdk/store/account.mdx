...
description: "Manage customer profiles, addresses, credit cards, and store credit totals through the Spree SDK's customer endpoints with JWT-authenticated requests."
---
