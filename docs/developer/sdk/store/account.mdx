---
title: "Customer accounts with the Spree SDK"
description: "Manage customer profiles, addresses, and saved credit cards with the Spree TypeScript SDK — including store-credit balances and display name helpers."
---
## Customer Profile
