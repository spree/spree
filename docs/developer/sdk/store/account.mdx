---
title: Spree SDK customer account methods
description: "Manage customer profiles, shipping addresses, saved credit cards, and store credit balances on the Spree storefront with the @spree/sdk customer API."
---
