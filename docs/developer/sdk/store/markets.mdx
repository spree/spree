---
title: "Markets and country resolution with the Spree SDK"
description: "Fetch markets, resolve the current market by country, and list market countries with the Spree TypeScript SDK for multi-region storefronts."
---
## List Markets
