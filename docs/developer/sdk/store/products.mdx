---
title: Spree SDK products and category browsing
description: "Fetch products, variants, taxons, and categories on the storefront with the Spree SDK — list, filter, sort, paginate, and expand related resources."
---
