---
title: "Browse products and categories with the Spree SDK"
description: "List, filter, and fetch products and categories with the Spree TypeScript SDK — including expand, pagination, and faceted filtering parameters."
---
## Products
