...
<Tip>
  Adding your own resources? The [`spree generate api_resource`](/developer/tutorial/admin-api) generator scaffolds Admin API endpoints (model, serializers, controllers, specs) in one command, and the [extending guide](/developer/sdk/extending) shows how to call custom endpoints from the SDK.
</Tip>
