...
<Note>
  Foreign-key predicates accept **prefixed IDs** (`customer_id_eq: 'cus_xxx'`, `variant_id_in: ['variant_a', 'variant_b']`) — the API translates them; you never handle raw database IDs.
</Note>
