...
- The [API](/developer/tutorial/admin-api) and [SDK](/developer/tutorial/storefront) tutorials walk through creating new Spree endpoints end-to-end (Rails controller, serializer, TypeScript types). Everything they show for the Store API applies equivalently for the Admin API.
