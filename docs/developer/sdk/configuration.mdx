---
title: "Spree SDK configuration and TypeScript options"
description: "Configure the Spree TypeScript SDK — localization headers, currency, error handling, type narrowing, and custom fetch implementations for SSR and edge."
---
