...
Five more are available to add: a **document** upload for you to review, a **seller confirmation** they attest to, a **manual check** you perform, a **seller policy** they must publish, **required custom fields** they must fill in, and — for marketplaces that pay through a provider — a **payout account** they connect.
