...
![Managing storefront themes in Spree Commerce](/images/user/storefront/themes/theme-editor/1-themes-tab.png)

Find the theme with the status **Live** and click on it to open the theme editor.

![The Spree Commerce theme editor](/images/user/storefront/themes/theme-editor/2-theme-editor.png)
...
![The top navigation bar in the Spree Commerce theme editor](/images/user/storefront/themes/theme-editor/3-top-navigation.png)
...
![The page selector in the Spree Commerce theme editor](/images/user/storefront/themes/theme-editor/4-page-selector.png)
...
![Modifying color schemes in the Spree Commerce theme editor](/images/user/storefront/themes/theme-editor/5-color-scheme.png)
...
![Setting fonts in the Spree Commerce theme editor](/images/user/storefront/themes/theme-editor/6-fonts.png)
...
![Switch between mobile and desktop preview in the Spree Commerce theme editor](/images/user/storefront/themes/theme-editor/7-views.png)
...
![The side navigation bar in the Spree Commerce theme editor](/images/user/storefront/themes/theme-editor/8-side-navigation.png)

The side navigation allows you to add, configure, and arrange page sections and individual content blocks.

### Page Section Settings

![Configuring page section settings in the Spree Commerce theme editor](/images/user/storefront/themes/theme-editor/9-page-sections.png)
...
![Configuring the announcement bar in the Spree Commerce theme editor](/images/user/storefront/themes/theme-editor/10-announcement-bar.png)
...
![Configuring the header in the Spree Commerce theme editor](/images/user/storefront/themes/theme-editor/11-page-header.png)
...
![Adding blocks to the header in the Spree Commerce theme editor](/images/user/storefront/themes/theme-editor/12-add-blocks.png)
...
![Configuring the newsletter sections in the Spree Commerce theme editor](/images/user/storefront/themes/theme-editor/13-newsletter.png)

A global email capture section to build your subscriber list. Customize text and styling as needed.

### Footer

![Configuring the footer section in the Spree Commerce theme editor](/images/user/storefront/themes/theme-editor/14-footer.png)
...
![Adding more pages section in the Spree Commerce theme editor](/images/user/storefront/themes/theme-editor/15-add-section.png)
...
![Rearranging page sections in the Spree Commerce theme editor](/images/user/storefront/themes/theme-editor/16-rearrange-sections.png)
...
![Deleting page sections in the Spree Commerce theme editor](/images/user/storefront/themes/theme-editor/17-delete-section.png)
