...
![Creating a new storefront theme in Spree Commerce](/images/user/storefront/themes/create-new-theme/1-themes-tab.png)

You have two options to create a new one:

### Clone an Existing Theme

![Cloning an existing storefront theme in Spree Commerce](/images/user/storefront/themes/create-new-theme/2-clone-theme.png)
...
![Choosing a starter storefront theme template in Spree Commerce](/images/user/storefront/themes/create-new-theme/3-starter-theme.png)
...
![Publishing a new storefront theme in Spree Commerce](/images/user/storefront/themes/create-new-theme/4-publish-theme.png)
