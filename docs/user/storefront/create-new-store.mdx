---
title: "Create and manage multiple stores in Spree"
description: "Create and manage additional stores in Spree's multi-store admin — separate branding, products, currencies, and policies from a single backend."
---
