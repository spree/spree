...
![How to create a new store in Spree Commerce](/images/user/storefront/create-new-store/1-add-new-store.png)
...
![Configuring new store settings in Spree Commerce](/images/user/storefront/create-new-store/2-new-store-settings.png)
...
![How to switch between stores in Spree Commerce](/images/user/storefront/create-new-store/3-switch-stores.png)
