---
title: "Customize the product details page in Spree"
description: "Customize the Product Details Page (PDP) in the Spree Theme Editor — layout, media, descriptions, related products, and conversion-focused sections."
---
...
![Publishing changes to a live storefront in Spree Commerce](/docs/images/user/storefront/themes/pdp/12-publish-changes.png)
