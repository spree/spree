...
![Themes dashboard in Spree Commerce](/images/user/storefront/themes/pdp/1-themes-tab.png)

Open your active theme (i.e., the one marked Live).

![The Spree Commerce theme editor](/images/user/storefront/themes/pdp/2-open-theme-editor.png)

In the page selector (top left), choose **Product Details Page**.

![Customize the product details page in Spree](/images/user/storefront/themes/pdp/3-select-pdp.png)

The editor preview and sidebar will update to show all PDP-specific sections and settings.

![Spree Theme editor PDP preview](/images/user/storefront/themes/pdp/4-pdp-preview.png)
...
![Drag and drop PDP elements in Spree](/images/user/storefront/themes/pdp/5-pdp-sidebar.png)

From here, you can customize the PDP in a number of ways:

### Reorder Elements

![Reordering PDP elements via drag and drop in Spree](/images/user/storefront/themes/pdp/6-pdp-reorder.png)
...
![Modifying PDP design settings in Spree](/images/user/storefront/themes/pdp/7-design-settings.png)
...
![Adding page sections to the PDP in Spree](/images/user/storefront/themes/pdp/8-add-sections.png)
...
![Displaying metafields on PDP in Spree Commerce](/images/user/storefront/themes/pdp/9-pdp-metafields.png)
...
![Reordering metafields on the PDP in Spree Commerce](/images/user/storefront/themes/pdp/10-reorder-metafields.png)
...
![Mobile preview of the PDP in Spree Commerce](/images/user/storefront/themes/pdp/11-preview-changes.png)
...
![Publishing changes to a live storefront in Spree Commerce](/images/user/storefront/themes/pdp/12-publish-changes.png)
