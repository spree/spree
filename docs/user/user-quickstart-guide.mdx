...
![](/docs/images/user/quickstart/1-getting-started.png)
...
![](/docs/images/user/quickstart/2-setup-payments.png)
...
![](/docs/images/user/quickstart/3-settings-payments.png)
...
![](/docs/images/user/quickstart/4-add-products.png)
...
![](/docs/images/user/quickstart/5-customer-support-email.png)
...
![](/docs/images/user/quickstart/6-setup-taxes.png)
...
![](/docs/images/user/quickstart/7-shipping-methods.png)
...
![](/docs/images/user/quickstart/8-storefront-setup.png)
...
![](/docs/images/user/quickstart/9-themes.png)
...
![](/docs/images/user/quickstart/10-theme-editor.png)
...
![](/docs/images/user/quickstart/11-connect-domain.png)
...
![](/docs/images/user/quickstart/12-pages.png)
...
![](/docs/images/user/quickstart/13-add-new-page.png)
...
![](/docs/images/user/quickstart/14-posts.png)
...
![](/docs/images/user/quickstart/15-new-post.png)

Simply, fill in your post content, image, and SEO fields, set a Published At date, and click **Create** to finalize your new post.

To learn more about Posts, please refer to our [<u>Posts</u>](https://spreecommerce.org/docs/user/storefront/create-post)

### Storefront Settings

![](/docs/images/user/quickstart/16-storefront-settings.png)
...
![](/docs/images/user/quickstart/17-multi-store.png)
...
![](/docs/images/user/quickstart/18-new-store.png)
...
![](/docs/images/user/quickstart/19-home-screen.png)
...
![](/docs/images/user/quickstart/20-reports.png)
