...
![Getting Started tab showing the onboarding checklist with four key tasks](/images/user/quickstart/1-getting-started.png)
...
![Payment setup onboarding step](/images/user/quickstart/2-setup-payments.png)
...
![Payments section of admin dashboard](/images/user/quickstart/3-settings-payments.png)
...
![Add products Spree onboarding step](/images/user/quickstart/4-add-products.png)
...
![Add a customer support email onboarding step](/images/user/quickstart/5-customer-support-email.png)
...
![Setup tax collection ecommerce onboarding step](/images/user/quickstart/6-setup-taxes.png)
...
![Configure shipping methods Spree onboarding step](/images/user/quickstart/7-shipping-methods.png)
...
![Setup a Spree storefront without code](/images/user/quickstart/8-storefront-setup.png)
...
![Create and manage themes in the admin dashboard](/images/user/quickstart/9-themes.png)
...
![A screenshot of the Spree theme editor](/images/user/quickstart/10-theme-editor.png)
...
![Connecting a domain to Spree commerce](/images/user/quickstart/11-connect-domain.png)
...
![A dashboard tab showing page management UI](/images/user/quickstart/12-pages.png)
...
![Ecommerce dashboard showing a page creation form](/images/user/quickstart/13-add-new-page.png)
...
![Ecommerce dashboard with a blog CMS](/images/user/quickstart/14-posts.png)
...
![A blog post editor in Spree Commerce](/images/user/quickstart/15-new-post.png)
...
![An ecommerce storefront settings menu](/images/user/quickstart/16-storefront-settings.png)
...
![Spree multi-store ecommerce](/images/user/quickstart/17-multi-store.png)
...
![Adding a new store in Spree Commerce](/images/user/quickstart/18-new-store.png)
...
![Spree Commerce dashboard analytics](/images/user/quickstart/19-home-screen.png)
...
![Spree Commerce native reports](/images/user/quickstart/20-reports.png)
