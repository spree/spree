---
title: "Order States"
description: "Understand Spree order states, including payment state and shipment state, to track each stage of the order lifecycle and quickly identify next steps."
---
