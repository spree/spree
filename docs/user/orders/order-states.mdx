---
title: "Order States"
description: "Reference for Spree order status, payment states, and shipment states, plus common state combinations and the next action to take for each."
---
...
Beyond payment and shipment states, every order also has a top-level **status**:

| **Status** | **Description**                                                                 |
| ---------- | ------------------------------------------------------------------------------- |
| Draft      | Cart or in-checkout order that hasn't been placed yet                           |
| Placed     | Order has been completed and is in fulfillment                                  |
| Cancelled  | Order has been cancelled — see [Cancelling Orders](/user/orders/cancelling-orders) |

A placed order can be cancelled as long as no shipment has shipped. See [When you can cancel an order](/user/orders/cancelling-orders#when-you-can-cancel-an-order) for the exact rules.
