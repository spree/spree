...
description: "Manually create a new customer order from the Spree admin panel, including line items, shipping address, and payment, for B2B or customer service workflows."
---
