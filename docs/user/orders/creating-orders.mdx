...
description: "Manually create a new order as an admin in Spree to support phone sales, B2B orders, and customer service by adding a customer, line items, and payment."
---
