...
If the customer changes their mind before the order is placed, open the draft, click the **three-dot menu** and select **Delete**. The draft is removed and you are taken back to the drafts list.

<Note>Delete is only offered while the order is a draft. Once it is placed, the way to stand it down is [<u>Cancelling Orders</u>](https://spreecommerce.org/docs/user/orders/cancelling-orders).</Note>
