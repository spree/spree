...
![How to create orders in Spree Commerce](/images/user/orders/creating-orders/1-creating-orders.png)
...
![Adding a customer to an order in Spree](/images/user/orders/creating-orders/2-customer-form.png)

Once these details are filled in, click **Create** to continue.

## 2. Add Line Items

![Adding line items to an order in Spree Commerce](/images/user/orders/creating-orders/3-add-line-items.png)
...
![Selecting variants for an order in Spree Commerce](/images/user/orders/creating-orders/4-select-line-items.png)
...
![Adding an existing customer to a Spree Commerce order](/images/user/orders/creating-orders/5-existing-customer.png)
...
![Adding a new customer to an order on the fly in Spree Commerce](/images/user/orders/creating-orders/6-new-customer.png)
...
![Adding a shipping method to an order in Spree Commerce](/images/user/orders/creating-orders/7-shipment-section.png)
...
![Manually adding a promotion to an order as an admin in Spree Commerce](/images/user/orders/creating-orders/8-promo-code.png)
...
![Making order adjustments in Spree Commerce](/images/user/orders/creating-orders/9-order-adjustment.png)
...
![Adding a payment to an order in the Spree Commerce dashboard](/images/user/orders/creating-orders/10-add-payment.png)

There are three options for applying payment to the order:

### Create a Manual Payment

![Manually creating a payment for an order in the Spree dashboard](/images/user/orders/creating-orders/11-new-payment.png)
