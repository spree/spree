---
title: "Create orders manually in the Spree admin"
description: "Manually create orders as an admin in Spree Commerce — handle phone orders, B2B sales, customer service exceptions, and other back-office workflows."
---
