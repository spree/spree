...
![How to export orders in the Spree Commerce dashboard](/images/user/orders/export-orders/2-select-records.png)
...
![Selecting order record to export in Spree Commerce](/images/user/orders/export-orders/1-orders-tab.png)
