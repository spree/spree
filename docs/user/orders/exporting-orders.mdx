...
description: "Export Spree orders to a CSV file for sales reporting, financial reconciliation, or sharing order data with other teams using filters or full history."
---
