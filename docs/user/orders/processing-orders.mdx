...
description: "Process orders in the Spree admin dashboard by capturing payment and fulfilling shipments, with options for auto-capture or manual payment workflows."
---
