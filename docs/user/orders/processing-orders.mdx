...
If the order still owes money — a **Partially paid** or **Authorized** payment status — follow one of the options below:
...
The order’s fulfillment status will update to **Fulfilled**, and the customer will receive a confirmation email with tracking details.
...
- **Payment status**: Paid
- **Fulfillment status**: Fulfilled — and **Delivered** once the carrier confirms it arrived
