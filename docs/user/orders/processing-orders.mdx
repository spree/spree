---
title: "Process orders in the Spree admin dashboard"
description: "Process orders in the Spree admin dashboard — capture payment, mark shipments shipped, and complete the fulfillment cycle for a smooth operation."
---
