...
description: "Process orders in the Spree admin dashboard by capturing payments, adding new payments, and fulfilling shipments for both B2C and B2B workflows."
---
