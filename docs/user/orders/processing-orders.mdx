...
![The Spree Commerce orders management dashboard](/images/user/orders/processing-orders/1-orders-tab.png)

From here, simply click on the order you want to process to open the order page.

![An order overview page in Spree Commerce](/images/user/orders/processing-orders/2-order-overview.png)

Here you’ll see a full overview of the order, including payment and shipment details.

## Payment Capture

![Capturing payments in Spree Commerce](/images/user/orders/processing-orders/3-order-payment.png)
...
![Manually capturing payments in Spree Commerce](/images/user/orders/processing-orders/4-capture-payment.png)
...
![Add new payment to an order in Spree Commerce](/images/user/orders/processing-orders/5-new-payment.png)
...
![How to ship an orders in Spree Commerce](/images/user/orders/processing-orders/6-shipments.png)
...
![Adding a tracking number to an order in Spree Commerce](/images/user/orders/processing-orders/7-tracking-number.png)
...
![A completed orders in the Spree Commerce dashboard](/images/user/orders/processing-orders/8-order-complete.png)
