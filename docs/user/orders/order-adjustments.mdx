...
![The Order management tab in Spree Commerce](/images/user/orders/order-adjustments/1-orders-tab.png)

Find the order you'd like to adjust and click on it to open the order page.

![A customer order page in Spree commerce](/images/user/orders/order-adjustments/2-order-page.png)

Scroll to the **Adjustments** section and click **New Adjustment** to open the adjustment creation form.

![Adding an adjustment to an order in Spree Commerce](/images/user/orders/order-adjustments/3-new-adjustment.png)
...
![Refunding a payment in Spree Commerce](/images/user/orders/order-adjustments/4-refund.png)

This will open a refund form where you can enter the amount to be refunded.

![The Spree Commerce refund form](/images/user/orders/order-adjustments/5-refund-form.png)
...
![Adding a new payment to an order in Spree Commerce](/images/user/orders/order-adjustments/6-new-payment.png)
...
![The Spree Commerce payment form](/images/user/orders/order-adjustments/7-payment-form.png)
...
![Closing an order adjustment in Spree Commerce](/images/user/orders/order-adjustments/8-close-adjustment.png)
