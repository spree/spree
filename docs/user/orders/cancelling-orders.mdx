...
![Spree Commerce Orders tab showing order states](/images/user/orders/cancelling-orders/1-cancelling-orders.png)

Find and click on the order you want to cancel to open its detail page.

![An order details page in the Spree Commerce admin dashboard](/images/user/orders/cancelling-orders/2-order-details.png)

In the top-right corner, click the **three-dot menu**, then select **Cancel Order** from the dropdown.

![Cancelling an orer in the Spree Commerce admin dashboard](/images/user/orders/cancelling-orders/3-cancel-order.png)
