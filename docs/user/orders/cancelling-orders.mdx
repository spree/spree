...
description: "Cancel an order in the Spree admin dashboard to handle customer requests, fraud, or inventory issues, with the order status updated automatically."
---
