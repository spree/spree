...
description: "Cancel customer orders directly from the Spree admin dashboard to handle refunds, fraud flags, or inventory and payment issues in a few clicks."
---
