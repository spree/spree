...
description: "Cancel orders from the Spree admin dashboard to handle customer requests, flag fraud, or resolve inventory and payment issues in a few steps."
---
