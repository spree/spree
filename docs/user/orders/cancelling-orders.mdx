---
title: "Cancel orders in the Spree admin dashboard"
description: "Cancel orders in the Spree admin dashboard — handle customer requests, flag fraudulent transactions, and resolve inventory or payment issues."
---
