---
title: "Edit existing orders in Spree Commerce"
description: "Edit existing orders in the Spree admin dashboard — add items, correct addresses, upgrade shipping, and adjust payments to support customer service."
---
