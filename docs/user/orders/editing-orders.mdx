...
description: "Update line items, shipping addresses, and order totals on existing orders in the Spree admin to handle customer support and post-purchase changes."
---
