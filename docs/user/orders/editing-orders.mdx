---
title: "Edit an existing order"
description: "Edit orders in the Spree admin to add line items, change quantities, update addresses, adjust shipping, or modify payments after checkout."
---
