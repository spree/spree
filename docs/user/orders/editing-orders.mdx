...
description: "Edit existing orders in the Spree admin to add items, update addresses, change shipping, or adjust payments for customer support and B2B workflows."
---
