...
description: "Edit an existing order in the Spree admin to add line items, update shipping or billing addresses, apply discounts, and adjust payments for support cases."
---
