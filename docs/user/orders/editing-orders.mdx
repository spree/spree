...
![How to edit orders in Spree Commerce](/images/user/orders/editing-orders/1-orders-tab.png)

Click the order you’d like to modify to open the order details page.

![Editing on via the order details page in Spree Commerce](/images/user/orders/editing-orders/2-order-details-page.png)

You can edit most aspects of an order (except the order number). Below are the key areas you can modify.

## Add Line Items

![Adding line items to an order in the Spree dashboard](/images/user/orders/editing-orders/3-add-items.png)
...
![Adjusting order line item quantities in Spree Commerce](/images/user/orders/editing-orders/4-adjust-quantity.png)
...
![Removing line items from an order in the Spree dashboard](/images/user/orders/editing-orders/5-remove-items.png)
...
![Changing the shipping address of an order in Spree Commerce](/images/user/orders/editing-orders/6-change-addresses.png)
...
![Changing the fulfillment location of an order in the Spree dashboard](/images/user/orders/editing-orders/7-fulfillment-location.png)
...
![Changing the shipping method of an order in the Spree dashboard](/images/user/orders/editing-orders/8-shipping-method.png)
...
![Adding orders adjustments in Spree Commerce](/images/user/orders/editing-orders/9-adjustments.png)
...
![Adding a payments to an existing order in Spree Commerce](/images/user/orders/editing-orders/10-add-payments.png)
