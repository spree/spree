---
title: "Refund orders in the Spree admin dashboard"
description: "Refund orders in the Spree admin dashboard — partial and full refunds, refund reasons, and how refunds interact with payments, taxes, and store credits."
---
