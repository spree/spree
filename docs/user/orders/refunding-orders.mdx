...
description: "Issue a full or partial refund on an order in the Spree admin dashboard from the Payments section to handle returns, complaints, or billing corrections."
---
