...
![](/images/user/returns/returns-processing/1.order_page.png)
...
![](/images/user/returns/returns-processing/2.new_return_auth.png)

This will open the Return Authorization form.

![](/images/user/returns/returns-processing/3.ra_form.png)
...
![](/images/user/returns/returns-processing/4.ra_section.png)

The RA will also now be listed in the **Returns → Return Authorizations** tab.

![](/images/user/returns/returns-processing/5.ra_tab.png)
...
![](/images/user/returns/returns-processing/6.new_customer_return.png)

This will open the Customer Return form. 

![](/images/user/returns/returns-processing/7.cr_form.png)
...
![](/images/user/returns/returns-processing/8.cr_section.png)

The return will also now be visible in the Returns tab and can be edited from either location.

![](/images/user/returns/returns-processing/9.returns_tab.png)
...
![](/images/user/returns/returns-processing/10.new_reimbursement.png)

This will create the reimbursement immediately and redirect you to the reimbursement form.

![](/images/user/returns/returns-processing/11.reimbursement_form.png)
...
![](/images/user/returns/returns-processing/12.customer_reimbursed.png)
...
![](/images/user/returns/returns-processing/13.updated_cr_form.png)
