...
description: "Process returns in Spree Commerce by creating return authorizations, accepting customer returns, restocking items, and issuing refunds or exchanges."
---
