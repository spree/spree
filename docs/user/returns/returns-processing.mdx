---
title: "Process returns and refunds in the Spree admin"
description: "Process returns in the Spree admin dashboard — authorize returns, restock inventory, issue refunds or exchanges, and track reimbursement workflows."
---
