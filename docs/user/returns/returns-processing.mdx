...
description: "Process returns in the Spree admin by creating a Return Authorization, accepting the customer return, and issuing reimbursement, refund, or restock actions."
---
