...
description: "Handle Spree returns end to end by creating return authorizations, recording customer returns, and issuing refunds or exchanges with restocking options."
---
