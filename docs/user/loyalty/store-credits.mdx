...
## See Every Customer's Credit in One Place

Issuing and editing a credit happens on the customer profile, but to see what
your store owes in total, go to **Loyalty → Store Credits**. See
[Store Credits List](/user/loyalty/store-credits-list) for how to read and
filter it.
