...
To get started, navigate to **Loyalty → Gift Cards** in the admin dashboard.

![](/docs/images/user/promotions/gift-cards/1-gift-cards.png)

Click **New Gift Card** in the top right corner.

![How to create gift cards in Spree Commerce](/docs/images/user/promotions/gift-cards/2-add-gift-cards.png)
...
![Creating a single gift card in Spree Commerce](/docs/images/user/promotions/gift-cards/3-gift-form.png)
...
![Creating a batch of gift cards in the Spree Commerce dashboard](/docs/images/user/promotions/gift-cards/4-gift-card-batch.png)
...
![How to manage gift cards in the Spree Commerce dashboard](/docs/images/user/promotions/gift-cards/5-manage-gift-cards.png)

Once created, gift cards appear in the main table view under **Loyalty → Gift Cards**.
...
![How to edit a gift card in the Spree Commerce dashboard](/docs/images/user/promotions/gift-cards/6-edit-gift-cards.png)
...
![How to delete a gift card in the Spree Commerce dashboard](/docs/images/user/promotions/gift-cards/7-delete-gift-card.png)
