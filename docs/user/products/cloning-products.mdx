...
description: "Duplicate an existing Spree product from the admin editor to quickly create color variants, seasonal versions, or new SKUs with the same structure."
---
