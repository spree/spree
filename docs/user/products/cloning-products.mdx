---
title: "Clone a product in the Spree admin"
description: "Clone an existing product in Spree to quickly create similar items — useful for color variants, seasonal versions, and products that share structure."
---
