---
title: "Create a new product in Spree Commerce"
description: "Create a new product from scratch in the Spree admin dashboard — basics, variants, pricing, media, taxonomies, and storefront visibility settings."
---
