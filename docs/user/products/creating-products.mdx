...
description: "Step-by-step guide to creating a product in the Spree admin, including media, pricing, variants, inventory, shipping, and digital downloads."
---
...
Product Custom Fields let you add custom data fields to a product beyond Spree's built-in fields — useful for technical specs, care instructions, supplier notes, or anything else specific to your catalog. For example, a clothing product might have a **Material** custom field set to "100% Organic Cotton," or an electronics product might have a **Voltage** custom field set to "110–240V."

See [<u>Product Custom Fields</u>](/user/manage-products/product-metafields) to learn how to create custom field definitions and add values to your products.
...
If you assign the **Digital** shipping category to a product, no physical fulfilment is required — but you'll also need to upload the file customers will receive after purchase.

Digital assets can be any downloadable file, most commonly:

- **PDFs** — ebooks, guides, certificates
...
Once purchased, customers can access their digital files from the order confirmation page, a link in their confirmation email, or their **My Account** dashboard.

To upload a digital asset:

1. In the product editor, click the *three-dot** menu in the top-right corner.
2. Select **Digital Assets** to open the digital assets management screen.
3. Click **New Digital Asset** to open the upload form.
4. Upload the file. If the product has multiple variants, also select which variant the asset should attach to.
...
For more on selling digital products, see the [Digital Products](/developer/how-to/sell-digital-products) guide.
