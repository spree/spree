...
![](/images/user/products/create-a-product/1.products_tab.png)

Click **New Product** in the top right corner to open the product creation form.

![](/images/user/products/create-a-product/2.new_product.png)

## Name & Description

![](/images/user/products/create-a-product/3.name_description.png)
...
![](/images/user/products/create-a-product/4.media.png)

This is where you can add visual media to your product. Click **Upload New Asset** to open the file importer.

![](/images/user/products/create-a-product/5.upload_image.png)
...
![](/images/user/products/create-a-product/6.rearrange_images.png)

To edit an image’s alt text, replace it, or delete it entirely, click on the image to open the edit form.

![](/images/user/products/create-a-product/7.edit_image.png)
...
![](/images/user/products/create-a-product/8.status.png)
...
![](/images/user/products/create-a-product/9.categorization.png)
...
- **Taxonomies:** Assign categories, collections, or brands (e.g., Fashion → Women → Tops). Products will appear anywhere the taxon is used on the site.
  ...
  ![](/images/user/products/create-a-product/10.taxons.png)
- **Tags:** Use custom tags like Vegan, Eco-Friendly, or Summer Collection for filtering, related products, or smart merchandising logic.
  ...
  ![](/images/user/products/create-a-product/11.tags.png)
...
![](/images/user/products/create-a-product/12.pricing.png)
...
![](/images/user/products/create-a-product/13.compare_at.png)

If your store supports multiple currencies, you’ll see additional rows here to define localized pricing.

![](/images/user/products/create-a-product/14.multi_currency.png)
...
![](/images/user/products/create-a-product/15.inventory.png)
...
![](/images/user/products/create-a-product/16.variants.png)
...
![](/images/user/products/create-a-product/17.add_options.png)
...
![](/images/user/products/create-a-product/18.merged_ui.png)
...
![](/images/user/products/create-a-product/19.shipping.png)
...
![](/images/user/products/create-a-product/20.properties.png)
...
![](/images/user/products/create-a-product/21.tax.png)
...
![](/images/user/products/create-a-product/22.seo.png)
