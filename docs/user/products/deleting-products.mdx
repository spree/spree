...
description: "Permanently delete a product from your Spree Commerce store, or archive products linked to existing orders to remove them from the storefront."
---
