...
description: "Permanently delete unused products from the Spree admin, or archive products tied to existing orders to hide them from the storefront safely."
---
