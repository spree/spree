...
description: "Export your Spree customer list to CSV for reporting, segmentation, or syncing with CRM and email marketing tools, with optional filter support."
---
