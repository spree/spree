---
title: "Export customer records to CSV in Spree"
description: "Export customer records from Spree to CSV — for reporting, segmentation, audits, and syncing with CRM, email marketing, and analytics platforms."
---
