...
![How to export customers in Spree Commerce](/images/user/customers/exporting-customers/1-customers-tab.png)
...
![Exporting vustomers in the Spree Commerce dashboard](/images/user/customers/exporting-customers/2-export-customers.png)
