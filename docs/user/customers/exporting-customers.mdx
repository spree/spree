...
description: "Export customer records to CSV from the Spree admin, applying filters by tags, location, or marketing opt-in to build targeted lists for CRM and email tools."
---
