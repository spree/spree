...
description: "Export customer records from Spree to CSV for reporting, segmentation, or syncing with CRM and email marketing tools, with optional filters applied."
---
