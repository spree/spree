...
description: "Export customer records from the Spree admin to a CSV file for reporting, segmentation, email marketing campaigns, or syncing with a CRM system."
---
