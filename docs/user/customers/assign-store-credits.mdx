...
![How to issue store credits in Spree Commerce](/images/user/customers/store-credits/1-customers-tab.png)

Find and click on the customer to open their profile page.

![Finding a customer to assign store credits to in the Spree dashboard](/images/user/customers/store-credits/2-customer-profile.png)
...
![Adding store credits to a customer account in Spree Commerce](/images/user/customers/store-credits/3-add-credits.png)

Clicking on either of these will redirect you to the store credit creation form.

## Configure the Store Credit

![Configure a store credit assignment in the Spree Commerce dashboard](/images/user/customers/store-credits/4-credit-form.png)
...
![Editing a store credit assignment in the Spree Commerce dashboard](/images/user/customers/store-credits/5-edit-store-credit.png)
...
![Deleting a store credit assignment in the Spree Commerce dashboard](/images/user/customers/store-credits/6-delete-store-credit.png)
