...
description: "Add store credits to a customer's Spree account for refunds, loyalty rewards, or B2B prepaid balances using the admin dashboard customer profile."
---
