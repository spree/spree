...
description: "Issue store credits from a customer profile in the Spree admin to handle refunds, loyalty rewards, or B2B prepaid balances and credit thresholds."
---
