...
description: "Issue a gift card to a customer in the Spree admin dashboard, setting code, amount, currency, and expiration to reward loyalty or resolve support cases."
---
