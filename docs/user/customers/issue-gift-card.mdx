...
description: "Create and email a gift card to a customer from the Spree admin to use for promotions, loyalty rewards, or customer service goodwill gestures."
---
