...
![How to issue a gift card to a customer in Spree Commerce](/images/user/customers/gift-cards/1-customers-tab.png)

Find and click the customer who should receive the gift card to open their customer profile.

![Customer profile page in the Spree admin backend](/images/user/customers/gift-cards/2-customer-profile.png)

Click the **three-dot menu** in the top right corner, and select **Add a Gift Card**.

![Issuing a gift card to a customer in Spree Commerce](/images/user/customers/gift-cards/3-add-gift-card.png)

You’ll be redirected to the gift card creation form.

## Configure the Gift Card

![Configuring a gift card in Spree Commerce](/images/user/customers/gift-cards/4-gift-card-form.png)
...
![Editing a gift card in the Spree Commerce admin dashboard](/images/user/customers/gift-cards/5-edit-gift-card.png)
...
![Deleting a gift card in Spree Commerce](/images/user/customers/gift-cards/6-delete-gift-card.png)
