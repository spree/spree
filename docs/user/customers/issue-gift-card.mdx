---
title: "Issue gift cards to customers in Spree"
description: "Issue gift cards to customers in the Spree admin dashboard — set balances, attach to customers, and use for promotions, loyalty, or service recovery."
---
