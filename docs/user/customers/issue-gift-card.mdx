...
description: "Issue a single-use gift card to a customer in the Spree admin with a custom or auto-generated code, set amount, expiration, and email delivery."
---
