...
![Understanding the customer profile page in Spree commerce](/images/user/customers/customer-profiles/1-customers-tab.png)
...
![A customer's profile in the Spree Commerce dashboard](/images/user/customers/customer-profiles/2-customer-profile.png)

The profile page is divided into several sections, each providing important information about the customer.

## User Analytics

![Customer profile analytics in Spree Commerce](/images/user/customers/customer-profiles/3-user-analytics.png)
...
![A customer's personal details in the Spree Commerce dashboard](/images/user/customers/customer-profiles/4-user-details.png)
...
![A customer's shipping address in the Spree dashboard](/images/user/customers/customer-profiles/5-shipping-address.png)
...
![A customer's billing address in the Spree dashboard](/images/user/customers/customer-profiles/6-billing-address.png)

Displays the billing address or indicates **“Same as shipping address”** if that option is selected.

## Internal Note

![An internal customer note in the Spree Commerce](/images/user/customers/customer-profiles/7-internal-note.png)
...
![The last order placed by a customer in Spree Commerce](/images/user/customers/customer-profiles/8-last-order-placed.png)
...
![Orders subsection of the customer proflile in the Spree dashboard](/images/user/customers/customer-profiles/9-customer-orders.png)
...
![Draft orders associated with a customer in Spree Commerce](/images/user/customers/customer-profiles/10-draft-orders.png)
...
![Gift cards issued to a customer in Spree Commerce](/images/user/customers/customer-profiles/11-gift-cards.png)
...
![Store credits assigned to a customer in Spree Commerce](/images/user/customers/customer-profiles/12-store-credits.png)
