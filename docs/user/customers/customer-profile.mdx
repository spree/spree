...
description: "Access and review customer profiles in the Spree admin to see order history, account details, and purchasing behavior for personalized support."
---
