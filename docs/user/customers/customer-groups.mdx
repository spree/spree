...
![The Customer Groups tab in Spree Commerce](/images/user/customers/customer-groups/1-customer-groups.png)
...
![Adding a new customer group in Spree Commerce](/images/user/customers/customer-groups/2-customer-group-form.png)
...
![Customer group overview in Spree Commerce](/images/user/customers/customer-groups/3-customer-group-edit.png)
...
![Adding customers to a customer group in Spree Commerce](/images/user/customers/customer-groups/4-add-customers.png)

Check the boxes next to the customers you want to add, then click **Add Selected**.

![An active customer group in Spree Commerce](/images/user/customers/customer-groups/5-customers-added.png)
