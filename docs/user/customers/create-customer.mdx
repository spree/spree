...
description: "Manually add a new customer record from the Spree admin dashboard for phone orders, in-person sales, wholesale accounts, or platform migrations."
---
