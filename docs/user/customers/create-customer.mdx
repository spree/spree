...
description: "Manually create customer accounts in the Spree admin for phone orders, wholesale clients, or data migration to track orders and personalize service."
---
