...
description: "Manually create a new customer in the Spree admin dashboard to support phone orders, B2B accounts, or data migrations, then add shipping and billing addresses."
---
