...
![The Customers tab in the Spree Commerce dashboard](/images/user/customers/create-customer/1-customers-tab.png)

Click **New Customer** in the top-right corner to open the creation form.

![Creating a customer in the Spree Commerce dashboard](/images/user/customers/create-customer/2-creation-form.png)
...
![Customer profile in the Spree Commerce dashboard](/images/user/customers/create-customer/3-customer-profile.png)
...
![Adding a shipping address to a customer in Spree Commerce](/images/user/customers/create-customer/4-shipping-address.png)
...
![Customer address map preciew in Spree Commerce](/images/user/customers/create-customer/5-address-preview.png)
