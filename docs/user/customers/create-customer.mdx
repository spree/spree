---
title: "Create a customer account from the Spree admin"
description: "Manually create customer accounts from the Spree admin dashboard — useful for phone orders, wholesale clients, and migrations from other platforms."
---
