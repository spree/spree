...
description: "Find Spree customers fast with admin search by name or email, plus sortable columns and filters for tags, location, marketing opt-in, and dates."
---
