...
description: "Search, sort, and filter customer records in the Spree admin dashboard by email, name, tags, location, or marketing opt-in using the updated table view."
---
