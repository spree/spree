...
![How to search for customers in Spree Commerce](/images/user/customers/searching-customers/1-customers-tab.png)

At the top of the page, you’ll find the search bar along with sorting, column, and filter controls.

## Search Bar

![Using the search bar to find customers in Spree Commerce](/images/user/customers/searching-customers/2-search-bar.png)
...
![Sorting the customer table in Spree Commerce](/images/user/customers/searching-customers/3-sort-by.png)
...
![Configuring columns on the customer table in Spree Commerce](/images/user/customers/searching-customers/4-select-columns.png)
...
![Applying filters to the customer table in the Spree admin dashboard](/images/user/customers/searching-customers/5-filters.png)
