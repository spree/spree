---
title: "Search and filter customers in the Spree admin"
description: "Search and filter customer records in the Spree admin dashboard — use the updated table view to find buyers, manage support, and review accounts."
---
