...
![Spree Commerce metafields](/images/user/settings/metafields/1-settings-metafields.png)
...
![Creating metafields in Spree](/images/user/settings/metafields/2-create-a-metafield.png)
...
![Add a metafield definition in Spree](/images/user/settings/metafields/3-metafield-resource.png)
...
![Spree Commerce metafield resources](/images/user/settings/metafields/4-metafield-type.png)
...
![Spree Commerce metafield data types](/images/user/settings/metafields/5-add-metafield-value.png)

Click the **three-dot menu** in the top right corner and select **Metafields** from the dropdown.

![Adding metafields values in Spree](/images/user/settings/metafields/6-select-metafields.png)

Enter the desired values in the form and click **Save** to finalized your changes.

![Product metafields in Spree](/images/user/settings/metafields/7-enter-metafield-values.png)
