...
description: "Define metafields in Spree to attach custom data to products, orders, and other objects without writing code or modifying the database from the admin dashboard."
---
