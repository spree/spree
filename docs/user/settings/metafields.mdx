...
You can also update your existing catalogby exporting the product file, updating it as described above, and then reimporting it to apply metafield updates
