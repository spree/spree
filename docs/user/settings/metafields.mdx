...
description: "Create and manage metafield definitions in Spree to attach custom data to products, orders, and other store objects without writing code or database changes."
---
