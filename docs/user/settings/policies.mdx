...
![Spree Commerce policies tab](/images/user/settings/policies/1-policies-tab.png)

Click **New Policy** in the top-right corner to open the policy creation form.

![Creating a new store policy in Spree Commerce](/images/user/settings/policies/2-policy-form.png)
...
![Published store policy on Spree storefront](/images/user/settings/policies/3-policy-published.png)
