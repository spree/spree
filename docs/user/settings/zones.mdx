...
![](/docs/images/user/settings/zones/1.zones.png)
...
![](/docs/images/user/settings/zones/2.add_a_zone.png)

Here you’ll see two sections that allow you to define the new zone:

### General Settings

![](/docs/images/user/settings/zones/3.general_settings.png)
...
![](/docs/images/user/settings/zones/4.country_based.png)
...
![](/docs/images/user/settings/zones/5.state_based.png)
...
![](/docs/images/user/settings/zones/6.edit_zone.png)
