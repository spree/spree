...
![](/docs/images/user/settings/returns-configuration/1.returns.png)
...
![](/docs/images/user/settings/returns-configuration/2.return_authorizations.png)
...
![](/docs/images/user/settings/returns-configuration/3.new_rma.png)
...
![](/docs/images/user/settings/returns-configuration/4.edit_rma.png)
...
![](/docs/images/user/settings/returns-configuration/5.refund_reasons.png)
...
![](/docs/images/user/settings/returns-configuration/6.new_refund_reason.png)
...
![](/docs/images/user/settings/returns-configuration/7.edit_refund_reason.png)
...
![](/docs/images/user/settings/returns-configuration/8.reimbursement_types.png)
...
![](/docs/images/user/settings/returns-configuration/9.new_reimbursement.png)
...
![](/docs/images/user/settings/returns-configuration/10.edit_reimbursement.png)
