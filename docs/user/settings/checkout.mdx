...
description: "Configure Spree checkout settings from the dashboard: add a checkout sidebar message, format it with the editor, and enable or disable guest checkout."
---
