---
title: "Checkout"
description: "Configure Spree checkout settings from the admin to add a custom checkout sidebar message and enable or disable guest checkout for your store."
---
