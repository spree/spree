...
<img src="/docs/images/user/settings/checkout/1.checkout.png" />

Here you’ll see two sections that allow you to modify certain aspects of the checkout:

## Checkout Message

<img src="/docs/images/user/settings/checkout/2.checkout_message.png" />
...
<img src="/docs/images/user/settings/checkout/3.storefront_checkout.png" />

## Guest Checkout

<img src="/docs/images/user/settings/checkout/4.guest_checkout.png" />
