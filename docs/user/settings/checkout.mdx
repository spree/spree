---
title: "Configure checkout settings in the Spree admin"
description: "Configure Spree checkout settings from the admin dashboard — add a checkout message and enable or disable guest checkout to fit your store policy."
---
