...
![](/docs/images/user/settings/users/3.invite_user.png)
...
![](/docs/images/user/settings/users/4.user_signup.png)
...
![](/docs/images/user/settings/users/7.edit_user.png)

Click Edit in the details section to reveal the edit form.

![](/docs/images/user/settings/users/8.edit_form.png)
...
![](/docs/images/user/settings/users/5.invitations.png)
...
![](/docs/images/user/settings/users/6.roles.png)
