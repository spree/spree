---
title: "Users"
description: "Invite admin users to your Spree store, manage active users, track pending invitations, assign user roles, and control backend access for team collaboration."
---
