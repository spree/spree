---
title: "Invite and manage admin users in Spree"
description: "Invite and manage admin users in the Spree admin dashboard — assign roles, track invitations, and remove access to keep your team secure and current."
---
