---
title: "Admin Users"
description: "Invite and manage admin users in Spree. Track active users and invitations, control dashboard access, and define roles to keep your store backend secure."
---
