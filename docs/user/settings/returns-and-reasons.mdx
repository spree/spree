...
description: "Define the return, claim, and refund reasons your team chooses from when handling returns."
---
...
To learn how, see [Returns → Returns Processing](/user/orders/returns).
