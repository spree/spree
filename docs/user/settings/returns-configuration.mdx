...
description: "Configure return authorization reasons, refund reasons, and reimbursement types in Spree to standardize how your store handles customer returns."
---
