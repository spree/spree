...
![Shipping section of the Spree dashboard](/images/user/settings/shipping/1-shipping-methods.png)
...
![Adding a new shipping method in Spree](/images/user/settings/shipping/2-new-shipping-method.png)

This page is divided into seven distinct sections, so let’s take a look at each individually:

### Presentation

![Spree shipping methods presentation settings](/images/user/settings/shipping/3-shipping-method-presentation.png)
...
![Spree shipping method tracking url](/images/user/settings/shipping/4-tracking-url.png)
...
![Set shipping zones in Spree Commerce](/images/user/settings/shipping/5-shipping-method-zones.png)
...
![Choose shipping categories in Spree Commerce](/images/user/settings/shipping/6-shipping-categories.png)
...
![Set a shipping method tax category in Spree](/images/user/settings/shipping/7-tax-category.png)
...
![Choosing a shipping calculator in Spree](/images/user/settings/shipping/8-shipping-calculator.png)
...
![Set shipping method estimated transits days in Spree](/images/user/settings/shipping/9-estimated-delivery.png)
