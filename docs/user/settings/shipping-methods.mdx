...
![](/docs/images/user/settings/shipping/10.10.1.1Shipping-NavigateToTab.png)
...
![](/docs/images/user/settings/shipping/10.10.1.2Shipping-AddANewShippingMethod.png)

This page is divided into seven sections, so let’s take a look at each individually.

### Presentation

![](/docs/images/user/settings/shipping/10.10.1.3Shipping-Presentation.png)
...
![](/docs/images/user/settings/shipping/10.10.1.4Shipping-TrackingURL.png)
...
![](/docs/images/user/settings/shipping/10.10.1.5Shipping-Zones.png)
...
![](/docs/images/user/settings/shipping/10.10.1.6Shipping-ShippingCategories.png)
...
![](/docs/images/user/settings/shipping/10.10.1.7Shipping-TaxCategory.png)
...
![](/docs/images/user/settings/shipping/10.10.1.8Shipping-Calculator.png)
...
![](/docs/images/user/settings/shipping/10.10.1.9Shipping-EstimatedTransit.png)
...
![](/docs/images/user/settings/shipping/10.10.1.10Shipping-MethodCreated.png)