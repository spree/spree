...
![](/docs/images/user/settings/payments/1.payments.png)

## Payment Methods Overview

![](/docs/images/user/settings/payments/2.payments_overview.png)

Here you can see a list of enabled payment methods, and a list of available payment methods:

### Enabled Payment Methods

![](/docs/images/user/settings/payments/4.enabled_payment_methods.png)
...
![](/docs/images/user/settings/payments/3.payments_display.png)

### Available Payment Methods

![](/docs/images/user/settings/payments/5.available_payment_methods.png)
...
![](/docs/images/user/settings/payments/6.add_payment_method.png)
...
![](/docs/images/user/settings/payments/7.payment_provider_settings.png)
...
![](/docs/images/user/settings/payments/8.display_settings.png)
...
![](/docs/images/user/settings/payments/9.edit_payment_method.png)
