---
title: "Payments"
description: "View, enable, add, edit, and remove payment methods in Spree, manage visibility and active status, and configure third-party payment gateways from the admin."
---
