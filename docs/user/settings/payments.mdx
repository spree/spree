---
title: "Configure payment methods in the Spree admin"
description: "View, add, edit, and remove payment methods in the Spree admin dashboard — built-in gateways and third-party integrations for accepting payments."
---
