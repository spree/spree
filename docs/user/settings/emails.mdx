---
title: "Configure store email settings in Spree"
description: "Configure how your Spree store communicates with customers via email — sender addresses, reply-to settings, and transactional email customization."
---
