...
description: "Configure Spree store email settings: upload a logo for automated emails, set sender and support addresses, and ensure messages reach customers reliably."
---
