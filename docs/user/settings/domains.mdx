---
title: "Connect a custom domain to your Spree store"
description: "Connect a custom domain to your Spree store — branded URLs that build trust, strengthen brand identity, and replace temporary or technical addresses."
---
...
<Note>Custom domain support requires the `spree-multi-store` package. See the [<u>Multi-Store Quickstart</u>](https://spreecommerce.org/docs/developer/multi-store/quickstart) for setup instructions.</Note>
