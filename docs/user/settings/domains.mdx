---
title: "Domains"
description: "Connect a custom domain to your Spree storefront through the admin Domains tab using the semi-automated Entri verification flow for multi-store."
---
