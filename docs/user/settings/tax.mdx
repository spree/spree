...
![](/docs/images/user/settings/tax/1.tax.png)

You’ll notice two separate subtabs here for managing Tax Rates and Tax Categories.

![](/docs/images/user/settings/tax/2.tax_subtabs.png)

Let’s take a look at each in more detail:

## Tax Rates

![](/docs/images/user/settings/tax/3.tax_rates.png)
...
![](/docs/images/user/settings/tax/4.add_new_rate.png)
...
![](/docs/images/user/settings/tax/5.edit_tax_rate.png)
...
![](/docs/images/user/settings/tax/6.tax_categories.png)
...
![](/docs/images/user/settings/tax/7.new_tax_category.png)
...
![](/docs/images/user/settings/tax/8.edit_tax_category.png)
