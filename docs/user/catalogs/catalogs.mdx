...
**Delete** ends the agreement for good. It removes the catalog, its audience assignments, and its price list together with the prices in it. Your products stay in the store, and orders already placed are untouched.

<Warning>
Deleting cannot be undone, and the prices typed onto the catalog's price list cannot be recovered. If you only want the agreement to stop applying, deactivate it instead.
</Warning>
