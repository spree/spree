...
![](/docs/images/user/vendors/4.2.1VendorOnboarding-EmailInvite.png)
...
![](/docs/images/user/vendors/vendor_onboarding_signup.png)
...
![](/docs/images/user/vendors/vendor_onboarding_tasks.png)
...
![](/docs/images/user/vendors/4.2.5VendorOnboarding-ConnectShop.png)
...
![](/docs/images/user/vendors/4.2.6VendorOnboarding-InstallApp.png)

Click 'Install' again to install the app, and you'll be redirected to the setup screen.

![](/docs/images/user/vendors/4.2.7VendorOnboarding-SetupScreen.png)

Simply click 'Start Setup' and your store will start synchronizing with the marketplace.

![](/docs/images/user/vendors/4.2.8VendorOnboarding-Synchronization.png)
...
![](/docs/images/user/vendors/4.2.9VendorOnboarding-StoreConnected.png)
...
![](/docs/images/user/vendors/4.2.10VendorOnboarding-WooCommercePopup.png)
...
![](/docs/images/user/vendors/4.2.11VendorOnboarding-ApproveAccess.png)

Click 'Approve' and you'll be redirected to the vendor dashboard and the task will be marked as complete.

![](/docs/images/user/vendors/4.2.12VendorOnboarding-WooCommerceConnected.png)
...
![](/docs/images/user/vendors/4.2.14VendorOnboarding-StoreCreated.png)
...
![](/docs/images/user/vendors/vendor_onboarding_products.png)
...
![](/docs/images/user/vendors/4.2.16VendorOnboarding-AddBillingAddress.png)

Fill in all the required fields, click 'Save', and the task will be marked as completed.

![](/docs/images/user/vendors/4.2.17VendorOnboarding-BillingAddressAdded.png)
...
![](/docs/images/user/vendors/4.2.18VendorOnboarding-ConnectStripeAccount.png)
...
![](/docs/images/user/vendors/4.2.19VendorOnboarding-StripeOnboardingComplete.png)
...
![](/docs/images/user/vendors/4.2.20VendorOnboarding-CompleteStripeOnboarding.png)
...
![](/docs/images/user/vendors/4.2.21VendorOnboarding-ReturnAddress.png)

Fill in all the required fields, click 'Save', and the task will be marked as completed.

![](/docs/images/user/vendors/4.2.22VendorOnboarding-ReturnAddressAdded.png)
...
![](/docs/images/user/vendors/4.2.23VendorOnboarding-SetShippingRates.png)
...
![](/docs/images/user/vendors/vendor_onboarding_shipping.png)
...
![](/docs/images/user/vendors/4.2.25VendorOnboarding-ShippingRatesConfirmed.png)
...
![](/docs/images/user/vendors/4.2.26VendorOnboarding-ReturnsPolicy.png)

Copy and paste your returns policy into the field, click 'Save' and the task will be completed.

![](/docs/images/user/vendors/4.2.27VendorOnboarding-ReturnsPolicyAdded.png)
