...
<Warning>Vendor onboarding is a feature available only in Spree Enterprise Edition.</Warning>

<Note>This guide is intended for vendors, but may also be useful for marketplace owners should they wish to understand the onboarding process more clearly.</Note>
...
<img src="/docs/images/user/vendors/4.2.1VendorOnboarding-EmailInvite.png" />
...
<Note>The above screenshot is the default email template. The actual email and content may be quite different.</Note>

## Create an Account

<img src="/docs/images/user/vendors/4.2.2VendorOnboarding-AccountCreation.png" />

Next, you'll need to set up a vendor account with the marketplace. The name and email fields should already be filled, so all you'll need to do is enter a password.

If you'd like to review the commercial terms, click on 'View your commercial terms' to reveal them.

<img src="/docs/images/user/vendors/4.2.3VendorOnboarding-CommercialTerms.png" />

<Note>The above screenshots show the default sign up page. The design, content, and commercial terms may differ.</Note>

Once you've entered a password and reviewed the commercial terms, click 'Create Account' to continue.

## Vendor Dashboard

Once you've created your account, you'll be redirected to your vendor dashboard.

<img src="/docs/images/user/vendors/4.2.4VendorOnboarding-VendorDashboard.png" />
...
<Note>There are six tasks by default, but the marketplace you're joining may have more or less depending on its business model.</Note>

### Connect or Create a Shop

<img src="/docs/images/user/vendors/4.2.5VendorOnboarding-ConnectShop.png" />
...
<Note>Custom integrations can be developed to sync products and inventory if the vendor's store is not running on any of the available platforms. Please reach out to us if you require integration support.</Note>
...
<img src="/docs/images/user/vendors/4.2.6VendorOnboarding-InstallApp.png" />

Click 'Install' again to install the app, and you'll be redirected to the setup screen.

<img src="/docs/images/user/vendors/4.2.7VendorOnboarding-SetupScreen.png" />

Simply click 'Start Setup' and your store will start synchronizing with the marketplace.

<img src="/docs/images/user/vendors/4.2.8VendorOnboarding-Synchronization.png" />
...
<Note>Once the app is set up, it's essentially business as usual for Shopify stores - no need to use the Spree vendor dashboard other than for completing the rest of the onboarding steps and accessing payout information or invoices on occasion.</Note>

Navigating back to the vendor dashboard, you'll see that this task is now marked as completed.

<img src="/docs/images/user/vendors/4.2.9VendorOnboarding-StoreConnected.png" />
...
<img src="/docs/images/user/vendors/4.2.10VendorOnboarding-WooCommercePopup.png" />
...
<img src="/docs/images/user/vendors/4.2.11VendorOnboarding-ApproveAccess.png" />

Click 'Approve' and you'll be redirected to the vendor dashboard and the task will be marked as complete.

<img src="/docs/images/user/vendors/4.2.12VendorOnboarding-WooCommerceConnected.png" />
...
<img src="/docs/images/user/vendors/4.2.14VendorOnboarding-StoreCreated.png" />
...
<img src="/docs/images/user/vendors/4.2.15VendorOnboarding-Addproducts.png" />
...
<img src="/docs/images/user/vendors/4.2.16VendorOnboarding-AddBillingAddress.png" />

Fill in all the required fields, click 'Save', and the task will be marked as completed.

<img src="/docs/images/user/vendors/4.2.17VendorOnboarding-BillingAddressAdded.png" />

<Note>If you use the Shopify store connector, your billing address will be automatically imported.</Note>

### Connect Stripe account

<img src="/docs/images/user/vendors/4.2.18VendorOnboarding-ConnectStripeAccount.png" />
...
<img src="/docs/images/user/vendors/4.2.19VendorOnboarding-StripeOnboardingComplete.png" />
...
<img src="/docs/images/user/vendors/4.2.20VendorOnboarding-CompleteStripeOnboarding.png" />

<Warning>While Stripe is popular among marketplace platforms, the marketplace you are joining may not use Stripe. However, you will likely still be required to connect a bank account to receive payouts unless they are reconciling them manually.</Warning>
...
<img src="/docs/images/user/vendors/4.2.21VendorOnboarding-ReturnAddress.png" />

Fill in all the required fields, click 'Save', and the task will be marked as completed.

<img src="/docs/images/user/vendors/4.2.22VendorOnboarding-ReturnAddressAdded.png" />

<Note>If you use the Shopify store connector, your billing address will be automatically imported.</Note>

### Set shipping rates

<img src="/docs/images/user/vendors/4.2.23VendorOnboarding-SetShippingRates.png" />
...
<img src="/docs/images/user/vendors/4.2.24VendorOnboarding-ShippingMethods.png" />
...
<img src="/docs/images/user/vendors/4.2.25VendorOnboarding-ShippingRatesConfirmed.png" />

<Note>You can edit existing shipping methods or add new ones at any time.</Note>
...
<img src="/docs/images/user/vendors/4.2.26VendorOnboarding-ReturnsPolicy.png" />

Copy and paste your returns policy into the field, click 'Save' and the task will be completed.

<img src="/docs/images/user/vendors/4.2.27VendorOnboarding-ReturnsPolicyAdded.png" />
