...
1. Click on **Add Returns Policy** in your onboarding checklist.
2. Paste your returns policy into the text field.
3. Click **Save**.

![The Add Returns Policy task expanded with the text field for entering a policy](/docs/images/user/vendors/vendor-onboarding-manual/12-returns-policy.png)
