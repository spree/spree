...
![The Vendors tab listing all vendors invited or onboarded to the marketplace](/images/user/vendors/vendor-onboarding-manual/1-vendors-tab.png)

Click **Invite Vendor** in the top right corner to open the invitation form.

![The Invite Vendor form with fields for company name, contact email, and commission rate](/images/user/vendors/vendor-onboarding-manual/2-invite-vendor.png)
...
![The Vendors list showing the newly invited vendor with a pending invitation status](/images/user/vendors/vendor-onboarding-manual/3-invitation-sent.png)
...
![The Invitations subtab with the three-dot menu opened to show the Copy invitation link option](/images/user/vendors/vendor-onboarding-manual/4-invitation-link.png)
...
![The Spree vendor account sign-up form](/images/user/vendors/vendor-onboarding-manual/5-account-signup.png)

You'll then be redirected to your new vendor dashboard, where you'll see a **Getting Started** checklist of onboarding tasks.

![The Getting Started onboarding checklist in the Spree vendor dashboard](/images/user/vendors/vendor-onboarding-manual/6-getting-started-tasks.png)

### 3. Set Up Your Shop

Click on the **Connect or Create a Shop** task in the checklist, then click **Use CSV and/or Admin dashboard**.

![The Connect or Create a Shop task expanded showing Shopify, WooCommerce, and Use CSV and/or Admin dashboard options](/images/user/vendors/vendor-onboarding-manual/7-connect-shop-options.png)
...
![The Add Billing Address task expanded with the billing form fields](/images/user/vendors/vendor-onboarding-manual/8-billing-address.png)
...
![The Connect Stripe Account task expanded in the onboarding checklist](/images/user/vendors/vendor-onboarding-manual/9-connect-stripe.png)
...
![The Add Returns Address task expanded with the address form fields](/images/user/vendors/vendor-onboarding-manual/10-returns-address.png)
...
![The Shipping Methods page in the vendor dashboard with fields for adding methods and rates](/images/user/vendors/vendor-onboarding-manual/11-shipping-rates.png)
...
![The Policies tab in the Spree Commerce vendor dashboard showing an unfilled returns policy](/images/user/vendors/vendor-onboarding-manual/12-returns-policy.png)
