...
![The Vendors tab showing the list of vendors](/images/user/vendors/commission-rates/1-vendors-tab.png)

Find the **Commission Rate** field on the vendor profile page and update it to the new percentage.

![The vendor profile page with the Commission Rate field highlighted](/images/user/vendors/commission-rates/2-vendor-commission-rate.png)
...
![The Products tab showing the list of products](/images/user/vendors/commission-rates/3-products-tab.png)

Scroll down to the **Platform Fee** section of the product editor and update the commission rate.

![The Platform Fee section of the product editor with the commission rate field](/images/user/vendors/commission-rates/4-platform-fee.png)
