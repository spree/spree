...
![The completed Create version form in the Shopify Dev Dashboard with all required fields filled in](/images/user/vendors/vendor-onboarding-shopify/1-create-version-form.png)
...
![The app Settings page in the Shopify Dev Dashboard with the Client ID and Secret fields](/images/user/vendors/vendor-onboarding-shopify/5-app-credentials.png)
...
![The Shopify Apps page in the Spree admin dashboard listing any existing connected apps](/images/user/vendors/vendor-onboarding-shopify/6-spree-shopify-apps.png)
...
![The New Shopify App form in Spree with Handle, Name, Client ID, and Secret fields](/images/user/vendors/vendor-onboarding-shopify/7-new-shopify-app-form.png)
...
![The Shopify app Overview page with the Select distribution method button highlighted](/images/user/vendors/vendor-onboarding-shopify/2-select-distribution-method.png)

2. Choose **Custom Distribution** and click **Select**. Confirm in the modal.

![The distribution method dialog with Custom Distribution selected](/images/user/vendors/vendor-onboarding-shopify/3-custom-distribution.png)
...
![The generated install link displayed in the Shopify Dev Dashboard, ready to copy](/images/user/vendors/vendor-onboarding-shopify/4-install-link.png)
...
![The Shopify store selection screen the vendor sees after opening the install link](/images/user/vendors/vendor-onboarding-shopify/8-vendor-store-select.png)

3. Accept the app installation.

![The Shopify app installation acceptance screen with the Install button](/images/user/vendors/vendor-onboarding-shopify/9-vendor-accept-install.png)
...
![The Spree vendor account creation screen presented after the vendor accepts the Shopify app installation](/images/user/vendors/vendor-onboarding-shopify/10-vendor-account-creation.png)
...
![The Getting Started onboarding checklist in the Spree vendor dashboard](/images/user/vendors/vendor-onboarding-shopify/11-getting-started-tasks.png)
...
![The Shipping Methods page in the vendor dashboard with the Confirm Shipping Rates button](/images/user/vendors/vendor-onboarding-shopify/12-confirm-shipping-rates.png)
...
![The Connect Stripe Account task expanded in the onboarding checklist](/images/user/vendors/vendor-onboarding-shopify/13-connect-stripe.png)
