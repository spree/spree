...
### 2. Generate the Install Link

With the app created and released, the next step is to generate the install link the vendor will use to connect their store.

1. From the app's **Overview** page, click **Select distribution method**.
...
### 3. Get the App's Credentials

Spree needs the app's Client ID and Secret to authenticate against Shopify.

1. Back in the **Shopify Dev Dashboard**, select the app you just created.
...
Send the install link you saved in step 2 to the vendor through any communication channel — email, Slack, or whatever you normally use. From here, the rest of the flow is on the vendor — see the **Vendor Onboarding** section below for what they'll experience.
