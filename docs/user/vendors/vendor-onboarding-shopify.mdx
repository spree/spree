...
description: "Invite and onboard a Shopify-based vendor to your Spree Enterprise marketplace via a Custom App so products, inventory, orders, and shipping sync."
---
