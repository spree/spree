...
![A cart containing items sold by multiple vendors](/images/user/vendors/multi-vendor-checkout/1-multi-vendor-cart.png)
...
![The checkout shipping step showing per-vendor shipping method selectors](/images/user/vendors/multi-vendor-checkout/2-shipping-methods.png)
