...
![](/docs/images/user/vendors/invite_vendor/1.invite_vendor.png)
...
![](/docs/images/user/vendors/invite_vendor/2.click_invite.png)
...
![](/docs/images/user/vendors/invite_vendor/3.invite_sent.png)
...
![](/docs/images/user/vendors/invite_vendor/4.vendor_profile.png)

Navigate to the "Invitations" subtab, click the three dots and select "Copy invitation link" from the dropdown menu.

![](/docs/images/user/vendors/invite_vendor/5.invitation_link.png)
