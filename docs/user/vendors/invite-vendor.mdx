...
<img src="/docs/images/user/vendors/4.1.1InviteAVendor-NavigateToTab.png" />
...
<img src="/docs/images/user/vendors/4.1.2InviteAVendor-InvitePopup.png" />
...
<img src="/docs/images/user/vendors/4.1.3InviteAVendor-InvitationSent.png" />
...
<img src="/docs/images/user/vendors/4.1.4InviteAVendor-VendorProfile.png" />

Click on "More actions" in the top right corner and select "Copy invitation link" from the dropdown menu.

<img src="/docs/images/user/vendors/4.1.5InviteAVendor-CopyInvitationLink.png" />
...
<img src="/docs/images/user/vendors/4.1.6InviteAVendor-CancelInvitation.png" />
