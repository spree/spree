...
![The Vendors tab listing all vendors invited or onboarded to the marketplace](/images/user/vendors/vendor-onboarding-woocommerce/1-vendors-tab.png)

Click **Invite Vendor** in the top right corner to open the invitation form.

![The Invite Vendor form with fields for company name, contact email, and commission rate](/images/user/vendors/vendor-onboarding-woocommerce/2-invite-vendor.png)
...
![The Vendors list showing the newly invited vendor with a pending invitation status](/images/user/vendors/vendor-onboarding-woocommerce/3-invitation-sent.png)
...
![The Invitations subtab with the three-dot menu opened to show the Copy invitation link option](/images/user/vendors/vendor-onboarding-woocommerce/4-invitation-link.png)
...
![The Spree vendor account sign-up form](/images/user/vendors/vendor-onboarding-woocommerce/5-account-signup.png)

You'll then be redirected to your new vendor dashboard, where you'll see a **Getting Started** checklist of onboarding tasks.

![The Getting Started onboarding checklist in the Spree vendor dashboard](/images/user/vendors/vendor-onboarding-woocommerce/6-getting-started-tasks.png)

### 3. Connect Your WooCommerce Store

Click on the **Connect or Create a Shop** task in the checklist, then click **WooCommerce**.

![The Connect or Create a Shop task expanded showing Shopify, WooCommerce, and CSV options](/images/user/vendors/vendor-onboarding-woocommerce/7-connect-shop-options.png)

A popup will appear asking for your WooCommerce store's URL.

![The popup asking for the WooCommerce store URL](/images/user/vendors/vendor-onboarding-woocommerce/8-woocommerce-url.png)
...
![The WooCommerce approval screen asking the vendor to approve marketplace access](/images/user/vendors/vendor-onboarding-woocommerce/9-woocommerce-approve.png)
...
![The Add Billing Address task expanded with the billing form fields](/images/user/vendors/vendor-onboarding-woocommerce/10-billing-address.png)
...
![The Connect Stripe Account task expanded in the onboarding checklist](/images/user/vendors/vendor-onboarding-woocommerce/11-connect-stripe.png)
...
![The Add Returns Address task expanded with the address form fields](/images/user/vendors/vendor-onboarding-woocommerce/12-returns-address.png)
...
![The Shipping Methods page in the vendor dashboard with synced WooCommerce methods and rate fields](/images/user/vendors/vendor-onboarding-woocommerce/13-shipping-rates.png)
...
![The Policies tab in the setting menu of the Spree vendor dashboard](/images/user/vendors/vendor-onboarding-woocommerce/14-returns-policy.png)
