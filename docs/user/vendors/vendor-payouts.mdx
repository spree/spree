...
description: "Set and override vendor payout schedules in Spree Enterprise across your marketplace using Stripe Connect, with marketplace defaults and per-vendor overrides."
---
