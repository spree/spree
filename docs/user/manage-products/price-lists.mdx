---
title: "Price lists for B2B, wholesale, and volume pricing"
description: "Use Spree price lists to manage customer-specific pricing — volume tiers, B2B contracts, wholesale rates, and per-group discounts in a single tool."
---
