...
![The price list tab in Spree Commerce](/images/user/products/price-lists/1-price-lists-tab.png)
...
![Creating a new price list in Spree Commerce](/images/user/products/price-lists/2-price-list-form.png)
...
![The price list editor in Spree Commerce](/images/user/products/price-lists/3-edit-form.png)
...
![Adding rules to a price list in Spree Commerce](/images/user/products/price-lists/4-price-list-rules.png)
...
![Adding product to a price list in Spree Commerce](/images/user/products/price-lists/5-add-products.png)
...
![Selecting products to add to a price list in Spree Commerce](/images/user/products/price-lists/6-select-products.png)
...
![How to edit prices on price list in Spree Commerce](/images/user/products/price-lists/7-edit-prices.png)
...
![Updating price lists values in the Spree Commerce dashboard](/images/user/products/price-lists/8-update-values.png)
...
![Activating a price list in Spree Commerce](/images/user/products/price-lists/9-active-price-list.png)
