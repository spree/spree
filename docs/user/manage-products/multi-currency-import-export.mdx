...
![The export modal on the Products tab](/images/user/products/multi-currency-import-export/1-export-modal.png)
...
![The import side panel on the Products tab](/images/user/products/multi-currency-import-export/2-import-panel.png)
