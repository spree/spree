...
![](/images/user/products/stock-transfers/4.add_products.png)
...
![](/images/user/products/stock-transfers/5.select_variants.png)

Please select a variant and then click **Add selected variant** to add it to the stock transfer.

![](/images/user/products/stock-transfers/6.variants_added.png)
...
![](/images/user/products/stock-transfers/7.transfer_complete.png)
