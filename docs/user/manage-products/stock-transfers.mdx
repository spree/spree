...
At the bottom of the form is where you can add the products to be transfered.
...
Select a variant and then click **Add selected variant** to add it to the stock transfer.
