---
title: "Product import file template"
description: "Download the Spree product import CSV template with all supported fields and multi-variant examples to prepare bulk catalog uploads correctly."
---
