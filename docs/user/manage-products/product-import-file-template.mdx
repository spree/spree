...
| category1               | The 1st [category](https://spreecommerce.org/docs/user/products/categories) to which the product should be assigned|
...
| custom field.namespace.key | The value for the product custom field [namespace.key](https://spreecommerce.org/docs/user/settings/metafields)|
