---
title: "Spree product import CSV file template"
description: "Download the Spree product import CSV template and reference field list — required and optional columns for single- and multi-variant products."
---
