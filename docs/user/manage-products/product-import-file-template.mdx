...
| option1_name            | The name of the 1st  [product option](/user/manage-products/product-options)|
...
| category1               | The 1st [category](/user/products/categories) to which the product should be assigned|
...
| custom_field.namespace.key | The value for the custom field [namespace.key](/user/settings/custom-fields)|
