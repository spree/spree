...
![](/images/user/products/bulk-product-operations/1.product_tab.png)
...
![](/images/user/products/bulk-product-operations/2.bulk_actions_menu.png)

The menu will show how many products are selected and present several action options.

## Status Updates

![](/images/user/products/bulk-product-operations/3.status.png)
...
![](/images/user/products/bulk-product-operations/4.add_taxons.png)
...
![](/images/user/products/bulk-product-operations/5.remove_taxons.png)
...
![](/images/user/products/bulk-product-operations/6.add_tags.png)
...
![](/images/user/products/bulk-product-operations/7.remove_tags.png)
...
![](/images/user/products/bulk-product-operations/8.save_changes.png)
