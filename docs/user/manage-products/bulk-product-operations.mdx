---
title: "Bulk product operations in the Spree admin"
description: "Perform bulk product operations in Spree — update prices, taxonomies, visibility, and inventory across many products at once from the admin dashboard."
---
