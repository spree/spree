...
<Warning>When updating products, make sure to **keep the following values unchanged** for each row: **product_id**, **sku**, and **slug**. Changing any of these may result in new products being created instead of updating the existing ones.</Warning>
