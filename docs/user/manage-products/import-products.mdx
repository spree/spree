...
If you’re using Spree Enterprise Edition, then you can save a lot of that time by making use of product import feature which allows you to upload products in bulk from a CSV or Excel file.

Please Note: It’s strongly recommended to preformat your product file to the resemble the attached example file to ensure no errors when importing. To learn more about formatting your product files, please refer to a separate support article.
