...
This is the safest and most efficient way to make large-scale updates to product data such as pricing, descriptions, inventory, or custom fields.

<Note>If your store sells in multiple currencies, your exported file will include additional price-only rows for each currency. See [<u>Multi-Currency Import/Export</u>](https://spreecommerce.org/docs/user/manage-products/multi-currency-import-export) for details on how these rows work.</Note>
