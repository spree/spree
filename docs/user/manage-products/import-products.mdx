...
If you’re using Spree Enterprise Edition, then you can save a lot of that time by making use of the product import feature which allows you to upload products in bulk from a CSV or Excel file.
