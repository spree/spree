---
title: "Search and filter products in the Spree admin"
description: "Use Spree's product search and filtering tools to find items in large catalogs — search by name, SKU, taxonomy, and other attributes from the admin."
---
