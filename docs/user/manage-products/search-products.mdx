...
description: "Search and filter products in the Spree Commerce admin dashboard by name, status, taxon, or keyword to quickly find items in a growing catalog."
---
