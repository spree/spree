...
![](/images/user/products/searching-products/3.status_and_stock.png)
...
![](/images/user/products/searching-products/4.filters.png)

Click the **Filters** button to open more filtering options. These include:

### Taxons

![](/images/user/products/searching-products/5.taxon_filter.png)
...
![](/images/user/products/searching-products/6.tag_filter.png)
...
![](/images/user/products/searching-products/7.vendor_filter.png)
