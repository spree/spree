...
![How to add product metafields in Spree Commerce](/images/user/products/product-metafields/1-product-metafields.png)

Click **New Metafield Definition** to open the metafield creation form.

![Adding a new product metafield in the Spree Commerce dashboard](/images/user/products/product-metafields/2-add-metafields.png)
...
![Adding metafield values to a product in Spree Commerce](/images/user/products/product-metafields/3-metafields-values.png)
