...
![Adding a new product custom field in the Spree Commerce dashboard](/docs/images/user/products/product-metafields/2-add-custom fields.png)
...
![Adding custom field values to a product in Spree Commerce](/docs/images/user/products/product-metafields/3-custom fields-values.png)
...
**custom field.namespace.key**

Example:

- **custom field.custom.material**
- **custom field.custom.care_instructions**
- **custom field.custom.sustainability_score**
