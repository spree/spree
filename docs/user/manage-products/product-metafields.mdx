---
title: "Product metafields in the Spree admin"
description: "Use product metafields in Spree to add custom attributes to products beyond default fields — specs, badges, and rich data for storefront and integrations."
---
