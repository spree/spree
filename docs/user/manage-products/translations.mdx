...
![The Translations overview page showing coverage by locale and product translation status](/docs/images/user/manage-products/translations/1-translations-overview.png)
...
![Translation coverage summary table showing locale, translated count, total products, and coverage percentage](/docs/images/user/manage-products/translations/2-coverage-table.png)
...
![Product list with locale columns showing checkmarks and dashes for translation status](/docs/images/user/manage-products/translations/3-product-grid.png)
...
![Product list with locale columns showing checkmarks and dashes for translation status](/docs/images/user/manage-products/translations/4-translation-drawer.png)
...
![The export confirmation modal for translations](/docs/images/user/manage-products/translations/5-export-modal.png)
...
![The import side panel for translations](/docs/images/user/manage-products/translations/6-import-panel.png)
