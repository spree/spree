---
title: "Migrate from Shopify to Spree Commerce"
description: "Migrate products and customers from Shopify to Spree Commerce using CSV imports — column mapping, multi-variant products, and post-migration checks."
---
## Overview
