...
| `Cost per item` | — | Not directly imported, can be set via custom fields |
| `Vendor` | — | Can be imported as a custom field or tag |
...
- `Vendor` — consider importing as a tag or custom field
...
- `Variant Barcode` — can be added as a custom field
...
| `Note` | — | Not directly imported, can be added as a custom field |
