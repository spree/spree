---
title: Migrate from Shopify to Spree
description: Step-by-step guide to migrating products, variants, images, categories, and customers from Shopify to Spree Commerce using the built-in CSV import system.
---
