...
description: "Step-by-step guide to migrating products, variants, images, customers, and addresses from Shopify to Spree Commerce using built-in CSV imports."
---
