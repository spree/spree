---
title: "Set up wholesale pricing in Spree Commerce"
description: "Offer wholesale pricing to specific customer groups using Spree price lists — trade-only prices for registered wholesalers alongside retail prices."
---
