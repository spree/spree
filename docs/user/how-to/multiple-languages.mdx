...
![The Markets overview page showing multiple configured markets with different locales](/images/user/how-to/multiple-languages/1-markets-overview.png)
...
![The Translations overview page showing coverage by locale and translation status per product](/images/user/how-to/multiple-languages/2-translations-overview.png)
...
![The import side panel for bulk translations](/images/user/how-to/multiple-languages/3-import-panel.png)
...
![The translation drawer open for an individual product showing fields for each locale](/images/user/how-to/multiple-languages/4-translation-drawer.png)
...
![A category open in the category configurator](/images/user/how-to/multiple-languages/5-category-configurator.png)
...
![The translations side panel open for a category](/images/user/how-to/multiple-languages/6-category-translations-panel.png)
...
![A policy open in the policy editor](/images/user/how-to/multiple-languages/7-policy-editor.png)
...
![The translations side panel open for a policy](/images/user/how-to/multiple-languages/8-policy-translations-panel.png)
