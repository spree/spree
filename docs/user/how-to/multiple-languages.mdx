...
description: "Sell in multiple languages in Spree by configuring market locales, bulk-translating products via the importer, and translating categories and store policies."
---
