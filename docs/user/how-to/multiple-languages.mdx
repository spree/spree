...
description: "Sell in multiple languages in Spree by configuring locales per Market and translating products, taxons, and policies in bulk via the translations importer."
---
