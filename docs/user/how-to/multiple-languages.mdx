...
description: "Enable locales, translate product catalogs, categories, and store policies so customers shop in their native language across each Spree market."
---
