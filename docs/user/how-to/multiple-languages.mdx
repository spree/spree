...
![The Markets overview page showing multiple configured markets with different locales](/docs/images/user/how-to/multi-language/1-markets-overview.png)
...
![The Translations overview page showing coverage by locale and translation status per product](/docs/images/user/how-to/multi-language/2-translations-overview.png)
...
![The import side panel for bulk translations](/docs/images/user/how-to/multi-language/3-import-panel.png)
...
![The translation drawer open for an individual product showing fields for each locale](/docs/images/user/how-to/multi-language/4-translation-drawer.png)
...
![A category open in the category configurator](/docs/images/user/how-to/multi-language/5-category-configurator.png)
...
![The translations side panel open for a category](/docs/images/user/how-to/multi-language/6-category-translations-panel.png)
...
![A policy open in the policy editor](/docs/images/user/how-to/multi-language/7-policy-editor.png)
...
![The translations side panel open for a policy](/docs/images/user/how-to/multi-language/8-policy-translations-panel.png)
