...
![The New Price List form in Spree Commerce](/images/user/how-to/regional-volume/1-new-price-list-form.png)
...
![The price list editor showing Match All logic with a Market rule and a Volume rule](/images/user/how-to/regional-volume/2-match-all-rules.png)
...
![The price editor showing discounted USD prices for the US 21–50 unit tier](/images/user/how-to/regional-volume/3-edit-prices.png)
...
![The price editor showing discounted EUR prices for the Germany 21–50 unit tier](/images/user/how-to/regional-volume/4-edit-prices-eur.png)
