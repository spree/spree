...
description: "Configure your Spree store to display and sell in multiple currencies by creating a Market per currency and setting base product prices for each region."
---
