---
title: "How to set up multi-currency pricing in Spree"
description: "Configure Spree to display and sell in multiple currencies — create a Market per currency and assign prices so shoppers see local-currency totals."
---
