...
description: "Configure your Spree store to sell in multiple currencies by creating a Market per currency and setting base prices, walked through with a US and EU example."
---
