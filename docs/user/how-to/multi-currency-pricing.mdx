...
![The Markets overview page showing the existing US market](/images/user/how-to/multi-currency-pricing/1-markets-overview.png)

Click **New Market** to open the creation form.

![The New Market creation form in Spree Commerce](/images/user/how-to/multi-currency-pricing/2-new-market-form.png)
...
![The Markets overview showing both the US (USD) and Germany (EUR) markets](/images/user/how-to/multi-currency-pricing/3-markets-configured.png)
...
![The product list in the Spree Commerce admin](/images/user/how-to/multi-currency-pricing/4-product-editor.png)
...
![The currency switcher in the product editor set to EUR](/images/user/how-to/multi-currency-pricing/5-currency-switcher.png)

Enter the EUR price for this product (e.g., `89.00` for a product priced at `99.00` USD) and click **Update** to save.

![The currency switcher set to EUR with the Euro price entered](/images/user/how-to/multi-currency-pricing/6-pricing-eur.png)
...
![The market switcher in the Spree Next.js storefront navigation bar showing Germany / EUR selected](/images/user/how-to/multi-currency-pricing/7-storefront-switcher.png)
