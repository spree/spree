---
title: "Set up volume pricing in Spree Commerce"
description: "Offer tiered volume discounts based on order quantity using Spree price lists — reward bulk buyers with automatic price breaks at configurable thresholds."
---
