...
description: "Offer tiered quantity discounts in Spree using Price Lists with a Volume rule, so bulk buyers automatically see lower per-unit prices for larger orders."
---
