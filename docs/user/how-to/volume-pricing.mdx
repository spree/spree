...
![The New Price List form in Spree Commerce](/images/user/how-to/volume-pricing/1-new-price-list-form.png)
...
![The price list editor showing a Volume rule with min and max quantity fields](/images/user/how-to/volume-pricing/2-volume-rule.png)
...
![The price editor showing discounted prices entered for the 21–50 unit tier](/images/user/how-to/volume-pricing/3-edit-prices.png)
