...
description: "Offer tiered bulk discounts based on order quantity in Spree by creating Price Lists with a Volume rule for mid-volume and high-volume customer tiers."
---
