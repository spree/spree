...
description: "Offer tiered volume discounts based on order quantity in Spree using price lists to automatically reward bulk buyers with lower per-unit pricing."
---
