...
![The Markets overview page showing the existing Germany (EUR) market](/images/user/how-to/multi-region-pricing/1-markets-overview.png)

Click **New Market** to open the creation form.

![The New Market creation form in Spree Commerce](/images/user/how-to/multi-region-pricing/2-new-market-form.png)
...
![The Markets overview showing Germany, France, and Spain markets, all using EUR](/images/user/how-to/multi-region-pricing/3-markets-configured.png)
...
![The New Price List form in Spree Commerce](/images/user/how-to/multi-region-pricing/4-new-price-list-form.png)
...
![The price list editor showing a Market rule targeting France](/images/user/how-to/multi-region-pricing/5-market-rule.png)
...
![The price editor showing EUR prices entered for the France price list](/images/user/how-to/multi-region-pricing/6-edit-prices.png)
...
![The market switcher in the Spree Next.js storefront navigation bar, switching between France, Spain, and Germany](/images/user/how-to/multi-region-pricing/7-storefront-switcher.png)
