...
- Familiarity with how Price Lists work. See [<u>Price Lists</u>](https://spreecommerce.org/docs/user/pricing/price-lists) for a full reference.
...
1. Visit your storefront and look for the market switcher in the navigation. If you're using the Spree Next.js Storefront, this appears in the navigation bar.
...
- [<u>Price Lists</u>](https://spreecommerce.org/docs/user/pricing/price-lists) — full reference for rules, volume pricing, and customer group pricing
