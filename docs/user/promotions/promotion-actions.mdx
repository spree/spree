...
description: "Use Spree promotion actions to apply whole-order or per-line-item discounts, free shipping, or free gifts at checkout, customized with built-in calculators."
---
