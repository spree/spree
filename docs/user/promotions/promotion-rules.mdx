---
title: "Promotion rules and eligibility in Spree"
description: "Use promotion rules in Spree to define when a promotion is eligible — order total, customer groups, product selection, and date-based windows."
---
