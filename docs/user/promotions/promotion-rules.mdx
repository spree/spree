...
description: "Configure Spree Commerce promotion rules to control when discounts apply based on order total, customer group, products, taxons, or login status."
---
