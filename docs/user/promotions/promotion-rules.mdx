---
title: "Promotion rules reference"
description: "Set Spree promotion eligibility using rules for order total, customer group, specific products, or user login, with match-all or match-any policies."
---
