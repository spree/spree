...
description: "Use Spree promotion rules to control when a promotion applies, with conditions for item total, customer group, products, taxons, and login status."
---
