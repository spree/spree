...
Rule behavior and configuration details are covered in Promotion Rules.
...
Each action supports one or more calculators (e.g. flat rate, percentage, tiered discounts). These are covered in detail in Promotion Actions.
