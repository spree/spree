...
description: "Set up Spree promotions to offer discounts, free shipping, or bonus products and configure when each promotion applies using rules and actions."
---
