---
title: "The B2B commerce model on Spree Commerce"
description: "Understand the B2B commerce model on Spree Enterprise — wholesale distribution, account-based pricing, custom catalogs, and procurement workflows."
---
