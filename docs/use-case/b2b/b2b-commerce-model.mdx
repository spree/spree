...
description: "Learn about the B2B commerce model and how Spree Commerce supports it."
---
...
- **Buyer Organizations** — Multiple buyers operate under one company account, with its sub-units, address book and shared order history.

## How Spree Supports B2B Commerce

### Community Edition

With [<u>Price Lists</u>](https://spreecommerce.org/docs/user/pricing/price-lists), [<u>Customer Groups</u>](https://spreecommerce.org/docs/user/customers/customer-groups), [<u>Markets</u>](https://spreecommerce.org/docs/user/settings/markets), and gated storefronts, you can configure working B2B scenarios directly in the Spree admin — no development required:
...
- Assign a catalog to a customer group or a company to deliver that buyer their own assortment and prices, in their own currency
...
Buyer organizations and catalogs are part of this — [<u>companies</u>](https://spreecommerce.org/docs/user/customers/companies) model a business buyer and its sub-units, and a [<u>catalog</u>](https://spreecommerce.org/docs/user/catalogs/catalogs) is the agreement that says what they see and what they pay.
...
- **Multi-User Organizations** — A company account with several buyers, its own address book and shared order history is supported in Community Edition. Role-based approval chains are Enterprise Edition.
