---
title: "B2B commerce capabilities on Spree Enterprise"
description: "Spree Enterprise B2B capabilities — customer segmentation, per-segment pricing, custom catalogs, quotes, net terms, and tax-exempt customer workflows."
---
