---
title: "Digital products admin capabilities in Spree"
description: "Configure and manage digital products in the Spree admin dashboard — file uploads, secure delivery, download limits, and access expiry settings."
---
