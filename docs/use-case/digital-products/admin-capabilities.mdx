...
description: "Configure digital products in the Spree admin: file uploads, download limits, link expiration, automated delivery, access logs, and bundling rules."
---
