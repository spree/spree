...
- **API-Driven Extensibility**
  - **Full API Coverage** - extend the platform via REST or GraphQL APIs for storefronts, checkout, vendor dashboards, or 3rd-party integrations. See:[<u>API Reference</u>](https://spreecommerce.org/docs/api-reference/store-api/introduction) 
