...
description: "Give vendors a dedicated Spree dashboard to manage products, orders, analytics, and shipping settings, with Shopify and WooCommerce integrations."
---
