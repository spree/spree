---
title: "Multi-vendor marketplace admin dashboard"
description: "Spree Enterprise multi-vendor marketplace admin dashboard — manage vendors, commissions, payouts, products, and centralized customer support."
---
