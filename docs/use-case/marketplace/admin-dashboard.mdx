...
description: "Run a multi-vendor marketplace from the Spree Enterprise admin with vendor onboarding, approvals, permission controls, and merchandising tools."
---
