...
description: "Marketplace admin dashboard in Spree for onboarding vendors, managing permissions, integrating Shopify and WooCommerce, and curating catalogs."
---
