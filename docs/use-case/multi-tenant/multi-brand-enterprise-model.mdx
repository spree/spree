---
title: "Multi-brand enterprises on Spree multi-tenant"
description: "Run multi-brand enterprises on Spree Enterprise's multi-tenant architecture — isolated tenants, shared infrastructure, and centralized governance."
---
