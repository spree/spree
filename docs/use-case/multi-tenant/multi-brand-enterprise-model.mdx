---
title: "Multi-brand Enterprise Model"
description: "Run multiple brands, regions, or divisions from one Spree multi-tenant backend with shared infrastructure and isolated storefront data."
---
