...
description: "Run multiple brands or regional storefronts on one shared backend using Spree Enterprise's multi-tenant architecture for global retail groups."
---
