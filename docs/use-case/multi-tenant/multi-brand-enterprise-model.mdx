...
description: "Run multiple brands or regional storefronts on a shared backend with Spree Enterprise multi-tenant architecture, data isolation, and unified ops."
---
