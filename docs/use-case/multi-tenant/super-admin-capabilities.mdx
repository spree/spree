...
description: "Super admin controls for Spree multi-tenant platforms: tenant onboarding, master catalogs, payments, fulfillment, billing, and white-label storefront tools."
---
