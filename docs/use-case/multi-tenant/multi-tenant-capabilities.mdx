---
title: "Multi-tenant ecommerce capabilities in Spree"
description: "Multi-tenant ecommerce capabilities in Spree Enterprise — tenant isolation, super-admin governance, per-tenant branding, and tenant-scoped APIs."
---
