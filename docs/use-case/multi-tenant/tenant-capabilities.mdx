---
title: "Multi-tenant store capabilities"
description: "Per-tenant tools in Spree Enterprise for managing products, orders, customers, analytics, and storefront branding within platform policies."
---
