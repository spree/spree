---
title: "Tenant capabilities in Spree multi-tenant"
description: "Tenant capabilities in Spree Enterprise multi-tenant platforms — manage products, orders, customers, payments, and storefront within an isolated tenant."
---
