---
title: "The multi-tenant ecommerce model on Spree"
description: "Understand the multi-tenant ecommerce model on Spree Enterprise — isolated tenants on shared infrastructure with centralized management and billing."
---
