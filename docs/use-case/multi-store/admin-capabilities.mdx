---
title: "Multi-store admin capabilities in Spree"
description: "Manage multiple Spree stores from a single unified admin dashboard — shared products and customers vs store-specific settings, branding, and pricing."
---
