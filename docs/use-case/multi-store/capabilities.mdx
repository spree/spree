---
title: "Multi-store capabilities on Spree Commerce"
description: "Multi-store capabilities in Spree Enterprise — launch and manage multiple storefronts from one backend with shared and store-specific resources."
---
