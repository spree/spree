---
title: "The multi-store commerce model on Spree"
description: "Understand the multi-store ecommerce model on Spree Enterprise — multiple storefronts on one backend, with shared admin and configurable data scope."
---
