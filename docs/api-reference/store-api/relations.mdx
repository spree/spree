---
title: "Expand related resources in Store API responses"
sidebarTitle: "Relations"
description: "Use the expand parameter to include related resources — variants, images, line items — inline in Store API responses and reduce request roundtrips."
---
