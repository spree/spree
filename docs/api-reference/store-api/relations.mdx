---
title: "Store API relations and included resources"
sidebarTitle: "Relations"
description: "Use the JSON:API `include` parameter to side-load related resources such as variants, images, and line items in a single Spree Store API response."
---
