...
description: "Understand how the Store API returns monetary values as decimal strings with paired display_ fields for safe formatting and accurate calculations."
---
