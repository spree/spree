---
title: "Monetary amounts in Store API responses"
sidebarTitle: "Monetary Amounts"
description: "How the Store API returns prices and totals as decimal strings with matching display_ fields to preserve precision and avoid JSON floating-point errors."
---
