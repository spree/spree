---
title: "Store API monetary amounts"
sidebarTitle: "Monetary Amounts"
description: "How the Spree Store API represents prices and totals as strings to preserve precision, with tips on formatting currency in the storefront."
---
