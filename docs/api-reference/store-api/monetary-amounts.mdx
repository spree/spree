...
description: "Store API returns monetary amounts as decimal strings with paired display_ fields, preserving precision and providing currency-formatted values for UI."
---
