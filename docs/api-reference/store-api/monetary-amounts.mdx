...
description: "How Spree serializes monetary values as decimal strings to preserve precision and avoid JSON floating-point rounding issues for prices and totals."
---
