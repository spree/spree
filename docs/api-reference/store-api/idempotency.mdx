---
title: "Store API idempotency keys for safe retries"
sidebarTitle: "Idempotency"
description: "Use idempotency keys on mutating Store API endpoints to safely retry requests without creating duplicate carts, orders, or payment side effects."
---
