---
title: "Store API error format and error codes"
description: "Reference for the Store API's Stripe-style error responses, including machine-readable error codes, status codes, and client handling strategies."
---
