...
description: "Default rate limits, throttling rules, and per-API-key quotas applied to Store API endpoints to protect storefronts against abuse and runaway traffic."
---
