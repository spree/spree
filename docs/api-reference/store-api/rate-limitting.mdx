...
description: "Store API rate limits, per-key and per-IP throttling rules, X-RateLimit response headers, and how to handle 429 Too Many Requests errors gracefully."
---
