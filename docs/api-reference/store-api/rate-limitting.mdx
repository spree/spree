---
title: "Store API rate limiting"
sidebarTitle: "Rate Limiting"
description: "Rate limits, throttling rules, and HTTP 429 responses for the Spree Store API, plus guidance on retrying requests and avoiding abuse-protection blocks."
---
