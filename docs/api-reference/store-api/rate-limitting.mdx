...
description: "Store API rate limits: 300 requests per minute per API key, stricter throttling on login, signup, and refresh endpoints, plus 429 response handling."
---
