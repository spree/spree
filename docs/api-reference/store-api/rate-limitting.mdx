---
title: "Store API rate limits and throttling"
sidebarTitle: "Rate Limiting"
description: "Rate limits applied to Store API requests per publishable API key or IP, response headers to track remaining quota, and how to handle 429 throttled responses."
---
