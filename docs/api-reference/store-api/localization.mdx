---
title: "Store API localization"
sidebarTitle: "Localization"
description: "Set the locale, currency, and country on Spree Store API requests to power multi-language, multi-currency, and market-aware headless storefronts."
---
