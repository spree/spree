...
description: "Set locale, currency, and country for Store API responses using request headers or SDK defaults to power multi-language, multi-currency storefronts."
---
