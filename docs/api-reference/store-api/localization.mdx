---
title: "Store API localization, currency, and country"
sidebarTitle: "Localization"
description: "Set locale, currency, and country headers on Store API requests to deliver translated content and market-aware pricing for international shoppers."
---
