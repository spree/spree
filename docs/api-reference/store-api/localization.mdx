---
title: "Store API localization: locale, currency, country"
sidebarTitle: "Localization"
description: "Set the locale, currency, and country for Store API responses using X-Spree headers or SDK client defaults to power multi-language, multi-market storefronts."
---
