---
title: "Store API metadata on carts, orders, and line items"
sidebarTitle: "Metadata"
description: "Attach and read arbitrary JSON key-value metadata on carts, orders, and line items to track UTM data, gift messages, and integration-specific fields."
---
