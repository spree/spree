...
description: "Attach and update custom JSON metadata on carts, orders, and line items via the Store API for gift messages, UTM tracking, and integration data."
---
