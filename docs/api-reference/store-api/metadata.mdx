---
title: "Store API metadata"
sidebarTitle: "Metadata"
description: "Attach and read public or private key-value metadata on carts, orders, line items, and other Spree Store API resources to support custom storefront data."
---
