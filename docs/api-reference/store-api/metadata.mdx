---
title: "Store API custom metadata on carts and orders"
sidebarTitle: "Metadata"
description: "Store and retrieve arbitrary key-value metadata on carts, orders, and line items for gift messages, attribution data, and integration IDs."
---
