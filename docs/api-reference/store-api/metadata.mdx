...
description: "Attach and retrieve arbitrary JSON metadata on carts, orders, and line items for gift messages, attribution data, and integration-specific fields."
---
