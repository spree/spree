...
description: "Authenticate Store API requests using publishable API keys, JWT bearer tokens for logged-in customers, and order tokens for guest checkout flows."
---
