...
description: "Authenticate Store API requests with a publishable API key, JWT tokens for logged-in customers, and order tokens for guest checkout sessions."
---
