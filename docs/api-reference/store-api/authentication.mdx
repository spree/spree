---
title: "Store API authentication methods"
sidebarTitle: "Authentication"
description: "Authenticate Store API requests with API keys, JWT customer tokens, or guest order tokens for storefront, mobile, and headless checkout flows."
---
