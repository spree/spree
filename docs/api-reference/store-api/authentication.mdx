---
title: "Store API authentication"
sidebarTitle: "Authentication"
description: "Authenticate Spree Store API requests using a store API key, an OAuth bearer token for logged-in customers, or an anonymous order token for guest carts."
---
