...
description: "Introduction to the Spree Store API v3, a REST API for building headless storefronts, mobile commerce apps, and point-of-sale clients on top of Spree."
---
