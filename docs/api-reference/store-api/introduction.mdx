...
description: "Introduction to the Spree Store API v3 for headless storefronts, point of sale, and mobile apps, including base URLs and the official TypeScript SDK."
---
