---
title: "Store API querying and filtering"
sidebarTitle: "Querying"
description: "Filter, sort, and paginate Spree Store API collection endpoints using Ransack predicates, sparse fieldsets, and standard JSON:API query parameters."
---
