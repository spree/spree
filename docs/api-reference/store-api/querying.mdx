---
title: "Querying the Store API: filter, sort, paginate"
sidebarTitle: "Querying"
description: "Filter, sort, and paginate Store API collections using Ransack predicates passed through the q query parameter from the SDK or direct HTTP requests."
---
