...
description: "Filter, sort, and paginate Store API collections using Ransack predicates, q parameters, scopes, and per-page limits with cURL and SDK examples."
---
