...
description: "Filter, sort, and paginate Store API collections with Ransack predicates passed through the q query parameter, plus per_page and page controls."
---
