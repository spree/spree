...
description: "Migration guide mapping legacy Storefront API v2 endpoints, SDK calls, and JSON:API concepts to the new resource-oriented Spree Store API v3."
---
