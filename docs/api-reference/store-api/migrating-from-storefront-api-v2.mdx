---
title: "Migrate from Storefront API v2 to Store API v3"
sidebarTitle: "Migrating from v2"
description: "Endpoint-by-endpoint migration guide from the legacy Storefront API v2 to the modern Store API v3, including SDK calls and behavior changes."
---
