...
description: "Migrate from the legacy Storefront API v2 to Store API v3 with endpoint, payload, and SDK mappings covering products, carts, checkout, and customers."
---
