---
title: "Migrating from Storefront API v2 to Store API"
sidebarTitle: "Migrating from v2"
description: "Endpoint-by-endpoint migration guide mapping legacy Storefront API v2 routes, JSON:API payloads, and SDK calls to their new Spree Store API v3 equivalents."
---
