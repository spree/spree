---
title: "Webhook event types and payload schemas"
description: "Complete reference of every Spree webhook event — order.completed, cart.updated, customer.created — with delivery envelope structure and payload schemas."
---
