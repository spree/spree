...
Event payloads use the same [Store API V3 serializers](/api-reference/store-api/introduction) as the REST API. All `id` fields use [prefixed IDs](/api-reference/store-api/introduction) (e.g., `or_m3Rp9wXz`, `prod_86Rf07xd4z`). All monetary values are strings. All timestamps are ISO 8601.
