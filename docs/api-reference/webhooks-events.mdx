...
description: "Complete reference of Spree webhook event names, JSON envelope structure, and payload schemas for orders, products, customers, carts, and shipments."
---
