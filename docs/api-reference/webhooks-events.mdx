...
description: "Complete reference of every Spree webhook event type, its trigger conditions, and the JSON payload schema delivered to subscribed endpoint URLs."
---
