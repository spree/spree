...
description: "Authenticate Storefront API v2 requests with OAuth bearer tokens for signed-in customers and X-Spree-Order-Token headers for guest cart sessions."
---
