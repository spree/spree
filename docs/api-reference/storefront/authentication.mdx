---
title: "Storefront API authentication for guests and users"
description: "Authenticate Storefront API requests for guest carts via order tokens and for signed-in customers via OAuth bearer tokens during checkout flows."
---
