---
title: "Storefront API authentication"
description: "Authenticate Storefront API v2 requests using bearer JWT tokens for logged-in customers and X-Spree-Order-Token headers for guest cart and checkout flows."
---
