---
title: "Storefront API authentication and order tokens"
description: "Authenticate Storefront API v2 requests with X-Spree-Order-Token for guest carts and OAuth bearer tokens for logged-in customers managing accounts."
---
