...
description: "Authenticate Spree Storefront API requests using OAuth bearer tokens for logged-in customers and order tokens for guest carts on headless storefronts."
---
