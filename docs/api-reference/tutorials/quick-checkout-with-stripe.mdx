...
description: "Tutorial for adding Stripe quick checkout to a headless Spree storefront, handling address, shipping rate, and confirmation events via the Storefront API."
---
