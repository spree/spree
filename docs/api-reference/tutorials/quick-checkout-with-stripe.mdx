---
title: "Quick checkout with Stripe on a headless storefront"
description: "Tutorial for adding Stripe quick checkout (Apple Pay, Google Pay) to a headless Spree storefront using the Spree Stripe extension and Store APIs."
---
<Warning>
