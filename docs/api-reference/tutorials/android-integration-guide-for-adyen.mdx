---
title: Android Integration Guide for Adyen
...
- Spree Adyen API docs - [create payment_session](https://spreecommerce.org/docs/api-reference/storefront/adyen/create-an-adyen-payment-session) and [GET payment_session](https://spreecommerce.org/docs/api-reference/storefront/adyen/get-an-adyen-payment-session)
...
(see [API docs](https://spreecommerce.org/docs/api-reference/storefront/adyen/create-an-adyen-payment-session) for more details)
