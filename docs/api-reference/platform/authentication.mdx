---
title: "Platform API authentication with OAuth"
description: "Authenticate Platform API requests by creating an OAuth application in the Spree admin and exchanging credentials for a bearer access token."
---
