...
description: "Create an oAuth application in the Spree admin and exchange the client ID and secret for a Platform API access token to authenticate API requests."
---
