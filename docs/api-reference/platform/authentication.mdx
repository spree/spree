...
description: "Authenticate Platform API requests by creating an OAuth application in Spree admin and exchanging client credentials for a bearer token with admin scope."
---
