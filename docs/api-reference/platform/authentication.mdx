---
title: "Platform API authentication and OAuth tokens"
description: "Create an oAuth application in Spree admin and exchange client credentials for a bearer token to authenticate Platform API requests from your backend."
---
