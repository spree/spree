...
description: Create an OAuth application in Spree and generate access tokens to authenticate external apps making Platform API calls with the right scopes.
---
