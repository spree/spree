...
description: "Generate OAuth tokens for the Spree Platform API by creating an admin oAuth application, exchanging client credentials, and sending Bearer tokens."
---
