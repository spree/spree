---
title: "Spree Admin API reference"
description: "REST API for managing products, orders, customers, payments, and store configuration from server-side admin tools and back-office integrations."
