...
description: "Introduction to the Spree Admin API — a REST API for managing products, orders, customers, fulfillments, and payments programmatically from your backend."
---
