---
title: "Paginating Storefront API v2 lists"
description: "Paginate Spree Storefront API v2 collection endpoints with the `page` and `per_page` query parameters, and read total counts from the response `meta` node."
---
