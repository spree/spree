---
description: "Overview of the Spree v2 REST APIs — Storefront and Platform — for building headless storefronts, mobile apps, and backend integrations on Spree Commerce."
title: "Spree Ecommerce API v2 introduction"
---
