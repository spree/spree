---
description: "Legacy JSON:API-based Storefront API v2 reference for headless storefronts — fetch products, build carts, run checkout, and manage customer accounts."
title: "Spree Storefront API v2 reference"
---
