---
description: "Introduction to the Spree Storefront API v2, a REST and JSON:API interface for building headless storefronts, mobile commerce apps, and custom integrations."
title: "Storefront API v2 introduction"
---
