---
description: "Overview of Spree's open-source ecommerce REST APIs for headless storefronts and mobile apps, covering the Storefront API and Platform API for v2 integrations."
title: "Ecommerce API"
---
