...
description: "Filter Storefront API v2 collections with filter[] parameters and order results with the sort parameter, including multi-attribute and descending sort syntax."
---
