---
title: "Filtering and sorting Storefront API v2 results"
description: "Filter and sort Spree Storefront API v2 collection endpoints using Ransack `filter[]` query parameters and the `sort` parameter to refine products and lists."
---
