---
title: "Filtering and sorting Storefront API v2 collections"
description: "Filter Storefront API v2 collection endpoints by attributes such as SKU, price, and name, and order results using the sort query parameter on list calls."
---
