---
title: "Filtering and sorting on the Storefront API"
description: "Apply filter and sort parameters to Storefront API v2 collection endpoints to narrow product results, sort listings, and refine catalog queries."
---
