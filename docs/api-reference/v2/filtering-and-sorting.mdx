---
title: "Filtering and sorting v2 API collections"
description: "Filter and sort Spree v2 API collection endpoints with filter[attribute] and sort parameters to narrow results by SKU, price, name, and other product fields."
---
