---
title: "Fetching multiple resources with include"
description: "Use the JSON:API `include` query parameter to side-load related resources such as variants, images, and option values in a single Storefront API v2 call."
---
