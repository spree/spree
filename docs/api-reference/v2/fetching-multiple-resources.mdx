---
title: "Fetching multiple resources in Storefront API v2"
description: "Use the include parameter to fetch a Spree resource together with its associated records — like product variants and images — in a single API v2 call."
---
