---
title: "Fetching multiple resources"
description: "Use the include parameter to fetch related resources like product variants, images, and option values in a single Storefront API v2 JSON:API call."
---
