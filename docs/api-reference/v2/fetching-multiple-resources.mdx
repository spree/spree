---
title: "Fetching included resources in v2 API"
description: "Use the JSON:API include parameter in the Spree v2 API to load related resources like variants, images, and option values in a single request."
---
