---
title: "Fetching multiple resources with the Storefront API"
description: "Use the include parameter on the legacy Storefront API v2 to fetch related resources — variants, images, taxons — in a single request response."
---
