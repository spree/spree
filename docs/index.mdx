...
<div className="relative">
  <div className="relative z-10 px-4 py-16 max-w-3xl mx-auto">
    ...
    <div className="px-6 lg:px-0 mt-12 grid sm:grid-cols-2 gap-x-6 gap-y-4">
      <HeroCard filename="dev" title="Guides" description="Setup your Spree in minutes and start developing" href="/developer/getting-started" />

      <HeroCard
        filename="api"
        title="API Reference"
        description="Explore the Spree API reference"
        href="/api-reference"
      />
      ...
      <HeroCard
        filename="user"
        title="Admin Guide"
        description="Learn how to use Spree as a store owner or operator"
        href="/user"
      />
      ...
      <HeroCard
        ...
        title="Integrations"
        description="Integrate Spree with your favorite tools and services"
        href="/integrations"
      />
    </div>
  </div>
