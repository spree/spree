...
![PayPal listed under Available Payment Methods on the Payments settings page](/images/integrations/paypal/1-payment-method-list.png)

Find PayPal under Available Payment Methods and click **Add**.

This will redirect you to the PayPal setup form.

![The PayPal setup form with fields for Client ID, Client Secret, and Webhook ID](/images/integrations/paypal/2-setup-form.png)
...
![The PayPal credentials page showing Client ID and Secret](/images/integrations/paypal/3-credentials.png)
...
![The PayPal Additional Settings panel after the payment method is created](/images/integrations/paypal/4-additional-settings.png)
