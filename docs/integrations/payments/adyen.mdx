...
![Adyen listed under Available Payment Methods on the Payments settings page](/images/integrations/adyen/1-payment-method-list.png)

Find Adyen under Available Payment Methods and click **Add**.

This will redirect you to the Adyen setup form.

![The Adyen setup form with fields for Merchant Account, API Key, Client Key, HMAC Key, Webhook, and Live URL Prefix](/images/integrations/adyen/2-setup-form.png)
...
![Adyen enabled as a payment method in Spree](/images/integrations/adyen/3-adyen-enabled.png)
...
![The Adyen Additional Settings panel after the payment method is created](/images/integrations/adyen/4-additional-settings.png)
