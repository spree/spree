...
<Warning>
  You must have an existing Stripe account to enable Stripe payments in Spree.
</Warning>
...
![](/docs/images/integrations/stripe/3.stripe_enabled.png)

### Additional Settings

![](/docs/images/integrations/stripe/4.additional_settings.png)
