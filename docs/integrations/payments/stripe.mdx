---
title: "Accept Stripe payments on Spree Commerce"
sidebarTitle: Stripe
description: "Set up and manage Spree's native Stripe integration — accept cards, wallets, and local payment methods with secure checkout and automated payouts."
---
