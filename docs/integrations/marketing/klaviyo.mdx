...
To start using Klaviyo with Spree, navigate to the Integrations tab of the admin dashboard.

![](/docs/images/integrations/klaviyo/1.klaviyo.png)

## Connect Klaviyo

To connect Klaviyo, locate the Klaviyo tile under the Marketing section and click Connect Klaviyo to open the setup form.

![](/docs/images/integrations/klaviyo/2.creation_form.png)
...
![](/docs/images/integrations/klaviyo/3.create_private_key.png)

Click Create Private API Key to open the key creation form.

![](/docs/images/integrations/klaviyo/4.configure_private_key.png)
...
![](/docs/images/integrations/klaviyo/5.manage_integration.png)
