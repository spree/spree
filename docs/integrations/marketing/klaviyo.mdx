---
title: "Connect Klaviyo email marketing to Spree"
sidebarTitle: Klaviyo
description: "Set up and manage Spree's native Klaviyo integration — sync customer events, build audience profiles, and power email and SMS campaigns from your store."
---
