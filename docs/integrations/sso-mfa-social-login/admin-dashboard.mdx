---
title: "Admin SSO and MFA with Microsoft Entra ID"
sidebarTitle: "Admin SSO & MFA"
description: "Secure the Spree admin panel with SSO and MFA — example integration with Microsoft Entra ID for enterprise compliance and centralized identity."
---
