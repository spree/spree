...
description: "Add customer-facing SSO and social login to your Spree storefront with Microsoft Entra External ID, Auth0, Google, Facebook, and Apple sign-in."
---
