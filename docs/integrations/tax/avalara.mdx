...
```bash
bundle add spree_avatax && bundle exec rails g spree_avatax:install
```
...
![The Integrations tab in the Spree admin showing the Avalara tile](/images/integrations/avalara/1-integrations-tab.png)

Locate the Avalara tile and click **Connect Avalara** to open the setup form.

![The Avalara connection form in Spree](/images/integrations/avalara/2-connection-form.png)
...
![Additional settings on the Avalara integration page](/images/integrations/avalara/7-additional-settings.png)
...
![Setting an Avalara tax code on a tax category in Spree](/images/integrations/avalara/3-tax-code.png)
...
![The Avalara Entity Use Codes list in Spree admin settings](/images/integrations/avalara/4-entity-use-codes.png)

To assign a code to a customer, open the customer's profile, click the dropdown, and select **Avalara Tax Settings**.

![The Avalara Tax Settings dropdown on a customer profile in Spree](/images/integrations/avalara/5-customer-tax-settings.png)
...
![Transactions listed as sales invoices in the Avalara dashboard](/images/integrations/avalara/6-transactions.png)
