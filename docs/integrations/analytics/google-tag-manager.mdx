---
title: "Connect Google Tag Manager to your Spree store"
sidebarTitle: Google Tag Manager
description: "Set up and manage Spree's native Google Tag Manager integration — deploy analytics, marketing, and SEO scripts across your store without code changes."
---
...
<Note> Ignore the GA4 Measurement ID field - simply leave it blank. </Note>
