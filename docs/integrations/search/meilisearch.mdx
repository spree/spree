---
title: "Meilisearch product search on Spree Commerce"
description: "Set up Meilisearch on Spree for fast, typo-tolerant product search with faceted filtering, relevance ranking, and sub-50ms storefront search responses."
---
## Overview
