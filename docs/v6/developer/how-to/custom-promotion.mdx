...
- **Actions** — what an applied promotion does, usually writing [Discount](/v6/developer/core-concepts/taxes-discounts-fees#discounts) rows
- **Adjusters** — for discounts and fees that aren't promotions at all (loyalty pricing, gift wrap fees, payment surcharges)

Spree ships with a comprehensive set of [built-in rules and actions](/v6/developer/core-concepts/promotions#rules). This guide shows how to build your own of each kind.
...
- [Promotions](/v6/developer/core-concepts/promotions) — promotion architecture and built-in rules and actions
- [Taxes, Discounts & Fees](/v6/developer/core-concepts/taxes-discounts-fees) — the typed rows actions and adjusters write
