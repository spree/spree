...
Promotions give money off an order — a percentage off, free shipping, or free items added to the cart. A promotion is a campaign definition: **rules** decide when it applies, **actions** decide what it does. When a promotion applies, its actions write [Discount](/v6/developer/core-concepts/taxes-discounts-fees#discounts) rows on the order.
...
You can also [build your own rules](/v6/developer/how-to/custom-promotion) for business-specific conditions.
...
- [Taxes, Discounts & Fees](/v6/developer/core-concepts/taxes-discounts-fees) — the Discount rows promotions write, and manual discounts
- [Build Custom Promotion Rules & Actions](/v6/developer/how-to/custom-promotion) — step-by-step guide to custom rules, actions and adjusters
- [Calculators](/developer/core-concepts/calculators) — promotion calculators
- [Carts](/v6/developer/core-concepts/carts) — the cart lifecycle promotions act on
