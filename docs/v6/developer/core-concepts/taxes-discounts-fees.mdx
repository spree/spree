...
Most discounts come from [Promotions](/v6/developer/core-concepts/promotions) — a customer applies a code and the rows appear. A **manual** discount is one an admin adds directly, for a goodwill gesture or a price match:
...
- [Promotions](/v6/developer/core-concepts/promotions) — where most discounts come from
