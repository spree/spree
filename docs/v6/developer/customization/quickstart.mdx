...
<Note>
Spree 6 changes where customization happens. The admin is now a React application extended through plugins rather than a Rails engine extended through partials, and business logic is extended through **workflow hooks** instead of replaced wholesale. See [Upgrading to 6.0](/developer/upgrades/5.4-to-6.0).
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Configuration">
    **Best for:** tweaking Spree's behavior globally.
    ...
    See [Configuration](/v6/developer/customization/configuration).
  </Accordion>
  ...
  <Accordion title="Checkout steps">
    **Best for:** adding, removing or reordering checkout steps.
    ...
    See [Carts](/v6/developer/core-concepts/carts#checkout-requirements).
  </Accordion>
  <Accordion title="Providers">
    **Best for:** swapping a whole area of behavior for your own implementation.
    ...
    See [Fulfillments](/v6/developer/core-concepts/fulfillments#delivery-types) and [Taxes](/developer/core-concepts/taxes).
  </Accordion>
  ...
  <Accordion title="Authentication">
    **Best for:** using your own user model or identity provider.
    ...
    See [Authentication](/developer/customization/authentication).
  </Accordion>
  ...
  <Accordion title="Dependencies">
    **Best for:** replacing an entire workflow or service with your own class.
    ...
    See [Dependencies](/v6/developer/customization/dependencies).
  </Accordion>
...
- [Carts](/v6/developer/core-concepts/carts) — checkout requirements and completion
