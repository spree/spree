...
module SpreePromotions::Product
...
module SpreePromotions::ProductGroup
  has_many :promotion_rules
end

module SpreePromotions::Order
...
ActiveSupport.on_load(:active_record) do
  ...
  Order.send SpreePromotions::Order
  Product.send SpreePromotions::Product
  ProductGroup.send SpreePromotions::ProductGroup
