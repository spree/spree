...
# where mixed in the main calculator folder. Calculators are now organised
# into modules: promotion, returns, shipping, tax.

# As well as the lack of organisation, FlatPercentItemTotal was the same as FlatPercentItemTotal
# and cross refrenced in the spec tests, this has been unifed into one file -> FlatPercent


# In Spree 4.0.0, in this file we point to old locatins at the new locations as not to brake upgrades.
