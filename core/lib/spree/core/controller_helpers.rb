# This module exists so that controllers that don't inherit from Spree::BaseController
# Can still inherit the important bits of functionality and use the Spree layout by default.
module Spree
  module Core
