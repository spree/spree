        ...
        def self.migratable_hooks
          {
            ...
            'admin/shared/_configuration_menu' => [:admin_configurations_sidebar_menu],
            'admin/shared/_order_tabs' => [:admin_order_tabs],
            'admin/shared/_product_sub_menu' => [:admin_product_sub_tabs],
            'admin/shared/_product_tabs' => [:admin_product_tabs],
