class AddMissingPageBuilderIndexes < ActiveRecord::Migration[8.0]
  def change
    ...
    add_index :spree_page_links, %w[linkable_id parent_type parent_id], name: 'index_spree_page_links_on_linkable_id_and_parent_type_and_parent_id', if_not_exists: true
