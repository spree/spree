class AddMissingIndexesOnSpreeTables < ActiveRecord::Migration
  def change
    unless index_exists? :spree_promotion_rules_users,
    ...
    unless index_exists? :spree_products_promotion_rules,
    ...
    unless index_exists? :spree_orders_promotions, [:promotion_id, :order_id]
      add_index :spree_orders_promotions, [:promotion_id, :order_id]
    end

    unless index_exists? :spree_properties_prototypes, :prototype_id
      add_index :spree_properties_prototypes, :prototype_id
    end

    unless index_exists? :spree_properties_prototypes,
    ...
    unless index_exists? :spree_taxons_prototypes, [:prototype_id, :taxon_id]
      add_index :spree_taxons_prototypes, [:prototype_id, :taxon_id]
    end

    unless index_exists? :spree_option_types_prototypes, :prototype_id
      add_index :spree_option_types_prototypes, :prototype_id
    end

    unless index_exists? :spree_option_types_prototypes,
    ...
    unless index_exists? :spree_option_values_variants,
