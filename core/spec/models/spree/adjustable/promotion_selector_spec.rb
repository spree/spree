...
module Spree
  module Adjustable
    describe PromotionSelector do
      ...
      let(:source)  { Spree::Promotion::Actions::CreateItemAdjustments.create(promotion: promotion2) }
      let(:source2) { Spree::Promotion::Actions::CreateItemAdjustments.create(promotion: promotion)  }
      let(:source3) { Spree::Promotion::Actions::CreateItemAdjustments.create(promotion: promotion)  }
      let(:source4) { Spree::Promotion::Actions::CreateItemAdjustments.create(promotion: promotion2) }
