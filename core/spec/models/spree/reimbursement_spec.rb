  ...
  describe "#perform!" do
    ...
    context 'with included tax' do
      ...
      it 'saves the included tax and refunds the total' do
        ...
        expect(reimbursement.total).to eq line_item.pre_tax_amount + line_item.included_tax_total
        expect(Spree::Refund.last.amount).to eq line_item.pre_tax_amount + line_item.included_tax_total
      end
    end
