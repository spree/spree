...
module Spree
  module Calculator::Shipping
    describe FlexiRate do
      ...
      let(:content_items) { [Stock::Package::ContentItem.new(variant1, 4),
      ...
      context "compute" do
        ...
        it "should compute amount correctly when additional_items and first_item have values AND max items has value" do
          ...
          subject.compute(content_items).round(2).should == 26.0
        end
