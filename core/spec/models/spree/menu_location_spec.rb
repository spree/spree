  ...
  context 'creating a new location' do
    ...
    describe '#sync_menu' do
      ...
      context 'when a new location is created' do
        it 'Menu#for_location responds to new location name' do
    ...
    describe '#remove_location_from_menu_singleton_methods' do
      ...
      context 'when a location is deleted' do
        ...
        it 'Menu#for_location no longer responds to the deleted location name' do
