...
describe Spree::Product, type: :model do
  ...
  describe 'associations' do
    ...
    describe '#relations' do
      let!(:relation) { create(:relation, relatable: product) }
      let(:other_relation) { create(:relation, relatable: product, relation_type: relation_type) }
      ...
      it 'can have many relations for different RelationTypes' do
        other_relation

        expect(subject.relations).to match_array [relation, other_relation]
      end
    end
