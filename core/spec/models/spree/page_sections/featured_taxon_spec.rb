...
RSpec.describe Spree::PageSections::FeaturedTaxon do
  describe '.by_taxon_id' do
    ...
    let!(:featured_taxon_1) { create(:featured_taxon_section, preferred_taxon_id: taxons[0].id) }
    let!(:featured_taxon_2) { create(:featured_taxon_section, preferred_taxon_id: taxons[1].id) }
