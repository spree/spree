...
describe Spree::Payment do
  ...
  describe "#set_unique_number" do
    ...
    it "sets a unique number on create" do
      ...
      payment.number.should_not be_blank
      payment.number.length.should eq 8
      payment.number.should be_a(String)
    end
    ...
    it "does not regenerate the number on re-save" do
      ...
      payment.save
      payment.number.should == old_number
    end
    ...
    context "other payment exists" do
      ...
      it "doesn't set duplicate number" do
        ...
        payment.number.should_not be_blank
        payment.number.should_not == other_payment.number
      end
    end
  end
