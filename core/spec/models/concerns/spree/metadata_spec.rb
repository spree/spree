...
RSpec.describe Spree::Metadata, type: :model do
  ...
  describe '#metafield' do
    let!(:metafield) { create(:metafield, owner: product, key: 'color', value: 'red') }
    ...
    it 'respects visibility parameter' do
      private_metafield = create(:metafield, owner: product, key: 'secret', visibility: 'private')
  ...
  describe '#set_metafield' do
    ...
    it 'updates existing metafield' do
      create(:metafield, owner: product, key: 'color', value: 'red')
  ...
  describe '#remove_metafield' do
    let!(:metafield) { create(:metafield, owner: product, key: 'color') }
  ...
  describe 'legacy metadata compatibility' do
    ...
    context 'when metafields exist' do
      let!(:public_metafield) { create(:metafield, owner: product, key: 'key3', value: 'value3', visibility: 'public') }
      let!(:private_metafield) { create(:metafield, owner: product, key: 'key4', value: 'value4', visibility: 'private') }
