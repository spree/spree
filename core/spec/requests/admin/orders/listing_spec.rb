...
describe "Orders Listing" do
  before(:each) do
    Factory(:order, :created_at => "2012-01-01 12:36:15", :completed_at => "2012-02-02 12:36:15", :number => "R100")
    Factory(:order, :created_at => "2012-02-01 12:36:15", :completed_at => "2012-02-01 12:36:15", :number => "R200")
