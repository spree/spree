    ...
    class OrderLineItemPresenter
      ...
      def call
        [
          ...
          taxon_dict(line_item.product.taxons.first)[0],
          taxon_dict(line_item.product.taxons.first)[1],
          taxon_dict(line_item.product.taxons.first)[2],
          taxon_dict(line_item.product.taxons.first)[3],
          taxon_dict(line_item.product.taxons.first)[4],
