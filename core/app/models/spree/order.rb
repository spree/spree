...
module Spree
  class Order < Spree::Base
    ...
    MONEY_VALIDATION = {
      presence:     true,
      numericality: {
        greater_than_or_equal_to: -MONEY_THRESHOLD,
        less_than_or_equal_to:     MONEY_THRESHOLD,
        allow_blank:               true
      },
    ...
    has_many :all_adjustments, class_name: 'Spree::Adjustment', foreign_key: :order_id, dependent: :destroy, inverse_of: :order
