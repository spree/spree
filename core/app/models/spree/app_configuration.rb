...
module Spree
  class AppConfiguration < Preferences::Configuration
    ...
    preference :address_fields, :array, default: %w(label firstname lastname company address1 address2 city state zipcode country phone alternative_phone) # address fields you would like to include in the Address form
