module Spree
  module Themes
    class B2B < Spree::Theme
      def self.metadata
        {
          authors: ['Spree Commerce'],
          license: 'MIT',
          description: 'A starter theme for B2B stores',
          preview_image_url: 'https://cdn.prod.website-files.com/652fd14a69d606ee5f6fc37f/66d08d0c64bc6065146b9db0_Multiple-Store%20Multi-tenant%20eCommerce.png',
      ...
      # PRODUCT IMAGES
      preference :product_listing_image_height, :integer, default: 200
      preference :product_listing_image_width, :integer, default: 200
      preference :product_listing_image_height_mobile, :integer, default: 150
      preference :product_listing_image_width_mobile, :integer, default: 150
    end
  end
end
