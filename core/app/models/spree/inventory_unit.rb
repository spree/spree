module Spree
  class InventoryUnit < Spree::Base
    ...
    has_many :reimbursement_items, inverse_of: :inventory_unit
    has_one :original_reimbursement_item, class_name: "Spree::ReimbursementItem", foreign_key: :exchange_inventory_unit_id
