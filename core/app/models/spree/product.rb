...
module Spree
  class Product < Spree::Base
    ...
    has_many :relations, -> { order(:position) }, class_name: 'Spree::Relation', as: :relatable
    has_many :relation_types, -> { distinct }, class_name: 'Spree::RelationType', through: :relations
