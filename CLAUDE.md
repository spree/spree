...
| `spree/easypost` | Ruby gem (`spree_easypost`, optional) — reference `DeliveryRateProvider`: live EasyPost carrier rates + per-store credentials via `SpreeEasyPost::Integration`. |
