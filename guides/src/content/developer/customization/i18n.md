...
### Adding Translations To Spree 4.2

If you wish to add a new translation to the list of `Supported Locales` found in each stores settings,
create your new translation file as described above, making sure to set a unique name for `this_file_language:` as shown below.

```yaml
ta:
  spree:
    i18n:
      this_file_language: "தமிழ் (TA)"

```

This new locale will then be displayed in the `Supported Locales` list for each of your stores.

![New Locale Added](../../../images/developer/adding_new_locale.png)
