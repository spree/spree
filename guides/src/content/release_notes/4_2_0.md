...
### Improved MultiStore support with Multi-Language
...
* `Language` - you can now change the Store language. This will also affect emails sent from that Store and API endpoints. Language settings will be also respected in all Spree extensions. Additional language packs are available via [Spree I18n gem](https://github.com/spree-contrib/spree_i18n).
...
* Supports multiple Relation Types via [Related Products](https://github.com/spree-contrib/spree_related_products) gem on product page [Spark Solutions](https://github.com/spree/spree/pull/10711)
