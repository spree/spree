...
Hubspot is... This endpoint can be used for...
...
In order to configure and use the [hubspot_endpoint](https://github.com/spree/hubspot_endpoint), you will need to first have:
