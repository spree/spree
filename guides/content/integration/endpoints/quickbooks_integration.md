...
Quickbooks is... This endpoint can be used for...
...
In order to configure and use the [quickbooks_endpoint](https://github.com/spree/quickbooks_endpoint), you will need to first have:
