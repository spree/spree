...
Shipwire is... This endpoint can be used for...
...
In order to configure and use the [shipwire_endpoint](https://github.com/spree/shipwire_endpoint), you will need to first have:
