...
Zendesk is... This endpoint can be used for...
...
In order to configure and use the [zendesk_endpoint](https://github.com/spree/zendesk_endpoint), you will need to first have:
