...
Mailchimp is... This endpoint can be used for...
...
In order to configure and use the [mailchimp_endpoint](https://github.com/spree/mailchimp_endpoint), you will need to first have:
