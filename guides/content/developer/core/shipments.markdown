...
*shipping instructions*. This is turned off by default. If an order has any shipping
...
As an example of how to use the [active_shipping extension](https://github.com/spree/spree_active_shipping) we'll demonstrate how to configure it to work with the USPS API. The other carriers follow a very similar pattern.
