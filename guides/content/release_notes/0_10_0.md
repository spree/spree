...
See the [checkout documentation](http://guides.spreecommerce.com/legacy/0-10-x/checkout.html#controller-logic) for
...
See the [REST API section](http://guides.spreecommerce.com/legacy/0-10-x/rest.html) for full details.
