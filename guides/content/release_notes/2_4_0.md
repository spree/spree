...
Return authorizations have received a major rewrite, and can be read more about in the new Return Authorization guide.

The previous return authorization code has been extraced into an extension if you would like to continue using it:
https://github.com/spree-contrib/spree_legacy_return_authorizations
...
The previous spree-guides repository has been merged into the spree core repository.  Any documentation updates should now be submitted with pull requests to https://github.com/spree/spree
