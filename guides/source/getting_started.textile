...
INFO. If you're an experienced Rails developer you may be wondering where your +app+ directory is.  Spree actually runs as an embedeed Rails app inside of your gem.  How do you customize things then?  We'll cover that later in extensions.
