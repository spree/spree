...
Spree itself contains a good example of how this can be achieved.  For instance, in the +spree_core+ gem there is logic to register calculators.  The following code can be found in the Rails +spree.register.calculators+ initializer defined in +spree/core/lib/spree_core/railtie.rb+:
