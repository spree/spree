...
Themes are designed to overhaul the entire look and feel of a Spree store (or it's administration system). Themes are also distributed in exactly the same manner as extensions, but don't generally include logic customizations.
