...
we have included an alternative binary 'spree_cmd'. You can use replace instances of 'spree' with 'spree_cmd' in this guide. The recommended
solution is to remove previous versions of Spree.
