...
The searching API is provided through the Ransack gem which Spree depends on. The `name_cont` here is called a *predicate*, and you can learn more about them by reading about "Predicates on the Ransack wiki":https://github.com/ernie/ransack/wiki/Predicates
