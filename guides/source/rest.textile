...
The request +GET /api/orders/R664048424.json+ will produce something like the following:
<plain>
{
  "order": {
    "number": "R664048424",
...
<shell>
curl -u bb51d44e:x http://example.com/api/orders/R123123.json  
</shell>
* POST for creating resources
<shell>
curl -u bb51d44e:x -H 'Content-Type: application/json' \
-d {"shipment":{"shipping_...},...} \
http://localhost:3000/api/orders/R123123/shipments.json
</shell>
* PUT for updating existing resources
<shell>
curl -u bb51d44e:x -X PUT -H 'Content-Type: application/json' \
-d {"shipment":{"shipping_...},...} \
http://localhost:3000/api/orders/R123123/shipments.json
</shell>
...
<shell>
PUT /api/orders/{order_id}/event?e={event_name}.json
</shell>
...
<shell>
PUT /api/shipments/{shipment_id}/event?e={event_name}.json
</shell>
...
<shell>
PUT /inventory_units/{inventory_unit_id}/event/?e={event_name}.json
...
</shell>
