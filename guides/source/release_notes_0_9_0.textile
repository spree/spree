...
+Spree::Config[:stylesheets]+ is a new config option for customizing the stylesheets used by the default application layout.  The value of +Spree::Config[:stylesheets]+ is a comma-separated string of stylesheet names without the file extensions.  See the "customization guide":customization.html for more information.
...
For more detailed information on the nature of these changes, please see the "relevant commit":http://github.com/spree/spree/commit/ce1aad7bc25c15a794f8f5689efcdbf8c3311b7b in Github.
