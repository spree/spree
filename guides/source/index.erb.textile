...
* "Current Release version":/documentation - based on the last stable release of Spree
* "Edge version":http://edgeguides.spreecommerce.com - for unreleased code in current Spree "master branch":http://github.com/railsdog/spree/tree/master
* "Legacy 0.30.x version":/legacy/0-30-x/ - for the legacy 0.30.x version of Spree
* "Legacy 0.11.x version":/legacy/0-11-x/ - for the legacy 0.11.x version of Spree
