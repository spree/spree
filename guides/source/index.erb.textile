...
<div id="subCol">
  <dl>
    <dd class="warning">This documentation is for the latest release version of Spree and may not apply to the "edge" source code.  Please see the "edge":http://spreecommerce.com/documentation/edge documentation for information on unreleased features.</dd>
  </dl>
</div>
...
<dl>
  <% guide('Theme Customization Tutorial', 'customization_tutorial.html') do %>
    This guide is a walkthrough of how to create a new theme
  <% end %>
</dl>
<dl>
  <% guide('Extension Tutorial', 'extension_tutorial.html') do %>
    This tutorial covers the basic steps of creating your own functionality extensions.
  <% end %>
</dl>
<dl>
