...
You will want to begin the update process by updating the Spree gem.
...
<ruby>
#config/routes.rb
YourStore::Application.routes.draw
  mount Spree::Core::Engine, :at => '/'
...
It is recommended to place your application's custom routes beneath Spree's mounted routes as shown in the above example. This will ensure you don't override any of Spree's defined routes.
...
Run the above command to copy over all the migrations from all the engines included in your application. This may also include any migrations from extensions.
...
* Correct the paths to any templates you are overriding to include the Spree namespace.
