...
WARNING. You will need to install the "spree-i18n":https://github.com/spree/spree_i18n gem if you want to use any of the community supplied translations of Spree.
