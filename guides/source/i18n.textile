...
Spree uses the standard Rails approach to internationalization so we suggest taking at look at the "rails-i18n.org wiki":http://rails-i18n.org/wiki to get started.
...
Spree extensions can contain their own *config/locale* directory where developers can include yaml files for each language they wish to support. 
