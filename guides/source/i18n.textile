...
Spree now stores all of the translation information in a separate GitHub project known as "spree_i18n":https://github.com/spree/spree_i18n.  This is a stand alone project with a large number of volunteer committers who maintain the locale files.  This is basically the same approach
followed by the Rails project which keeps their localizations in "rails-i18n":https://github.com/svenfuchs/i18n.
...
INFO: This functionality is new in Spree 1.2. Please refer to the appropriate guide if you are using an older version. 
