...
You should create your own "namespace" for extension locales.  This will prevent issues with conflicting filenames in future releases where we plan to automatically copy locale information out of extensions and into the main application space.  For instance, the api extension has a locale named +en_US_api.yml+. 
