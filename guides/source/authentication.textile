...
NOTE: Any modifications made to +lib/spree/authentication_helpers.rb+ while the server is running will require a restart, as wth any other modification to other files in +lib+.
