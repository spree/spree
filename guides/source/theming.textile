...
option in an extension initializer, e.g. add the following to +config/my_theme.rb+ inside your
theme. This would load +screen.css+ first followed by +my_theme.css+.
