...
h3. Significant Improvements in Test Coverage
...
INFO: See the "Testing Guide":http://spreecommerce.com/documentation/testing.html for more details on testing in Spree.

h3. Replace search_logic gem with meta_search
...
WARNING: If you are using one of the search related extensions for Spree you may experience compatibility issues.  Please report any troubles you have on the spree-user list and we'll see if we can help.  Eventually we'll revisit these extensions and verify their compatibility.
