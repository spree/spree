...
NOTE: In order to use decorators in an extension you need to include the following code in the self.activate method defined in *lib/extension_name/engine.rb*:
