...
and over-rideable methods to help with this. Resource-controller also helps with nested 
...
admin panel via the +admin_tabs+ hook (see "hooks":theming.html#usingablock for an example).
