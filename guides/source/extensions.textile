...
h3. Extension Load Order and Initializers
...
Such extensions are loaded in extension order (as above) then by alphabetical order within an extension - 
and they will all be loaded after the main project initialization is done. 
...
en-US:
  ...
  edit_foo: "Edit Foo"
  transmorgify_foo: "Turn Foo into a T-Rex"
</shell>
