...
WARNING. The dependencies should be specified in a specific order. Always specify +spree+, followed by the various spree extensions at the very end of +Gemfile+.
