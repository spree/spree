...
NOTE: You only need to be cognizant about the master variant if you begin to manage products and inventory programatically. The administration interface keeps all this nitty gritty transparent to the end-user. If you're looking to get your store set up quickly through the administration interface, feel free to skip to the next section.
