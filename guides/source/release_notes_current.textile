...
WARNING. You will need to install the "spree-i18n":http://github.com/railsdog/spree-i18n extension if you want to use any of the community supplied translations of Spree.
