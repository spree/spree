...
WARNING: You will need to install the "spree_i18n":http://github.com/spree/spree_i18n extension if you want to use any of the community supplied translations of Spree.
