...
!/images/promomtions/index.png(Promotions listing)
...
It is easy to add new action types by defining a subclass of *PromotionAction* which implements the *perform* method. Call *register* on your subclass to make it available to choose in the admin interface. See "Promotion::Actions::CreateAdjustment":https://github.com/spree/spree/blob/1-0-stable/promo/app/models/spree/promotion/actions/create_adjustment.rb for an example.
