...
Note if you initialize values for preferences available in the Admin Interface. They will overwrite any changes made through the user interface on when you restart.
