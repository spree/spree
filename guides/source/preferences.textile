...
Spree Preferences support general application configuration and perferences per model instance. Spree comes with preferences for your store like site name and description. Additional preferences can be added by your application or included extensions.
...
Preferences for models within an application are very common. Although the rule of thumb is to keep the number of preferences available to a minimum, sometimes it's necessary if you want users to have optional preferences like disabling like e-mail notifications.
...
Spree comes with many applicaiton wide preferences. They are defined in core/app/models/spree/app_configuration.rb and made availble to your code through Spree::Config, e.g., *Spree::config.site_name*.
