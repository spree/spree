...
INFO. Most sites are going to require at least some custom preferences.  It is recommended that you do this by creating a migration for your site extension.  See the "Upgrade Considerations":upgrade_considerations.html guide for more details.
...
INFO. Even though you can change many settings in the admin interface, you should realize that these settings will be lost should you decide to rebuild your database.  You'll also be missing these settings in your production server once you promote your code.  You should consider using a migration to set these values instead. See the "Upgrade Considerations":upgrade_considerations.html guide for more details.    