...
* If you activating custom Abilities or Calculators, you should remove then for now. You can re-add them to config/application.rb after you've ran the spree:site generator below. They will need to be inside the <tt>config.to_prepare</tt> block. 
