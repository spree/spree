...
In Quebec, Canada there are two different tax rates to consider. There is the Goods and Services Tax (GST) which iscalculated at 5% of the sales price. There is also the Quebec Sales Tax of 8.5% on the sale price including GST.

Since Spree does not currently support the notion of compound tax rates you can calculated a combined sales tax amount instead. In this case you can create a single sales tax rate of 8.925%. This approach is allowed "according to the Quebec government":http://www.revenuquebec.ca/documents/en/publications/in/in-203-v(2011-05).pdf as long as you label the tax simply as "QST" and do not display the percentage used in the calculation as part of the label.
