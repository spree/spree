...
h5. Accessing taxonomies

@taxonomies used to be set in most shared views. Instead when you need the site configured taxonomies call get_taxonomies.

h5. Spree Base Controller and Layouts

Spree::BaseController inherits directly from ActionController::Base changed from ApplicationController,
if you had an app/views/application.html.erb in your site extension. e.g.
<shell>
