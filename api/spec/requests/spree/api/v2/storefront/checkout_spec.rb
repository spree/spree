    ...
    shared_examples 'perform next' do
      context 'without line items' do
        ...
        it 'cannot transition to address without a line item' do
          expect(json_response['error']).to include(I18n.t('spree.api.there_are_no_items_for_this_order'))
        end
      end
      ...
      context 'without payment info' do
        ...
        it 'returns an error' do
          expect(json_response['error']).to include(I18n.t('spree.api.no_payment_found'))
        end
