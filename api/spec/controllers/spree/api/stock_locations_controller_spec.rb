  ...
  describe Api::StockLocationsController do
    ...
    context "as an admin" do
      ...
      it "gets a stock location" do
        ...
        json_response['stock_location'].should have_attributes(attributes)
        json_response['stock_location']['name'].should eq stock_location.name
      end
      ...
      it "can update a stock location" do
        ...
        json_response['stock_location']['name'].should eq 'South Pole'
      end
