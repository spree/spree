...
RSpec.describe Spree::Api::V3::Store::Orders::LineItemsController, type: :controller do
  ...
  describe 'POST #create' do
    ...
    context 'validation errors' do
      it 'returns error for invalid variant' do
        post :create, params: { order_id: order.number, line_item: { variant_id: 0, quantity: 1 } }
  ...
  describe 'PATCH #update' do
    ...
    context 'error handling' do
      it 'returns not found for non-existent line item' do
        patch :update, params: { order_id: order.number, id: 0, line_item: { quantity: 5 } }
  ...
  describe 'DELETE #destroy' do
    ...
    context 'error handling' do
      it 'returns not found for non-existent line item' do
        delete :destroy, params: { order_id: order.number, id: 0 }
