...
RSpec.describe Spree::Api::V3::Store::CustomersController, type: :controller do
  ...
  describe 'PATCH #update' do
    it 'updates the current user first name' do
      patch :update, params: { id: 'me', user: { first_name: 'Updated' } }
    ...
    it 'updates multiple fields' do
      patch :update, params: { id: 'me', user: { first_name: 'John', last_name: 'Doe' } }
    ...
    context 'validation errors' do
      it 'returns errors for blank email' do
        patch :update, params: { id: 'me', user: { email: '' } }
      ...
      it 'returns errors for duplicate email' do
        ...
        patch :update, params: { id: 'me', user: { email: other_user.email } }
