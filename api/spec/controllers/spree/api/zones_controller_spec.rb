  ...
  describe Api::ZonesController, :type => :controller do
    ...
    context "as an admin" do
      ...
      it "can create a new zone" do
        ...
        expect(json_response['zone']).to have_attributes(attributes)
        expect(json_response['zone']["zone_members"]).not_to be_empty
      end
      ...
      it "updates a zone" do
        ...
        expect(json_response['zone']['name']).to eq 'North Pole'
        expect(json_response['zone']['zone_members']).not_to be_blank
      end
