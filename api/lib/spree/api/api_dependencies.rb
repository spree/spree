module Spree
  class ApiDependencies
    ...
    INJECTION_POINTS = [
      ...
      :storefront_cart_change_currency_service, :storefront_checkout_create_payment_source_service,
      ...
      :platform_shipment_change_state_service, :platform_shipment_update_service
    ].freeze
    ...
    def set_storefront_defaults
      ...
      @storefront_checkout_create_payment_source_service = Spree::Dependencies.checkout_create_payment_source_service
