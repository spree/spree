  ...
  module Api
    class ApiDependencies
      INJECTION_POINTS_WITH_DEFAULTS = {
        ...
        v3_store_credit_card_serializer: 'Spree::Api::V3::Store::CreditCardSerializer',
        v3_store_product_serializer: 'Spree::Api::V3::Store::ProductSerializer',
        v3_store_variant_serializer: 'Spree::Api::V3::Store::VariantSerializer',
        v3_store_image_serializer: 'Spree::Api::V3::Store::ImageSerializer',
        v3_store_option_type_serializer: 'Spree::Api::V3::Store::OptionTypeSerializer',
        v3_store_option_value_serializer: 'Spree::Api::V3::Store::OptionValueSerializer',
        v3_store_order_serializer: 'Spree::Api::V3::Store::OrderSerializer',
        v3_store_line_item_serializer: 'Spree::Api::V3::Store::LineItemSerializer',
        v3_store_payment_serializer: 'Spree::Api::V3::Store::PaymentSerializer',
        v3_store_payment_source_serializer: 'Spree::Api::V3::Store::PaymentSourceSerializer',
        v3_store_shipment_serializer: 'Spree::Api::V3::Store::ShipmentSerializer',
        v3_store_address_serializer: 'Spree::Api::V3::Store::AddressSerializer',
        v3_store_user_serializer: 'Spree::Api::V3::Store::UserSerializer',
        v3_store_country_serializer: 'Spree::Api::V3::Store::CountrySerializer',
        v3_store_state_serializer: 'Spree::Api::V3::Store::StateSerializer',
        v3_store_store_serializer: 'Spree::Api::V3::Store::StoreSerializer',
        v3_store_wishlist_serializer: 'Spree::Api::V3::Store::WishlistSerializer',
        v3_store_wished_item_serializer: 'Spree::Api::V3::Store::WishedItemSerializer',
        v3_store_payment_method_serializer: 'Spree::Api::V3::Store::PaymentMethodSerializer',
        v3_store_shipping_method_serializer: 'Spree::Api::V3::Store::ShippingMethodSerializer',
        v3_store_shipping_rate_serializer: 'Spree::Api::V3::Store::ShippingRateSerializer',
        v3_store_stock_location_serializer: 'Spree::Api::V3::Store::StockLocationSerializer',
