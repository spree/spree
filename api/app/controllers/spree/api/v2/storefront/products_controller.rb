      ...
      module Storefront
        class ProductsController < ::Spree::Api::V2::BaseController
          ...
          def sorted_collection
            collection_sorter.constantize.new(collection, params, current_currency).call
          end

          def collection
            collection_finder.constantize.new(scope: scope, params: params, current_currency: current_currency).execute
          end
          ...
          def collection_sorter
            Spree::Api::Dependencies.storefront_products_sorter
          end

          def collection_finder
            Spree::Api::Dependencies.storefront_products_finder
          end

          def collection_serializer
            Spree::Api::Dependencies.storefront_product_serializer
          end
