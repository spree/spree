    ...
    module V3
      class SectionSerializer < BaseSerializer
        def attributes
          ...
          base_attrs[:blocks] = serialize_blocks if include?('blocks')
        ...
        def serialize_blocks
          resource.blocks.ordered.map do |block|
            block_serializer.new(block, nested_context('blocks')).as_json
          end
        end
        ...
        def block_serializer
          Spree::Api::Dependencies.v3_storefront_block_serializer.constantize
        end
