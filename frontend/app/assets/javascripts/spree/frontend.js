...
Spree.routes.product = function(id_or_slug) { return Spree.pathFor('products/' + id_or_slug) }
Spree.routes.product_related = function(id_or_slug) { return Spree.routes.product(id_or_slug) + '/related' }
