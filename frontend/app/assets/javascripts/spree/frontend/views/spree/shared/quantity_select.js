Spree.ready(function($) {
  ...
  if (cartPage.length) {
    ...
    cartPage.off('click', quantitySelectDecreaseSelector).on('click', quantitySelectDecreaseSelector, onQuantityDecreaseClick)
    cartPage.off('click', quantitySelectIncreaseSelector).on('click', quantitySelectIncreaseSelector, onQuantityIncreaseClick)
    cartPage.off('change', quantitySelectValueSelector).on('change', quantitySelectValueSelector, onValueChange)
  }
})
