function CouponManager(input) {
  ...
  this.couponErrorIcon = Spree.translations.coupon_code_error_icon;
}
...
CouponManager.prototype.sendRemoveRequest = function() {
  return $.ajax({
    ...
    method: "DELETE",
    url:
      Spree.routes.api_v2_storefront_cart_remove_coupon_code +
      "/" +
      this.couponCode,
    dataType: "json",
    headers: {
    ...
    .done(
      function() {
        ...
        this.couponStatus
          .addClass("alert-success")
          .html(Spree.translations.coupon_code_removed);
