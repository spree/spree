...
describe Spree::ProductsController, :type => :controller do
  ...
  it "allows admins to view non-active products" do
    allow(controller).to receive_messages :spree_current_user => mock_model(Spree.user_class, :has_spree_role? => true, :incomplete_spree_orders => Spree::Order.none, :spree_api_key => 'fake')
  ...
  it "should provide the current user to the searcher class" do
    user = mock_model(Spree.user_class, :incomplete_spree_orders => Spree::Order.none, :spree_api_key => 'fake')
  ...
  it "doesn't error when given an invalid referer" do
    current_user = mock_model(Spree.user_class, :has_spree_role? => true, :incomplete_spree_orders => Spree::Order.none, :generate_spree_api_key! => nil)
