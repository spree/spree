...
unless defined?('RAILS_ROOT')
  ...
  FileUtils.cp(File.join(File.dirname(__FILE__), 'javascripts/jquery.template.js'), "#{Rails.root}/public/javascripts") unless File.exists?("#{Rails.root}/public/javascripts/jquery.template.js")
end
