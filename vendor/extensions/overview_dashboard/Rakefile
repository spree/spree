...
desc 'Generate documentation for the overview_dashboard extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'OverviewDashboardExtension'
...
desc 'Test the overview_dashboard extension.'
...
namespace :test do
  desc 'Functional test the overview_dashboard extension.'
  ...
  desc 'Unit test the overview_dashboard extension.'
