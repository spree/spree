...
desc 'Generate documentation for the promotions extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'PromotionsExtension'
...
desc 'Test the promotions extension.'
...
namespace :test do
  desc 'Functional test the promotions extension.'
  ...
  desc 'Unit test the promotions extension.'
